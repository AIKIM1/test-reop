...
namespace LGC.GMES.MES.FCS002
{
    ...
    /// </summary>
    public partial class FCS002_090 : UserControl
    {
        ...
        private void InitCombo()
        {
            ...
            _combo.SetCombo(cboGrade, CommonCombo_Form_MB.ComboStatus.ALL, sCase: "COMMCODE", sFilter: sFilter);
        }
                ...
                Util.MessageConfirm("FM_ME_0020", (result) => //Cell 등급을 변경하시겠습니까?
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < dgCellList.Rows.Count; i++)
                        {
                            ...
                            if (DataTableConverter.GetValue(dgCellList.Rows[i].DataItem, "SUBLOTID")==null)
                                continue;
