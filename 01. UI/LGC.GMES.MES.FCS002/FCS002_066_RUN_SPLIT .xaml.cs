...
{
    public partial class FCS002_066_RUN_SPLIT : C1Window, IWorkArea
    {
        ...
        private void btnSearchLossCode_Click(object sender, RoutedEventArgs e)
        {
            ...
            FCS002_066_FCR_LIST wndFCRList = new FCS002_066_FCR_LIST();
        ...
        {
            FCS002_066_FCR_LIST window = sender as FCS002_066_FCR_LIST;
