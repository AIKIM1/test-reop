...
{
    public partial class FCS002_105 : UserControl,IWorkArea
    {
        ...
        {
            CommonCombo_Form_MB combo = new CommonCombo_Form_MB();

            // 동
            combo.SetCombo(cboArea, CommonCombo_Form_MB.ComboStatus.NONE, sCase: "AREA");
            ...
            combo.SetCombo(cboLotType, CommonCombo_Form_MB.ComboStatus.ALL, sCase: "FORM_CMN", sFilter: sFilter);
        ...
        private void GetList()
        {
            try
            {
                const string bizRuleName = "DA_PRD_SEL_SCAN_CELL_FOR_REG_BOX_UI_MB";
        ...
        private void GetSubLotList()
        {
            ...
            DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_PRD_SEL_SCAN_CELL_FOR_REG_BOX_SUBLOT_LIST_MB", "RQSTDT", "RSLTDT", inTable);
        ...
        private void GetBoxCount()
        {
            ...
            txtCellCount.Value = ((DataView) dgTargetList.ItemsSource).Table.AsEnumerable().Sum(s => s.Field<Int32>("CNT"));
        ...
        private void CreateBox()
        {
            ...
            const string bizRuleName = "BR_PRD_REG_FORM_OUTER_WH_BOX_MB";
        ...
        private void btnLabelPrint_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                FCS002_105_LABEL_PRINT wndLabelPrint = new FCS002_105_LABEL_PRINT();
        ...
        private void btnBoxCreateByModel_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                FCS002_105_MAX_TRF_QTY popup = new FCS002_105_MAX_TRF_QTY();
