...
{
    public partial class FCS002_200_CPF_DETAIL : C1Window, IWorkArea
    {
        ...
        private string _sHeader = ObjectDic.Instance.GetObjectName("LCI 세부 현황");

        public FCS002_200_CPF_DETAIL()
        {
            InitializeComponent();
            ...
            try
            {
                switch (bSend.Name)
                {
                    ...
                    case "btnInit":
                        ...
                        break;
                    case "btnBCRRead":
                        sMsg = "FM_ME_0521";  //BCR 재읽기 요청을 하시겠습니까?
                        sCtrStatus = "B";
                        break;
                    case "btnItin":
