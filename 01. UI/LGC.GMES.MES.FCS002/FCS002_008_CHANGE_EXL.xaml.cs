...
{
    public partial class FCS002_008_CHANGE_EXL : C1Window, IWorkArea
    {
        ...
        public FCS002_008_CHANGE_EXL()
        {
            InitializeComponent();
            Loaded += FCS002_008_CHANGE_EXL_Loaded;
        }

        private void FCS002_008_CHANGE_EXL_Loaded(object sender, RoutedEventArgs e)
        {
            Loaded -= FCS002_008_CHANGE_EXL_Loaded;
