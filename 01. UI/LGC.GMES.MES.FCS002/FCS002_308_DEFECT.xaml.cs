...
{
    public partial class FCS002_308_DEFECT : C1Window, IWorkArea
    {
        #region Declaration
        Util _Util = new Util();
        ...
        private void GetAssyLot()
        {
            try
            {
                ...
                RQSTDT.Rows.Add(dr);
                //Selecting 공정 불량 팔레트 신규 등록 조립 LOT 정보 조회
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("BR_PRD_GET_ASSY_LOT_ST_MB", "INDATA", "OUTDATA", RQSTDT);
