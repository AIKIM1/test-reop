...
{
    public partial class FCS002_106_LABEL_PRINT : C1Window, IWorkArea
    {
        ...
        private void GetLabelList()
        {
            try
            {
                ...
                new ClientProxy().ExecuteService("DA_PRD_SEL_OUTER_WH_PLLT_LIST_MB", "INDATA", "OUTDATA", inTable, (searchResult, searchException) =>
                {
        ...
        {
            const string bizRuleName = "BR_PRD_REG_FORM_WH_OUTER_LABEL_REPRINT_MB";
