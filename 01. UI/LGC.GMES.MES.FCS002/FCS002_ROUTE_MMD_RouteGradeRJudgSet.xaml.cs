...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2023.10.17  주훈   : LGC.GMES.MES.FROM001.FROM001_ROUTE_MMD_RouteGradeRJudgSet 초기 복사
**************************************************************************************/
using System;
...
{
    /// <summary>
    /// FCS002_ROUTE_MMD_RouteGradeRJudgSet.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class FCS002_ROUTE_MMD_RouteGradeRJudgSet : C1Window, IWorkArea
    {
        ...
        public FCS002_ROUTE_MMD_RouteGradeRJudgSet()
        {
            InitializeComponent();
            InitializeCombo();
        }
