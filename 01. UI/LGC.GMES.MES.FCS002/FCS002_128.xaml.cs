...
{
    public partial class FCS002_128 : UserControl, IWorkArea
    {
        ...
        private void InitCombo()
        {
            ...
            _combo.SetCombo(cboUseFlag, CommonCombo_Form_MB.ComboStatus.NONE, sCase: "CMN", sFilter: sFilter1);
        ...
        private void LocGetList()
        {
            try
            {
                ...
                DataTable dtRslt = new ClientProxy().ExecuteServiceSync("DA_SEL_CNVR_LOCATION_UI_MB", "RQSTDT", "RSLTDT", dtRqst);
        ...
        private void EqpGetList(string location_id)
        {
            try
            {
                ...
                DataTable dtRslt = new ClientProxy().ExecuteServiceSync("DA_SEL_EQUIPMENT_UI_MB", "RQSTDT", "RSLTDT", dtRqst);
        ...
        private void TrayTypeGetList(string Location_Id)
        {
            try
            {
                ...
                DataTable dtRslt = new ClientProxy().ExecuteServiceSync("DA_SEL_ENABLE_TRAY_TYPE_UI_MB", "RQSTDT", "RSLTDT", dtRqst);
        ...
        private void Eqp_btnSave_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Util.MessageConfirm("SFU1241", result =>
                {
                    if (result == MessageBoxResult.OK)
                    {
                        DataTable dtRslt = new ClientProxy().ExecuteServiceSync("DA_UPD_MCS_PORT_UI_MB", "INDATA", "OUTDATA", dtRqst);
        ...
        private void btnDisableMapping_Click(object sender, RoutedEventArgs e)
        {
            ...
            {   
                ...
                Util.MessageConfirm("SFU1241", result =>
                {
                    ...
                    DataTable dtRslt = new ClientProxy().ExecuteServiceSync("DA_DEL_MCS_PORT_UI_MB", "INDATA", "OUTDATA", dtRqst);
