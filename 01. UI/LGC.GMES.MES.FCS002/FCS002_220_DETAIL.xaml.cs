...
{
    public partial class FCS002_220_DETAIL : C1Window, IWorkArea
    {
        ...
        private string _sHeader = ObjectDic.Instance.GetObjectName("IR-OCV 세부 현황");

        public FCS002_220_DETAIL()
        {
            InitializeComponent();
            ...
            try
            {
                switch (bSend.Name)
                {
                    ...
                    case "btnInit":
                        ...
                        break;
                    case "btnBCRRead":
                        sMsg = "FM_ME_0521";  //BCR 재읽기 요청 하시겠습니까?
                        sCtrStatus = "B";
                        break;
                    case "btnItin":
