/*************************************************************************************
 Created Date : 2024.05.20
      Creator : 이홍주
   Decription : NG 및 Noread Cell 의 Recheck 처리 Popuop
--------------------------------------------------------------------------------------
 [Change History]
  2020.02.29  이제섭 : 최초생성
...
namespace LGC.GMES.MES.FCS002
{
    ...
    public partial class FCS002_400_RECHECK : C1Window, IWorkArea
    {
        ...
        private void txtCellID_KeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
            ...
            if (e.Key == Key.Enter)
            {
                string sBoxID = txtCellID.Text.ToString().Trim();
