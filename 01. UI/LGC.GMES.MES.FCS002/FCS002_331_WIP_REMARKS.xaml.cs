...
{
    public partial class FCS002_331_WIP_REMARKS : C1Window, IWorkArea
    {
        ...
        private void SaveWipRemarks( int tranType )
        {
            try
            {
                const string bizRuleName = "BR_PRD_REG_WIPATTR_WIP_REMARKS";
                ...
                {
                    newRow = inLot.NewRow();
                    newRow["LOTID"] = _LOT_ID_LISTS[inx]["BOXID"];
