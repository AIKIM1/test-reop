...
{
    public partial class FCS002_302_RUNSTART : C1Window, IWorkArea
    {
        #region Declaration
        Util _Util = new Util();
        ...
        private void GetAssyLotInfo()
        {
            try
            {
                ...
                if ((bool)rdoTray.IsChecked)
                {
                    ...
                    {
                        _job = "TRAY_NJ";
                        bizName = "DA_PRD_SEL_INPUT_TRAY_ASSY_LOT_INFO_MB";  //2023.03.09 _MB로 수정
                    }
                    else
                    {
                        _job = "TRAY";
        ...
        private void StartRunProcess()
        {
            try
            {
                ...
                //const string bizRuleName = "BR_PRD_REG_START_PROD_LOT_CG_MB";//활성화 라우트

                const string bizRuleName = "BR_PRD_REG_START_PROD_LOT_CG";//기존 라우트
