...
namespace LGC.GMES.MES.FCS002
{
    ...
    public partial class FCS002_303_INBOX_LABEL : C1Window, IWorkArea
    {
        ...
        private void Print_Box()
        {
            try
            {
                ...
                new ClientProxy().ExecuteService_Multi("BR_PRD_GET_INBOX_LABEL_FOR_TESLA_MB", "INDATA,INPRINT", "OUTDATA", (bizResult, bizException) =>
                {
                    try
                    {
        ...
        private void RePrint_Box()
        {
            try
            {
                ...
                new ClientProxy().ExecuteService_Multi("BR_PRD_GET_INBOX_LABEL_FOR_TESLA_REPRT_MB", "INDATA,INPRINT", "OUTDATA", (bizResult, bizException) =>
                {
                    try
                    {
                        string zplCode = string.Empty;
