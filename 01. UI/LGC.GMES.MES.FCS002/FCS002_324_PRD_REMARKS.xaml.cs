...
{
    public partial class FCS002_324_PRD_REMARKS : C1Window, IWorkArea
    {
        ...
        private void SaveWipRemarks( int tranType )
        {
            try
            {
                ...
                const string bizRuleName = "BR_PRD_REG_WIPHISTORYATTR_WIP_NOTE_FO_MB";
