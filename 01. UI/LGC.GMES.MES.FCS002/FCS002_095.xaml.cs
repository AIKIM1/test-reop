...
{
    public partial class FCS002_095 : IWorkArea
    {
        #region Declaration
        ...
        private void SetComboBox()
        {
           ...
           SetProcessCombo(cboProcess);
            ...
            _combo.SetCombo(cboAutoSearch, CommonCombo_Form_MB.ComboStatus.NA, sFilter: sFilter3, sCase: "COMMCODE");
        ...
        private void DgNgGroupLot_PreviewMouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            if (dg.CurrentCell.Column.Name.ToString() == "LOTID")
            {
                ...
                this.FrameOperation.OpenMenu("SFU010705490", true, parameters); //활성화 Lot 관리 화면 연계
                dg.CurrentCell.Presenter.Cursor = Cursors.Hand;
            }
        ...
        private void SetProcessGroupCombo(C1ComboBox cbo)
        {
            ...
            string[] arrCondition = { LoginInfo.LANGID, LoginInfo.CFG_AREA_ID, cboEquipmentSegment.SelectedValue == null ? null : cboEquipmentSegment.SelectedValue.ToString(), "PROC_GR_CODE_MB" };
            string selectedValueText = "CBO_CODE";
            string displayMemberText = "CBO_NAME";
        ...
        private void SetProcessCombo(C1ComboBox cbo)
        {
            ...
            CommonCombo_Form_MB.CommonBaseCombo(bizRuleName, cbo, arrColumn, arrCondition, CommonCombo_Form_MB.ComboStatus.NONE, selectedValueText, displayMemberText, null); //2021.03.31 기본 공정이 없을 경우 에러 발생에 대한 조치
        ...
        private void PopupOperResult()
        {
            ...
            this.FrameOperation.OpenMenu("SFU010715240", true, Parameters);
        }
        ...
        private void PopupCreateTrayInfo()
        {
            ...
            this.FrameOperation.OpenMenu("SFU010710330", true, Parameters);
        }
