...
--------------------------------------------------------------------------------------
 [Change History]
 2023.03.08  LEEHJ    SI              소형활성화MES 복사
...
{
    /// <summary>
    /// FCS002_301_RETURN.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class FCS002_301_RETURN : C1Window, IWorkArea
    {
        ...
        private void InitCombo()
        {
            ...
            _combo.SetCombo(cboLine, CommonCombo.ComboStatus.SELECT, sCase: "EQUIPMENTSEGMENT_FORM", sFilter: new string[] { LoginInfo.CFG_AREA_ID });          
        }
