...
{
    public partial class FCS002_333_CONFIRM : C1Window, IWorkArea
    {
        #region Declaration
        ...
        private void chkAllNew_Checked(object sender, RoutedEventArgs e)
        {
            ...
            _dtResult.Select().ToList<DataRow>().ForEach(r => r["WIPQTY"] = 0);
            _dtResult.Select().ToList<DataRow>().ForEach(r => r["SUMQTY"] = 0);
