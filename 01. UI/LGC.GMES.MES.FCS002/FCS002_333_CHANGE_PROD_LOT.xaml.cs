...
{
    public partial class FCS002_333_CHANGE_PROD_LOT : C1Window, IWorkArea
    {
        #region Declaration
        ...
        public FCS002_333_CHANGE_PROD_LOT()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void SetEquipmentCombo(C1ComboBox pCbo)
        {
            ...
            {
                bizRuleName = "DA_BAS_SEL_EQUIPMENT_CBO_MB";//NJ수정 20230609
            }
