...
{
    public partial class FCS002_ASSYLOT : C1Window, IWorkArea
    {
        #region Declaration
        ...
        private void SetAssyLot()
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(PolymerYN))
                    //bizName = "DA_PRD_SEL_ASSYLOT_FO";          //추후 TEST시 하위 _MB로 갈지 판단 2023.03.10
                    bizName = "DA_PRD_SEL_ASSYLOT_FO_MB";
                    
                else
                    bizName = "DA_PRD_SEL_ASSYLOT_PC"; //파우치
