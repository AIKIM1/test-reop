...
{
    public partial class FCS002_303_INFO : C1Window, IWorkArea
    {
        ...
        public FCS002_303_INFO()
        {
            InitializeComponent();
            Loaded += FCS002_303_INFO_Loaded;
        }

        private void FCS002_303_INFO_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void GetSearchData()
        {
            ...
            try
            {
                if (string.IsNullOrWhiteSpace(txtsublot.Text.ToString().Trim()) && String.IsNullOrWhiteSpace(txtinbox.Text.ToString().Trim()) && String.IsNullOrWhiteSpace(txtoutbox.Text.ToString().Trim()))
                {
                    // 입력 데이터가 존재하지 않습니다.
