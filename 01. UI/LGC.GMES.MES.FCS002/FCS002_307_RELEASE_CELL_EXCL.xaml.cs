...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2023.03.13  이홍주      SI               : 소형활성화 MES 복사
...
{
    /// <summary>
    /// FCS002_307_RELEASE_CELL_EXCL.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class FCS002_307_RELEASE_CELL_EXCL : C1Window, IWorkArea
    {
        ...
        public FCS002_307_RELEASE_CELL_EXCL()
        {
            InitializeComponent();
        }
