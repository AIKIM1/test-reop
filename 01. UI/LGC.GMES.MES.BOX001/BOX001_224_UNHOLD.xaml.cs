...
{
    /// <summary>
    /// BOX001_224_UNHOLD.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class BOX001_224_UNHOLD : C1Window, IWorkArea
    {        
        ...
        private void Save()
        {
            try
            {
                ...
                {
                    if (Util.NVC(dtInfo.Rows[row]["CHK"]).ToUpper().Equals("FALSE") || Util.NVC(dtInfo.Rows[row]["CHK"]).Equals("0")) continue;
