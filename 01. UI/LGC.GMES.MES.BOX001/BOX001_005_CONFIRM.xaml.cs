...
{
    public partial class BOX001_005_CONFIRM : C1Window, IWorkArea
    {
        ...
        public BOX001_005_CONFIRM()
        {
            InitializeComponent();
            Loaded += BOX001_005_CONFIRM_Loaded;

        }

        private void BOX001_005_CONFIRM_Loaded(object sender, RoutedEventArgs e)
        {
            Loaded -= BOX001_005_CONFIRM_Loaded;
            InitSet();
        ...
        private void InitSet()
        {
            ...
            //Parameters[2] = txtWorkorder.Text.Trim();
            //Parameters[3] = Process.CELL_BOXING;
            //Parameters[4] = txtRemark.Text.Trim();
            //Parameters[5] = (selLotData as DataRowView)["MODELID"].ToString(); ;
            //Parameters[6] = sEQSGID;
            //Parameters[7] = sEQSGNAME;
            //Parameters[8] = sEQPTID;
            //Parameters[9] = txtProdid.Text.Trim();
            //Parameters[10] = dtTRAY;    //lsDataTable;
            //Parameters[11] = dtASSYLOT;
            //Parameters[12] = totalCount;
        ...
        private void btnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            else if (string.IsNullOrEmpty(txtProcUser.Text))
            {
                ...
                // LGC.GMES.MES.ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage("SFU1843"), null, "Information", MessageBoxButton.OK, MessageBoxIcon.None);                
                return;
            }
            ...
            // 실적확인 처리
            //Boolean endResult = ProcPackEnd(sUser);
            ...
            if (endResult == true)
            {
                ...
                {
                    sTopProdID = GetTopProdID(txtLotid.Text.Trim());

                    if (sTopProdID.Equals(""))
                    {
                        // [%1]에 완제품 정보(TOP_PRODID)가 없습니다.
                        Util.MessageValidation("SFU5208", txtLotid.Text.Trim());
                ...
                _RetDT = setPalletTag(txtProcUser.Text, sTopProdID);
            ...
            else
            {
               ...
               // LGC.GMES.MES.ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage("SFU3155"), null, "Information", MessageBoxButton.OK, MessageBoxIcon.None);
                return;
            }
        ...
        private Boolean ProcPackEnd()
        {
            ...
            // BizData data = new BizData("GMPACK_END_v03"); 
            ...
            try
            {
                ...
                //        DataRow inLot = inLotTable.NewRow();
                //        inLot["BOXID"] = Util.NVC(dtBOX.Rows[i]["TRAY_MAGAZINE"]);
                //        inLot["TOTAL_QTY"] = Util.NVC(dtBOX.Rows[i]["QTY"]);
                ...
                DataSet dsResult = new ClientProxy().ExecuteServiceSync_Multi("BR_PRD_REG_END_LOT_BY_EQ_CP", "INDATA,INLOT", null, indataSet);
                return true;
            ...
            catch (Exception ex)
            {
                ...
                Util.AlertByBiz("BR_PRD_REG_END_LOT_BY_EQ_CP", ex.Message, ex.ToString());
                return false;
            }
            finally
            {
        ...
        private DataTable setPalletTag(string sUserName, string sTopProdID)
        {
