...
{
    public partial class BOX001_301_CONFIRM : C1Window, IWorkArea
    {
        ...
        public BOX001_301_CONFIRM()
        {
            InitializeComponent();
            Loaded += BOX001_301_CONFIRM_Loaded;
        }

        private void BOX001_301_CONFIRM_Loaded(object sender, RoutedEventArgs e)
        {
            Loaded -= BOX001_301_CONFIRM_Loaded;
            InitSet();
        }
        ...
        private void InitSet()
        {
            ...
            sPACK_WRK_TYPE_CODE = tmps[16] as string;
        ...
        private string InsertCELLTOPALLETData()
        {
            ...
            try
            {
                ...
                inDataTable.Columns.Add("PLLT_BCD_ID", typeof(string));
                ...
                inData["PLLT_BCD_ID"] = !string.IsNullOrWhiteSpace(txtPalletBCD.Text.Trim()) ? txtPalletBCD.Text.Trim() : null;
                ...
                loadingIndicator.Visibility = Visibility.Visible;
                DataSet dsResult = new ClientProxy().ExecuteServiceSync_Multi("BR_SET_END_PALLET_BY_UI_BX", "INDATA,INDATA_SUBLOT", "OUTDATA", indataSet);
