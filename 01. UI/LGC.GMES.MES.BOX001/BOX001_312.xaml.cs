...
{
    public partial class BOX001_312 : UserControl, IWorkArea
    {
        Util _Util = new Util();
        ...
        private void btnSearch_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                DataTable SearchResult = new ClientProxy().ExecuteServiceSync("DA_SEL_CANCEL_SHIP_PALLET_HIST_BX", "RQSTDT", "RSLTDT", RQSTDT);
            ...
            if (dgCancel.GetRowCount() > 0)
            {
                ...
                try
                {
                    try
                    {
                        ...
                        new ClientProxy().ExecuteService_Multi("BR_SET_CANCEL_SHIP_CELL_BX", "INDATA,INPALLET", null, (result, Exception) =>
                        {
                            if (Exception != null)
                            {
        ...
        private void wndConfirm_Closed(object sender, EventArgs e)
        {
            ...
            if (window.DialogResult == MessageBoxResult.OK)
            {
                ...
                try
                {
                    ...
                    DataSet dsRslt = new ClientProxy().ExecuteServiceSync_Multi("BR_SET_CANCEL_SHIP_CELL_BX", "INDATA,INPALLET,INBOX", null, indataSet);
        ...
        private void txtPALLETID_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                ScanPalletInfo(palletID, txtRCVID.Text.Trim());
            }
        }
                ...
                try
                {
                    ...
                    for (int i = 0; i < sPasteStrings.Length; i++)
                    {
                        ...
                        if (!string.IsNullOrEmpty(palletID))
                        {
                            ...
                            if (ScanPalletInfo(palletID, string.Empty) == false)
                            {
                                break;
                            }
                        }
