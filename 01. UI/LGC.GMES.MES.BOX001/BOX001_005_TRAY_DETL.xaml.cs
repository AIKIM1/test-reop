...
{
    public partial class BOX001_005_TRAY_DETL : C1Window, IWorkArea
    {
        ...
        public BOX001_005_TRAY_DETL()
        {
            InitializeComponent();
            Loaded += BOX001_005_TRAY_DETL_Loaded;
        }

        private void BOX001_005_TRAY_DETL_Loaded(object sender, RoutedEventArgs e)
        {
            Loaded -= BOX001_005_TRAY_DETL_Loaded;
