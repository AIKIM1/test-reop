/*************************************************************************************
 Created Date : 2019.11.11
      Creator : 최상민
   Decription : 전지 5MEGA-GMES 구축 - 출하HOLD 관리 - 보류재고 등록 팝업
--------------------------------------------------------------------------------------
 [Change History]
 2019-11-18 최상민 : GMES Hold, QMS Hold건 보류재고 등록 기능 팝업
...
{
    /// </summary>
    public partial class BOX001_213_NCR_HOLD : C1Window, IWorkArea
    {
        ...
        private void btnDownLoad_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (od.ShowDialog() == true)
                {
                    ...
                    //sheet[0, 0].Style.Font = new XLFont("Arial", 12, Color.FromArgb(255, 255, 0, 0));
                    sheet[0, 0].Style.BackColor = Color.FromArgb(255, 255, 0, 0);
                    //sheet[0, 1].Style.BackColor = Color.FromArgb(255, 255, 0, 0);
                    //sheet[0, 2].Style.BackColor = Color.FromArgb(255, 255, 0, 0);
                ...
                if (fd.ShowDialog() == true)
                {
                    using (Stream stream = fd.OpenFile())
                    {
                        ...
                        if (sheet.GetCell(0, 0).Text != "Hold Group ID"
                            || sheet.GetCell(0, 1).Text != "Assy Lotid"
                            || sheet.GetCell(0, 2).Text != "Cell ID")
                        */
