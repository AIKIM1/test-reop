...
{
    public partial class BOX001_045_PACKINGCARD_MERGE : UserControl, IWorkArea
    {


        #region Declaration & Constructor 

        public BOX001_045 BOX001_045;
        ...
        public BOX001_045_PACKINGCARD_MERGE()
        {
            InitializeComponent();
        }
        ...
        private void init_Form()
        {
            try
            {
                ...
                Util.gridClear(dgPancakeListRemain03);
                Util.gridClear(dgPancakeListSelected01);
                Util.gridClear(dgPancakeListSelected02);
                Util.gridClear(dgPancakeListSelected03);

                m_LotID1 = BOX001_045.sTempLot_1.ToString();
                m_LotID2 = BOX001_045.sTempLot_2.ToString();
                m_LotID3 = BOX001_045.sTempLot_3.ToString();

                Search_Lot_List(m_LotID1, dgPancakeListRemain01);
                txtLotID1.Text = m_LotID1;
                txtLaneQty1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[0].DataItem, "LANE_QTY"));
                txtCutM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[0].DataItem, "M_WIPQTY"));
                txtCellM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[0].DataItem, "CELL_WIPQTY"));
                numLane_Qty1.Value = dgPancakeListRemain01.GetRowCount();

                if (!string.IsNullOrEmpty(m_LotID2) || !m_LotID2.Equals(""))
                {
                    Search_Lot_List(m_LotID2, dgPancakeListRemain02);
                    txtLotID2.Text = m_LotID2;
                    txtLaneQty2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[1].DataItem, "LANE_QTY"));
                    txtCutM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[1].DataItem, "M_WIPQTY"));
                    txtCellM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[1].DataItem, "CELL_WIPQTY"));
                    numLane_Qty2.Value = dgPancakeListRemain02.GetRowCount();
                }
                else
                {
                    txtLotID2.Text = null;
                    txtLaneQty2.Text = null;
                    txtCutM2.Text = null;
                    txtCellM2.Text = null;
                    numLane_Qty2.Value = 0;
                }

                if (!string.IsNullOrEmpty(m_LotID3) || !m_LotID3.Equals(""))
                {
                    Search_Lot_List(m_LotID3, dgPancakeListRemain03);
                    txtLotID3.Text = m_LotID3;
                    txtLaneQty3.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[2].DataItem, "LANE_QTY"));
                    txtCutM3.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[2].DataItem, "M_WIPQTY"));
                    txtCellM3.Text = Util.NVC(DataTableConverter.GetValue(BOX001_045.dgOut.Rows[2].DataItem, "CELL_WIPQTY"));
                    numLane_Qty3.Value = dgPancakeListRemain03.GetRowCount();
                }
                else
                {
                    txtLotID3.Text = null;
                    txtLaneQty3.Text = null;
                    txtCutM3.Text = null;
                    txtCellM3.Text = null;
                    numLane_Qty3.Value = 0;
                }

                txtLocation.Text = BOX001_045.cboTransLoc2.Text;
        ...
        private void cboPackWay_SelectedValueChanged(object sender, PropertyChangedEventArgs<object> e)
        {
            ...
            for (int i = 0; i < dgPancakeListRemain03.GetRowCount(); i++)
            {
                DataTableConverter.SetValue(dgPancakeListRemain03.Rows[i].DataItem, "POSITION", 0);
                DataTableConverter.SetValue(dgPancakeListRemain03.Rows[i].DataItem, "CHK", true);
            }
        }
        ...
        private void InitLaneList()
        {
            ...
            DelFromPosition(0, dgPancakeListSelected03, dgPancakeListRemain03);
        ...
        {
            AddToPosition(3, dgPancakeListSelected03, dgPancakeListRemain03, 3);
        ...
        private bool Prevalidation()
        {
            ...
            //if (Convert.ToInt32(numLaneQty3.Value) <= 0)
            //{
            //    Util.MessageValidation("SFU3019", "#3"); //%1 Box/가대에 선택된 Lane 이 없습니다.
            //    return false;
            //}
            return bResult;
        }
        ...
        private void InitPackingNo()
        {
            ...
            if (!string.IsNullOrWhiteSpace(m_LotID1))
            {
                InitPackSkidRemake(m_LotID1);
            }

            if (!string.IsNullOrWhiteSpace(m_LotID2))
            {
                InitPackSkidRemake(m_LotID2);
            }
            if (!string.IsNullOrWhiteSpace(m_LotID3))
            {
            ...
            if (!m_LotID1.Equals("") || !m_LotID2.Equals("") || !m_LotID3.Equals(""))
            {
                ...
                if(!BOX001_045.sNote2.ToString().Equals(""))
                    m_PackingRemark += BOX001_045.sNote2.ToString() + ", ";
            }
            ...
            m_PackingNo3 = txtLotID1.Text.ToString().Substring(0, 9) + "0";
        ...
        private void PackingCardDataBinding_Config()
        {
            ...
            {  
                ...
                sPackageWay = ObjectDic.Instance.GetObjectName("전극포장카드 SteelRack");

                // BOX타입이 가대로 고정되어 있어 STEELRACK으로 수정 [2019-07-11]
                sOWMS_Code = "ER";
                ...
                string sVld_date3 = string.Empty;
                string sVld3 = string.Empty;
                string sProdDate3 = string.Empty;
                string no2 = string.Empty;
                string no3 = string.Empty;
                string prodvercode2 = string.Empty;
                string prodvercode3 = string.Empty;
                string procRemark = "";
                string miFrameLane1 = m_iFrameLane1.ToString();
                string miFrameLane2 = m_iFrameLane2.ToString();
                string miFrameLane3 = m_iFrameLane3.ToString();
                string mdCutM1 = string.Empty;
                string mdCutM2 = string.Empty;
                string mdCutM3 = string.Empty;
                string mdCell1 = string.Empty;
                string mdCell2 = string.Empty;
                string mdCell3 = string.Empty;
                string mdConvCoutC1 = string.Empty;
                string mdConvCoutC2 = string.Empty;
                string mdConvCoutC3 = string.Empty;

                if (Util.NVC(m_EltrValueDecimalApplyFlag).Equals("Y"))  //[E20230306-000128]전극수 소수점 개선
                {
                    mdCutM1 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dCutM1 * 10) / 10) );
                    mdCutM2 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dCutM2 * 10) / 10) );
                    mdCutM3 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dCutM3 * 10) / 10) );
                    mdCell1 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dCell1 * 10) / 10) );
                    mdCell2 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dCell2 * 10) / 10) );
                    mdCell3 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dCell3 * 10) / 10) );
                    mdConvCoutC1 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dConvCutC1 * 10) / 10) );
                    mdConvCoutC2 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dConvCutC2 * 10) / 10) );
                    mdConvCoutC3 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( m_dConvCutC3 * 10) / 10) );
                }
                else
                {
                    mdCutM1 = String.Format("{0:#,##0}", m_dCutM1);
                    mdCutM2 = String.Format("{0:#,##0}", m_dCutM2);
                    mdCutM3 = String.Format("{0:#,##0}", m_dCutM3);
                    mdCell1 = String.Format("{0:#,##0}", m_dCell1);
                    mdCell2 = String.Format("{0:#,##0}", m_dCell2);
                    mdCell3 = String.Format("{0:#,##0}", m_dCell3);
                    mdConvCoutC1 = String.Format("{0:#,##0}", m_dConvCutC1);
                    mdConvCoutC2 = String.Format("{0:#,##0}", m_dConvCutC2);
                    mdConvCoutC3 = String.Format("{0:#,##0}", m_dConvCutC3);
                }
                ...
                if (!string.IsNullOrEmpty(BOX001_045.sTempLot_2) || !BOX001_045.sTempLot_2.Equals(""))
                {
                    no2 = "2";
                    ...
                    if(Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected02.Rows[0].DataItem, "PROD_VER_CODE")) == "")
                    {
                        prodvercode2 = null;
                    }
                    else
                    {
                        prodvercode2 = Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected02.Rows[0].DataItem, "PROD_VER_CODE"));
                    }
                }
                else
                {
                ...
                if (!string.IsNullOrEmpty(BOX001_045.sTempLot_3) || !BOX001_045.sTempLot_3.Equals(""))
                {
                    no3 = "3";
                    if (Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected03.Rows[0].DataItem, "VLD_DATE")) == "")
                    {
                        sVld3 = null;
                    }
                    else
                    {
                        sVld_date3 = Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected03.Rows[0].DataItem, "VLD_DATE"));
                        sVld3 = sVld_date3.ToString().Substring(0, 4) + "-" + sVld_date3.ToString().Substring(4, 2) + "-" + sVld_date3.ToString().Substring(6, 2);
                    }
                    if (Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected03.Rows[0].DataItem, "WIPSDTTM")) == "")
                    {
                        sProdDate3 = null;
                    }
                    else
                    {
                        DateTime ProdDate3 = Convert.ToDateTime(Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected03.Rows[0].DataItem, "WIPSDTTM")));
                        sProdDate3 = ProdDate3.Year.ToString() + "-" + ProdDate3.Month.ToString("00") + "-" + ProdDate3.Day.ToString("00");
                    }

                    if (Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected03.Rows[0].DataItem, "PROD_VER_CODE")) == "")
                    {
                        prodvercode3 = null;
                    }
                    else
                    {
                        prodvercode3 = Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected03.Rows[0].DataItem, "PROD_VER_CODE"));
                    }
                ...
                dr4["CSTID"] = m_LotID1 + "," + m_LotID2 + "," + m_LotID3;
                ...
                string sSHIPTO_ID = BOX001_045.cboTransLoc2.SelectedValue.ToString();
        ...
        private void Print_Result(object sender, EventArgs e)
        {
            try
            {
                ...
                if (wndPopup.DialogResult == MessageBoxResult.OK)
                {
                    ...
                    Util.gridClear(BOX001_045.dgOut);
                    BOX001_045.dgSub.Children.Clear();

                    BOX001_045.dgOut.IsEnabled = true;
                    BOX001_045.txtLotID.IsReadOnly = false;
                    BOX001_045.btnPackOut.IsEnabled = true;
                    BOX001_045.txtLotID.Text = "";
                    BOX001_045.txtLotID.Focus();
                }
            }
            catch (Exception ex)
            {
