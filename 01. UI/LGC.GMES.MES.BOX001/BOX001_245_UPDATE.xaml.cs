...
{
    /// <summary>
    /// BOX001_245_UPDATE.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class BOX001_245_UPDATE : C1Window, IWorkArea
    {
        ...
        private void Update()
        {
            try
            {
                ...
                newRow["HOLD_REG_QTY"] = Util.NVC(txtHoldRegQty.Text).Equals("") ? "0" : txtHoldRegQty.Text;
