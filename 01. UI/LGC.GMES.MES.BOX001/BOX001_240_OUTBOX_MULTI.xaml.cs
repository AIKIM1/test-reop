...
namespace LGC.GMES.MES.BOX001
{
    ...
    public partial class BOX001_240_OUTBOX_MULTI : C1Window, IWorkArea
    {
        Util _util = new Util();
        ...
        #region Initialize
        public BOX001_240_OUTBOX_MULTI()
        {
            InitializeComponent();
        }
        ...
        private void RunStart()
        {
            ...
            try
            {
                ...
                DataSet dsResult = new ClientProxy().ExecuteServiceSync_Multi("BR_PRD_REG_PACK_OUTBOX_MIX_MULTI_NJ", "INPALLET,INOUTBOX", null, ds);
