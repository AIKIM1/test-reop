...
{
    public partial class BOX001_221_PACKINGCARD_MERGE : UserControl, IWorkArea
    {
        ...
        public BOX001_221_PACKINGCARD_MERGE()
        {
            InitializeComponent();
        }
        ...
        private void init_Form()
        {
            try
            {
                ...
                m_LotID1 = BOX001_221.sTempLot_1.ToString();
                m_LotID2 = BOX001_221.sTempLot_2.ToString();

                m_ProcID = Util.NVC(DataTableConverter.GetValue(BOX001_221.dgOut.Rows[0].DataItem, "PROCID"));
                ...
                txtLaneQty1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_221.dgOut.Rows[0].DataItem, "LANE_QTY"));
                txtLaneQty2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_221.dgOut.Rows[1].DataItem, "LANE_QTY"));

                txtCutM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_221.dgOut.Rows[0].DataItem, "M_WIPQTY"));
                txtCutM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_221.dgOut.Rows[1].DataItem, "M_WIPQTY"));

                txtCellM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_221.dgOut.Rows[0].DataItem, "CELL_WIPQTY"));
                txtCellM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_221.dgOut.Rows[1].DataItem, "CELL_WIPQTY"));
        ...
        private void InitPackingNo()
        {
            ...
            if (!m_LotID1.Equals("") || !m_LotID2.Equals(""))
            {
                ...
                if(!BOX001_221.sNote2.ToString().Equals(""))
                    m_PackingRemark += BOX001_221.sNote2.ToString() + ", ";
            }
            ...
            //m_PackingNo1 = txtLotID1.Text.ToString().Substring(0, 9) + "0"; //SKIDID #1
            //m_PackingNo2 = txtLotID1.Text.ToString().Substring(0, 9) + "0"; // //SKIDID #1
