...
{
    public partial class Report_Pallet_Hist : C1Window, IWorkArea
    {
        object[] tmps;
        ...
        private void previewVolt()
        {
            try
            {
                ...
                using (Stream stream = a.GetManifestResourceStream("LGC.GMES.MES.BOX001.Report." + "Pallet_Lot.xml"))
                {
