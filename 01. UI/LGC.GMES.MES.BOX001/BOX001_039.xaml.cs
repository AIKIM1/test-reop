...
{
    public partial class BOX001_039 : UserControl, IWorkArea
    {
        Util _Util = new Util();
        ...
        private void btnSearch_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                DataTable SearchResult = new ClientProxy().ExecuteServiceSync("DA_PRD_SEL_WO_FOR_ROLL_IN", "RQSTDT", "RSLTDT", RQSTDT);
