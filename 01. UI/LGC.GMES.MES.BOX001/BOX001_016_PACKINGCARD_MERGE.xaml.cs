...
namespace LGC.GMES.MES.BOX001
{
    ...
    public partial class BOX001_016_PACKINGCARD_MERGE : UserControl, IWorkArea
    {
        ...
        public BOX001_016_PACKINGCARD_MERGE()
        {
            InitializeComponent();
        }
        ...
        private void init_Form()
        {
            try
            {
                ...
                m_LotID1 = BOX001_016.sTempLot_1.ToString();
                m_LotID2 = BOX001_016.sTempLot_2.ToString();
                ...
                txtLaneQty1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[0].DataItem, "LANE_QTY"));
                txtLaneQty2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[1].DataItem, "LANE_QTY"));

                txtCutM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[0].DataItem, "M_WIPQTY"));
                txtCutM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[1].DataItem, "M_WIPQTY"));

                txtCellM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[0].DataItem, "CELL_WIPQTY"));
                txtCellM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[1].DataItem, "CELL_WIPQTY"));
