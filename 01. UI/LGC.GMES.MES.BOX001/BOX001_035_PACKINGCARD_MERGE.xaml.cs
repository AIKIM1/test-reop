...
{
    public partial class BOX001_035_PACKINGCARD_MERGE : UserControl, IWorkArea
    {
        ...
        private string m_SkidID1 = string.Empty;
        private string m_SkidID2 = string.Empty;
        ...
        public BOX001_035_PACKINGCARD_MERGE()
        {
            InitializeComponent();
        }
        ...
        private void init_Form()
        {
            try
            {
                ...
                m_LotID1 = BOX001_035.sTempLot_1.ToString();
                m_LotID2 = BOX001_035.sTempLot_2.ToString();

                m_SkidID1 = BOX001_035.sTempSkid_1.ToString();
                m_SkidID2 = BOX001_035.sTempSkid_2.ToString();

                Search_Lot_List(m_LotID1, dgPancakeListRemain01);

                Search_Lot_List(m_LotID2, dgPancakeListRemain02);

                txtLotID1.Text = m_SkidID1;
                txtLotID2.Text = m_SkidID2;

                txtLaneQty1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[0].DataItem, "LANE_QTY"));
                txtLaneQty2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[1].DataItem, "LANE_QTY"));

                txtCutM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[0].DataItem, "M_WIPQTY"));
                txtCutM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[1].DataItem, "M_WIPQTY"));

                txtCellM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[0].DataItem, "CELL_WIPQTY"));
                txtCellM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[1].DataItem, "CELL_WIPQTY"));
        ...
        private void InitPackingNo()
        {
            ...
            if (!m_SkidID1.Equals(""))
            {
                InitPackSkidRemake(m_SkidID1, m_LotID1);
            }

            if (!m_SkidID2.Equals(""))
            {
                InitPackSkidRemake(m_SkidID2, m_LotID2);
            }
        ...
        private void PackingCardDataBinding_Config()
        {
            ...
            {  
                ...
                if (string.Equals(sUnitCode, "EA"))
                {
                    ...
                    {
                        decimal sConvLength = Util.NVC_Decimal(GetPatternLength(sProdID, m_SkidID1));
                ...
                //dtPackingCard_Merge.Columns.Add("Text7", typeof(string)); // Skid ID
