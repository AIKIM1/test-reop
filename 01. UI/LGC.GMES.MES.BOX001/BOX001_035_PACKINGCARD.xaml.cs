...
{
    public partial class BOX001_035_PACKINGCARD : UserControl, IWorkArea
    {

        #region Declaration & Constructor 
        public BOX001_035 BOX001_035;
        ...
        private void init_Form()
        {
            try
            {
                ...
                m_SkidID = BOX001_035.sTempSkid_1.ToString();
                m_LotID = BOX001_035.sTempLot_1.ToString();
                ...
                dr["LOTID"] = BOX001_035.sTempLot_1.ToString();
                ...
                txtLotID.Text = BOX001_035.sTempSkid_1.ToString();

                txtLocation.Text = BOX001_035.cboTransLoc2.Text;

                txtLaneQty.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[0].DataItem, "LANE_QTY"));

                txtCutM.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[0].DataItem, "M_WIPQTY"));

                txtCellM.Text = Util.NVC(DataTableConverter.GetValue(BOX001_035.dgOut.Rows[0].DataItem, "CELL_WIPQTY"));
        ...
        private void InitPackingNo()
        {
            ...
            if (!m_SkidID.Equals("") || !m_LotID.Equals(""))
            {
                ...
                if (!BOX001_035.sNote2.ToString().Equals(""))
                    m_PackingRemark += BOX001_035.sNote2.ToString() + ", ";
            }
        ...
        private void PackingCardDataBinding_Config()
        {
            try
            {
                ...
                string sSHIPTO_ID = BOX001_035.cboTransLoc2.SelectedValue.ToString();
                string sTO_SLOC_ID = string.Empty;
                string sShopID = string.Empty;
        ...
        private void Print_Result(object sender, EventArgs e)
        {
            try
            {
                ...
                if (wndPopup.DialogResult == MessageBoxResult.OK)
                {
                    ...
                    Util.gridClear(BOX001_035.dgOut);
                    BOX001_035.dgSub.Children.Clear();

                    BOX001_035.dgOut.IsEnabled = true;
                    BOX001_035.txtLotID.IsReadOnly = false;
                    BOX001_035.btnPackOut.IsEnabled = true;
                    BOX001_035.txtLotID.Text = "";
                    BOX001_035.txtLotID.Focus();
