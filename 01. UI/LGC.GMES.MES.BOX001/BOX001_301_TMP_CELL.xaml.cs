...
{
    public partial class BOX001_301_TMP_CELL : C1Window, IWorkArea
    {
        ...
        private void InitSet()
        {
            ...
            _comboF.SetCombo(cboEquipmentSegment, CommonCombo_Form.ComboStatus.SELECT, cbChild:cboChild, sFilter: sFilter, sCase: "LINE");
        ...
        private void btnSelect_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (Util.NVC(DT.Rows[i]["CHK"]) == "True")
                {
                    iRow = i;
                    break;
                }
