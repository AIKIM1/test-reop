...
namespace LGC.GMES.MES.BOX001
{
    ...
    public partial class BOX001_210_TESLA_UNMAP : C1Window, IWorkArea
    {
        ...
        private void UnMap_Pallet()
        {
            try
            {
                ...
                new ClientProxy().ExecuteServiceSync_Multi("BR_PRD_REG_TESLA_PLT_LABEL_UNMAP_NJ", "INDATA,INBOX", null, indataSet);
