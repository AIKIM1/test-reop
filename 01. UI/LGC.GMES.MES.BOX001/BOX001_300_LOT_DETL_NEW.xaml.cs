...
{
    public partial class BOX001_300_LOT_DETL_NEW : C1Window, IWorkArea
    {
        ...
        public BOX001_300_LOT_DETL_NEW()
        {
            InitializeComponent();
            Loaded += BOX001_300_LOT_DETL_NEW_Loaded;
        }

        private void BOX001_300_LOT_DETL_NEW_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void btnReConfirm_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage("SFU3169"), null, "Information", MessageBoxButton.OK, MessageBoxIcon.None);
