...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2023.11.30  이병윤    : Low SOC 파라메터 추가
...
{
    public partial class BOX001_201_CELL_DETL : C1Window, IWorkArea
    {
        ...
        private string _RowSoc = string.Empty;
        ...
        #region Initialize
        private void BOX001_201_CELL_DETL_Loaded(object sender, RoutedEventArgs e)
        {
            Loaded -= BOX001_201_CELL_DETL_Loaded;
            InitControl();
        ...
        private void txtCellID_KeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
            try
            {
                if (e == null || e.Key == System.Windows.Input.Key.Enter)
                {
                    ...
                    RQSTDT.Columns.Add("LOW_SOC_FLAG");
        ...
        private void Getinbox(string sBoxID)
        {
            try
            {
                ...
                //  DataTable dtResult = new ClientProxy().ExecuteServiceSync("BR_PRD_GET_INBOX_NJ", "INDATA", "OUTSUBLOT", RQSTDT);
                DataSet dsResult = new ClientProxy().ExecuteServiceSync_Multi("BR_PRD_GET_INBOX_NJ", "INDATA", "OUTDATA,OUTSUBLOT", ds);
        ...
        private void btnChange_Click(object sender, RoutedEventArgs e)
        {
            ...
            BOX001_201_CHANGE_CELL puChange = new BOX001_201_CHANGE_CELL();
        ...
        {
            BOX001_201_CHANGE_CELL popup = sender as BOX001_201_CHANGE_CELL;
