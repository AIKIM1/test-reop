...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2023.10.26  이병윤 : E20230704-000395 : 엑셀업로드 100까지 제한
**************************************************************************************/
...
namespace LGC.GMES.MES.BOX001
{
    ...
    public partial class BOX001_240_UNPACK : C1Window, IWorkArea
    {
        ...
        void LoadExcel(Stream excelFileStream, int sheetNo)
        {
            try
            {
                ...
                {
                    Util.MessageValidation("SFU3695");  //최대100개까지 가능합니다.
                    return;
                }
