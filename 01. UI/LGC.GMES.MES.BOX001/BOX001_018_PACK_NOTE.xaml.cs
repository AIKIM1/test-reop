...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2024.07.30  남형희 : E20240614-001681 활성화 전환 BizRule로 변경
...
{
    public partial class BOX001_018_PACK_NOTE : C1Window, IWorkArea
    {
        ...
        public BOX001_018_PACK_NOTE()
        {
            InitializeComponent();
            Loaded += BOX001_018_PACK_NOTE_Loaded;
        }

        private void BOX001_018_PACK_NOTE_Loaded(object sender, RoutedEventArgs e)
        {
            Loaded -= BOX001_018_PACK_NOTE_Loaded;
        ...
        private void SavePackNote(string sPalletID, string sPackNote)
        {
            try
            {
                ...
                else if(chkPalletHoldFlag.IsChecked == true)
                {
                    ...
                    //}, inDataSet); 
                    #endregion
                    //2024.07.30 E20240614-001681 활성화 전환 BizRule로 변경
                    DataSet inData = new DataSet();                   
