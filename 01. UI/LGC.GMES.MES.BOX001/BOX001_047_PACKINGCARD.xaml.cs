...
{
    public partial class BOX001_047_PACKINGCARD : UserControl, IWorkArea
    {

        #region Declaration & Constructor 
        public BOX001_047 BOX001_047;
        ...
        private void init_Form()
        {
            try
            {
                ...
                m_SkidID = BOX001_047.sTempSkid_1.ToString();
                m_LotID = BOX001_047.sTempLot_1.ToString();
                ...
                dr["LOTID"] = BOX001_047.sTempLot_1.ToString();
                dr["LANGID"] = LoginInfo.LANGID;
                dr["AREAID"] = LoginInfo.CFG_AREA_ID;
                RQSTDT.Rows.Add(dr);

                DataTable SearchResult = new ClientProxy().ExecuteServiceSync("DA_PRD_SEL_ELEC_PACKING_PALLTE", "RQSTDT", "RSLTDT", RQSTDT);
                ...
                txtLotID.Text = BOX001_047.sTempSkid_1.ToString();

                txtLocation.Text = BOX001_047.cboTransLoc2.Text;

                txtLaneQty.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[0].DataItem, "LANE_QTY"));

                txtCutM.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[0].DataItem, "M_WIPQTY"));

                txtCellM.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[0].DataItem, "CELL_WIPQTY"));
            ...
            if (DataGrid.Rows.Count == 0)
            {
                ...
                for (int i = 0; i < dgPancakeListRemain.GetRowCount(); i++)
                {
                    if (DataTableConverter.GetValue(dgPancakeListRemain.Rows[i].DataItem, "CHK").ToString() == "True")
                    {
                        ...
                        DataTableConverter.SetValue(DataGrid.CurrentRow.DataItem, "EQSG_NAME", DataTableConverter.GetValue(dgPancakeListRemain.Rows[i].DataItem, "EQSG_NAME"));
            ...
            if (dgPancakeListRemain.Rows.Count == 0)
            {
                ...
                for (int i = 0; i < DataGrid.GetRowCount(); i++)
                {
                        ...
                        DataTableConverter.GetValue(DataGrid.Rows[i].DataItem, "POSITION").ToString() != "ADD")
                    {
                        ...
                        DataTableConverter.SetValue(dgPancakeListRemain.CurrentRow.DataItem, "EQSG_NAME", DataTableConverter.GetValue(DataGrid.Rows[i].DataItem, "EQSG_NAME"));
                        dgPancakeListRemain.IsReadOnly = true;
                    }
                }
            }
        ...
        private void InitPackingNo()
        {
            ...
            if (!m_SkidID.Equals(""))
            {
                InitPackSkidRemake(m_SkidID, m_LotID);
            }

            if (!m_SkidID.Equals("") || !m_LotID.Equals(""))
            {
                ...
                if (!BOX001_047.sNote2.ToString().Equals(""))
                    m_PackingRemark += BOX001_047.sNote2.ToString() + ", ";
            }
            ...
            if (m_PkgWay == "CRT" && rdoFrame2.IsChecked == true)
            {
                ...
                {
                    case "1":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "A" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "B" + "Z";
                        break;
                    case "2":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "C" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "D" + "Z";
                        break;
                    case "3":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "E" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "F" + "Z";
                        break;
                    case "4":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "G" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "H" + "Z";
                        break;
                    case "5":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "I" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "J" + "Z";
                        break;
                    case "6":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "K" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "L" + "Z";
                        break;
                    case "7":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "M" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "N" + "Z";
                        break;
                    case "8":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "O" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "P" + "Z";
                        break;
                    case "9":
                        m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 8) + "Q" + "Z";
                        m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 8) + "S" + "Z";
                        break;
                }
            ...
            else
            {
                ...
                if (IsDupplicatedPakcingNo(m_PackingNo1) == false)
                {
                    m_PackingNo1 = txtLotID.Text.ToString().Substring(0, 9) + "Z";
                    m_PackingNo2 = txtLotID.Text.ToString().Substring(0, 9) + "Z";
                }
        ...
        private void InitPackSkidRemake(string sSKIDID, string sLOTID)
        {
            DataTable RQSTDT = new DataTable();
            RQSTDT.TableName = "RQSTDT";
            ...
            {
                m_PackingRemark += sSKIDID + " " + SlocIDResult.Rows[0]["CUTIDS"].ToString() + "\n";
        ...
        private void PackingCardDataBinding_Config()
        {
            try
            {
                ...
                if (string.Equals(sUnitCode, "EA"))
                {
                    ...
                    {
                        decimal sConvLength = Util.NVC_Decimal(GetPatternLength(sProdID, m_SkidID));
                ...
                if (Util.NVC(m_EltrValueDecimalApplyFlag).Equals("Y"))  //[E20230306-000128]전극수 소수점 개선
                {
                    drCrad.ItemArray = new object[] { sPackageWay,
                                                  ...
                                                  "",
                                                  String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCutM1 + m_dCutM2) * 10) / 10) ),
                                                  "",
                                                  String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCell1 + m_dCell2) * 10) / 10) ),
                                                  "",
                                                  String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dConvCutC1 + m_dConvCutC2) * 10) / 10) ),
                                                  "",
                                                  m_PackingRemark,
                                                  sUnitCode,
                                                  sV_DATE,
                ...
                string sSHIPTO_ID = BOX001_047.cboTransLoc2.SelectedValue.ToString();
                string sTO_SLOC_ID = string.Empty;
                string sShopID = string.Empty;
        ...
        private void PackingCardDataBinding_2CRT()
        {
            try
            {
                ...
                string sPackage = ObjectDic.Instance.GetObjectName("전극포장카드");
                ...
                if (Util.NVC(m_EltrValueDecimalApplyFlag).Equals("Y"))  //[E20230306-000128]전극수 소수점 개선
                {
                    if (string.Equals(sUnitCode, "EA"))
                    {
                        m_CutStr1 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCutM1) * 10) / 10) ) + "/" + String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dConvCutM1) * 10) / 10) ) + "M";
                        s_CutStr1 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCell1) * 10) / 10) ) + "/" + String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dConvCutC1) * 10) / 10) ) + "M";
                        m_CutStr2 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCutM2) * 10) / 10) ) + "/" + String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dConvCutM2) * 10) / 10) ) + "M";
                        s_CutStr2 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCell2) * 10) / 10) ) + "/" + String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dConvCutC2) * 10) / 10) ) + "M";
                    }
                    else
                    {
                        m_CutStr1 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCutM1) * 10) / 10) );
                        s_CutStr1 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCell1) * 10) / 10) );
                        m_CutStr2 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCutM2) * 10) / 10) );
                        s_CutStr2 = String.Format("{0:#,##0.#}", (decimal)(Math.Truncate( (m_dCell2) * 10) / 10) );
                    }
                }
                else
                {
                ...
                dtPackingCard.Columns.Add("EQSG_NAME", typeof(string));
                //dtPackingCard.Columns.Add("Text7", typeof(string));
                //dtPackingCard.Columns.Add("Text19", typeof(string));
                ...
                if (Util.NVC(m_EltrValueDecimalApplyFlag).Equals("Y"))  //[E20230306-000128]전극수 소수점 개선
                {
                    drCrad.ItemArray = new object[] { sPackageWay,
                                                  ...
                                                  Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected01.Rows[0].DataItem, "PRODID")) + " [ " + sAbbrCode + " ]",
                                                  Util.NVC(DataTableConverter.GetValue(dgPancakeListSelected01.Rows[0].DataItem, "EQSG_NAME"))
                                                  //ObjectDic.Instance.GetObjectName("PANCAKEID").ToString() ,
                                                  //ObjectDic.Instance.GetObjectName("PANCAKEID").ToString()
                                               };
                }
                else
                ...
                drInfo["OUTBOXID"] = m_PackingNo1 + "0";
                //drInfo["QTY1"] = Convert.ToDecimal(txtSelectedM1.Text.ToString()) + Convert.ToDecimal(txtSelectedM2.Text.ToString());
                //drInfo["QTY2"] = Convert.ToDecimal(txtSelectedCell1.Text.ToString()) + Convert.ToDecimal(txtSelectedCell2.Text.ToString());
                ...
                drInfo["FROM_SLOC_ID"] = DataTableConverter.GetValue(dgPancakeListSelected01.Rows[0].DataItem, "FROM_SLOC_ID");
                drInfo["TO_SLOC_ID"] = sTO_SLOC_ID;
                drInfo["PACKING_NO"] = m_LotID;
                drInfo["PACK_NO1"] = m_PackingNo1;
                drInfo["REMARK"] = m_PackingRemark;
                drInfo["PKGWAY"] = m_PkgWay;
                //drInfo["TOTAL_QTY"] = Convert.ToDecimal(txtSelectedM1.Text.ToString());
                //drInfo["TOTAL_QTY2"] = Convert.ToDecimal(txtSelectedCell1.Text.ToString());
                ...
                if (Util.NVC(m_EltrValueDecimalApplyFlag).Equals("Y"))  //[E20230306-000128]전극수 소수점 개선
                {
                    drInfo["TOTAL_QTY"]  = (decimal)(Math.Truncate( m_dCutM2 * 10) / 10);
                    drInfo["TOTAL_QTY2"] = (decimal)(Math.Truncate( m_dCell2 * 10) / 10);
                }
                else
                {
        ...
        private void Print_Result(object sender, EventArgs e)
        {
            try
            {
                ...
                if (wndPopup.DialogResult == MessageBoxResult.OK)
                {
                    ...
                    Util.gridClear(BOX001_047.dgOut);
                    BOX001_047.dgSub.Children.Clear();

                    BOX001_047.dgOut.IsEnabled = true;
                    BOX001_047.txtLotID.IsReadOnly = false;
                    BOX001_047.btnPackOut.IsEnabled = true;
                    BOX001_047.txtLotID.Text = "";
                    BOX001_047.txtLotID.Focus();
