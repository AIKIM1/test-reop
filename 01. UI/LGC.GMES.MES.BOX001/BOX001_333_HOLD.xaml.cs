...
--------------------------------------------------------------------------------------
 ...
 2024.07.22 유재홍                        BOX001_333로 복사 후 HOLD_CODE추가
**************************************************************************************/
...
namespace LGC.GMES.MES.BOX001
{
    ...
    /// </summary>
    public partial class BOX001_333_HOLD : C1Window, IWorkArea
    {
        ...
        private void Save()
        {
            try
            {
                ...
                if (newRow["HOLD_CODE"].ToString().Equals(""))
                {
                    return;
                }
