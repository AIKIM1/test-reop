...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2024.01.10  김도형     : [E20231122-001031] [NA PI]전극MES시스템의 포장화면 개선건 (BOX001_016->BOX001_330)
...
{
    public partial class BOX001_330_PACKINGCARD : UserControl, IWorkArea
    {
        ...
        private void init_Form()
        {
            try
            {
                ...
                dr["LOTID"] = BOX001_330.sTempLot_1_Pack.ToString();
                ...
                txtLotID.Text = BOX001_330.sTempLot_1_Pack.ToString();

                txtLocation.Text = BOX001_330.cboTransLoc2_Pack.Text;

                txtLaneQty.Text = Util.NVC(DataTableConverter.GetValue(BOX001_330.dgOut_Pack.Rows[0].DataItem, "LANE_QTY"));

                txtCutM.Text = Util.NVC(DataTableConverter.GetValue(BOX001_330.dgOut_Pack.Rows[0].DataItem, "M_WIPQTY"));

                txtCellM.Text = Util.NVC(DataTableConverter.GetValue(BOX001_330.dgOut_Pack.Rows[0].DataItem, "CELL_WIPQTY"));
        ...
        private void btnPackCard_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (Prevalidation() == true)
                {
                    ...
                    dr2["PRODID"] = Util.NVC(DataTableConverter.GetValue(BOX001_330.dgOut_Pack.Rows[0].DataItem, "PRODID"));
                    dr2["BIZTYPE"] = "P";
        ...
        private void InitPackingNo()
        {
            ...
            if (!BOX001_330.sTempLot_1_Pack.ToString().Equals(""))
            {
                InitPackSkidRemake(BOX001_330.sTempLot_1_Pack.ToString());
            }
        ...
        private void PackingCardDataBinding_Config()
        {
            try
            {
                ...
                m_LotID = BOX001_330.sTempLot_1_Pack.ToString();
