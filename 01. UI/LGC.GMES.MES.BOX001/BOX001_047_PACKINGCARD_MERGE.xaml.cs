...
{
    public partial class BOX001_047_PACKINGCARD_MERGE : UserControl, IWorkArea
    {
        ...
        public BOX001_047_PACKINGCARD_MERGE()
        {
            InitializeComponent();
        }
        ...
        private void init_Form()
        {
            try
            {
                ...
                m_LotID1 = BOX001_047.sTempLot_1.ToString();
                m_LotID2 = BOX001_047.sTempLot_2.ToString();

                m_SkidID1 = BOX001_047.sTempSkid_1.ToString();
                m_SkidID2 = BOX001_047.sTempSkid_2.ToString();
                ...
                txtLaneQty1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[0].DataItem, "LANE_QTY"));
                txtLaneQty2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[1].DataItem, "LANE_QTY"));

                txtCutM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[0].DataItem, "M_WIPQTY"));
                txtCutM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[1].DataItem, "M_WIPQTY"));

                txtCellM1.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[0].DataItem, "CELL_WIPQTY"));
                txtCellM2.Text = Util.NVC(DataTableConverter.GetValue(BOX001_047.dgOut.Rows[1].DataItem, "CELL_WIPQTY"));
