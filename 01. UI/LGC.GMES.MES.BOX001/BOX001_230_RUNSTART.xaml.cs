/*************************************************************************************
 Created Date : 2018.06.22
      Creator : 이영준S
   Decription : 전지 5MEGA-GMES 구축 - 1/2차 포장 구성 (파우치형) - 작업시작 팝업
--------------------------------------------------------------------------------------
 [Change History]
...
namespace LGC.GMES.MES.BOX001
{
    ...
    /// </summary>
    public partial class BOX001_230_RUNSTART : C1Window, IWorkArea
    {
        ...
        private void btnSave_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace((string)cboLabelType.SelectedValue) || Util.NVC(cboLabelType.SelectedValue) == "SELECT")
                {
                ...
                if (popShipto.SelectedValue == null || string.IsNullOrWhiteSpace(popShipto.SelectedValue.ToString()))
                {
                    // 출하처를 선택하세요.
        ...
        private void RunStart()
        {
            try
            {
                ...
                new ClientProxy().ExecuteService_Multi("BR_PRD_REG_INPUT_CTNR_FOR_12ND_PACKING_NJ", "INDATA,INPALLET,INCTNR", "OUTPALLET", (searchResult, searchException) =>
                {
                    try
                    {
        ...
        private void puProduct_Closed(object sender, EventArgs e)
        {
            ...
            if (popup.DialogResult == MessageBoxResult.OK)
            {
                ...
                // 거래처
                setShipToPopControl(popup.PRODID);
            }
        ...
        private void GetDetailInfo()
        {
            ...
            // 거래처
            setShipToPopControl(txtPRODID.Text);
        }
