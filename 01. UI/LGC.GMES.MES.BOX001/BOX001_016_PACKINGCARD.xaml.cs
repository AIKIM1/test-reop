...
{
    public partial class BOX001_016_PACKINGCARD : UserControl, IWorkArea
    {
        #region Declaration & Constructor 
        public BOX001_016 BOX001_016;
        ...
        private void init_Form()
        {
            try
            {
                ...
                dr["LOTID"] = BOX001_016.sTempLot_1.ToString();
                ...
                txtLotID.Text = BOX001_016.sTempLot_1.ToString();

                txtLocation.Text = BOX001_016.cboTransLoc2.Text;

                txtLaneQty.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[0].DataItem, "LANE_QTY"));

                txtCutM.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[0].DataItem, "M_WIPQTY"));

                txtCellM.Text = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[0].DataItem, "CELL_WIPQTY"));
        ...
        private void btnPackCard_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (Prevalidation() == true)
                {
                    ...
                    dr2["PRODID"] = Util.NVC(DataTableConverter.GetValue(BOX001_016.dgOut.Rows[0].DataItem, "PRODID"));
                    dr2["BIZTYPE"] = "P";
                    dr2["BOXTYPE"] = cboPackWay.SelectedValue.ToString(); //BIZTYPE 이 'M'이면 'ALL' 고정 SETTING
                    dr2["LOTCNT"] = numLaneQty1.Value + numLaneQty2.Value;
                    ...
                    if (BoxLotResult.Rows.Count > 0)
                    {
                        ...
                        {
                            Util.MessageInfo("SFU8265", (result) =>
                            {
        ...
        private void InitPackingNo()
        {
            ...
            if (!BOX001_016.sTempLot_1.ToString().Equals(""))
            {
                InitPackSkidRemake(BOX001_016.sTempLot_1.ToString());
            }
            ...
            if (!BOX001_016.sTempLot_1.ToString().Equals(""))
            {
                ...
                if (!BOX001_016.sNote2.ToString().Equals(""))
                    m_PackingRemark += BOX001_016.sNote2.ToString() + ", ";
            }
        ...
        private void PackingCardDataBinding_Config()
        {
            try
            {
                ...
                m_LotID = BOX001_016.sTempLot_1.ToString();
                ...
                if (string.Equals(sUnitCode, "EA"))
                {
                    ...
                    {
                        decimal sConvLength = Util.NVC_Decimal(GetPatternLength(sProdID, m_LotID));
                ...
                dtPackingCard.Columns.Add("PROC_REMARK", typeof(string));
                ...
                string sSHIPTO_ID = BOX001_016.cboTransLoc2.SelectedValue.ToString();
                string sTO_SLOC_ID = string.Empty;
                string sShopID = string.Empty;
                ...
                drInfo["TYPE"] = "SHIP";
                drInfo["PROCID"] = "E7000";
                drInfo["SKID_NOTE"] = BOX001_016.txtComment.Text;
        ...
        private void Print_Result(object sender, EventArgs e)
        {
            try
            {
                ...
                if (wndPopup.DialogResult == MessageBoxResult.OK)
                {
                    ...
                    Util.gridClear(BOX001_016.dgOut);
                    BOX001_016.dgSub.Children.Clear();

                    // [E20240325-000262] 电极包装（LOT SCAN）改善 electrode package(LOT SCAN) improvement 
                    BOX001_016.txtLotIDScan.IsReadOnly = false;
                    BOX001_016.txtLotIDScan.Text = "";

                    BOX001_016.dgOut.IsEnabled = true;
                    BOX001_016.txtLotID.IsReadOnly = false;
                    BOX001_016.btnPackOut.IsEnabled = true;
                    BOX001_016.txtLotID.Text = "";
                    BOX001_016.txtLotID.Focus();
                }
            }
            catch (Exception ex)
            {
