...
{
    public partial class FORM001_013_RUNSTART : C1Window, IWorkArea
    {
        #region Declaration
        Util _Util = new Util();
        ...
        private void InitializeUserControls(bool IsAll)
        {
            if (IsAll)
            {
                Util.gridClear(dgWO);
        ...
        private void SetControl()
        {
            ...
            //string[] sFilter = { LoginInfo.CFG_AREA_ID, LoginInfo.CFG_EQSG_ID , "P" };
        ...
        private void SetFormWorkType(C1ComboBox cbo)
        {
            ...
            string[] arrCondition = {LoginInfo.LANGID, LoginInfo.CFG_AREA_ID, LoginInfo.CFG_EQSG_ID, LoginInfo.CFG_SHOP_ID.Equals("G182") ? "P" : null};
        ...
        private void txtAssyLotID_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (dgLot.Rows.Count > 0)
                DataTableConverter.SetValue(dgLot.Rows[0].DataItem, "ASSY_LOTID", txtAssyLotID.Text);
        }
        ...
        private void SetWorkOrder()
        {
            try
            {
                ...
                newRow["FORM_WRK_TYPE_CODE"] = Util.NVC(cboFormWorkType.SelectedValue);
        ...
        private void GetAssyLotInfo()
        {
            try
            {
                ...
                if (dtResult != null && dtResult.Rows.Count > 0)
                {
                    ...
                    {
                        if (!Util.NVC(dtResult.Rows[0]["LOTTYPE"]).Equals("N"))
                        {
                            // 반품 재작업인 경우 LOT 유형이 N(반품)만 투입가능 투입 가능 합니다.
                            Util.MessageValidation("SFU4569");
        ...
        private void StartRunProcess()
        {
            try
            {
                ...
                inTable.Columns.Add("WO_DETL_ID", typeof(string));                     // (*)활성화 작업 유형
        ...
        private bool ValidateStartRun()
        {
            ...
            _rowIndex = _Util.GetDataGridFirstRowIndexWithTopRow(dgWO, "CHK");
            ...
            if (Util.NVC(DataTableConverter.GetValue(dgLot.Rows[0].DataItem, "MKT_TYPE_CODE")) != Util.NVC(DataTableConverter.GetValue(dgWO.Rows[_rowIndex].DataItem, "MKT_TYPE_CODE")))
            {
                // 선택한 W/O의 시장유형과 조립 LOT의 시장유형이 틀립니다.
                Util.MessageValidation("SFU4247");
                return false;
            }
