...
{
    /// <summary>
    /// FORM001_ROUTE_MMD_RouteSelectorGrade.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class FORM001_ROUTE_MMD_RouteSelectorGrade : C1Window, IWorkArea
    {
        ...
        public FORM001_ROUTE_MMD_RouteSelectorGrade()
        {
            InitializeComponent();
        }
        #endregion
