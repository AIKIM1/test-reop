...
{
    public partial class FORM001_020 : IWorkArea
    {
        #region Declaration
        ...
        {
            _processCode = Process.SmallPacking;
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_020_RUNSTART popupRunStart = new FORM001_020_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_020_RUNSTART popup = sender as FORM001_020_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_020_CONFIRM popupConfirm = new FORM001_020_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_020_CONFIRM popup = sender as FORM001_020_CONFIRM;
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_020_PALETTE_CREATE popupPalletCreate = new FORM001_020_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_020_PALETTE_CREATE popupPalletEdit = new FORM001_020_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_020_PALETTE_CREATE popup = sender as FORM001_020_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
        ...
        private bool ValidationCompletion()
        {
            ...
            //// 투입수 <> 생산량
            //if (Util.NVC(DataTableConverter.GetValue(DgProductLot.Rows[rowIndex].DataItem, "INPUT_QTY")) != Util.NVC(DataTableConverter.GetValue(DgProductLot.Rows[rowIndex].DataItem, "PRODUCT_QTY")))
            //{
            //    // 투입과 생산이 같아야 작업 완료할 수 있습니다.
            //    Util.MessageValidation("SFU4033");
            //    return false;
            //}
            ...
            ////if (drchk.Length > 0)
            ////{
            ////    // 다음 공정으로 이동되지 않은 Pallet가 존재 합니다.
            ////    Util.MessageValidation("다음 공정으로 이동되지 않은 Pallet가 존재 합니다.");
            ////    return false;
            ////}
