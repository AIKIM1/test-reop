...
{
    /// <summary>
    /// FORM001_ROUTE_MMD_RouteGradeMJudgSet.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class FORM001_ROUTE_MMD_RouteGradeMJudgSet : C1Window, IWorkArea
    {
        ...
        public FORM001_ROUTE_MMD_RouteGradeMJudgSet()
        {
            InitializeComponent();
        }
        #endregion
