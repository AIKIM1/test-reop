...
{
    public partial class FORM001_001_PALETTE_CREATE : C1Window, IWorkArea
    {
        #region Declaration
        ...
        public FORM001_001_PALETTE_CREATE()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void SetControlVisibility()
        {
            ...
            tbQultType.Visibility = Visibility.Collapsed;
            cboQultType.Visibility = Visibility.Collapsed;
        ...
        private void SetGridCreatePallet()
        {
            try
            {
                ...
                ////newRow["QLTY_TYPE_CODE"] = cboQultType.SelectedValue ?? cboQultType.SelectedValue.ToString();
        ...
        private void SetCreatePallet()
        {
            try
            {
                ...
                const string bizRuleName = "BR_PRD_REG_CREATE_PALLET_GD";
