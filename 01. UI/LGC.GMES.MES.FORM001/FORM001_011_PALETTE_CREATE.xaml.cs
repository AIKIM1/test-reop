...
{
    public partial class FORM001_011_PALETTE_CREATE : C1Window, IWorkArea
    {
        #region Declaration
        ...
        public FORM001_011_PALETTE_CREATE()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            FORM001_PALLET_FCS_LIST popupPalletFCSList = new FORM001_PALLET_FCS_LIST { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_PALLET_FCS_LIST popup = sender as FORM001_PALLET_FCS_LIST;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
