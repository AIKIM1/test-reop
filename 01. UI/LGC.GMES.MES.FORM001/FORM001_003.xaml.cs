/*************************************************************************************
 Created Date : 2017.07.31
      Creator : 
   Decription : 초소형 Grading/외관 공정진척
--------------------------------------------------------------------------------------
 [Change History]
**************************************************************************************/
...
{
    public partial class FORM001_003 : IWorkArea
    {
        #region Declaration
        ...
        {
            _processCode = Process.SmallGrader;
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_003_RUNSTART popupRunStart = new FORM001_003_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_003_RUNSTART popup = sender as FORM001_003_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_003_CONFIRM popupConfirm = new FORM001_003_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_003_CONFIRM popup = sender as FORM001_003_CONFIRM;
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_003_PALETTE_CREATE popupPalletCreate = new FORM001_003_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_003_PALETTE_CREATE popupPalletEdit = new FORM001_003_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_003_PALETTE_CREATE popup = sender as FORM001_003_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
