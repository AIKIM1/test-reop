...
{
    public partial class FORM001_026 : IWorkArea
    {
        #region Declaration
        ...
        private void SetEventInUserControls()
        {
            if (UcPolymerFormCommand != null)
            {
                ...
                UcPolymerFormCommand.ButtonChangeAommGrade.Click += ButtonChangeAommGrade_Click;
            }
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            if (_isLoaded == false)
            {
                _processCode = Process.PolymerTaping;
        ...
        private void ButtonChangeAommGrade_Click(object sender, RoutedEventArgs e)
        {
            FORM001_CHANGE_AOMM_GRADE popupAomm = new FORM001_CHANGE_AOMM_GRADE { FrameOperation = FrameOperation };

            popupAomm.FrameOperation = this.FrameOperation;

            object[] parameters = new object[4];
            C1WindowExtension.SetParameters(popupAomm, parameters);

            grdMain.Children.Add(popupAomm);
            popupAomm.BringToFront();
        }
