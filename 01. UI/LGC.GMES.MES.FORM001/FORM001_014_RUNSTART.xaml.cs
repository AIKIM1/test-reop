...
{
    public partial class FORM001_014_RUNSTART : C1Window, IWorkArea
    {
        #region Declaration
        Util _Util = new Util();
        ...
        private void StartRunProcess()
        {
            try
            {
                ...
                const string bizRuleName = "BR_PRD_REG_START_PROD_LOT_VT";
