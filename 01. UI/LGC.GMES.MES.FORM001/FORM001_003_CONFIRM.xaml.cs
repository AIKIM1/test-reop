...
{
    public partial class FORM001_003_CONFIRM : C1Window, IWorkArea
    {
        #region Declaration
        ...
        private void SetGridProduct()
        {
            try
            {
                ...
                _dtProductSum = new DataTable();
                _dtProductSum = new ClientProxy().ExecuteServiceSync("DA_PRD_SEL_CONFIRM_PRODUCT_SUM_FO", "INDATA", "OUTDATA", inTable);

                Util.GridSetData(dgProduct, _dtProductSum, null);
