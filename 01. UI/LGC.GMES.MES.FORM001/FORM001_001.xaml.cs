...
{
    public partial class FORM001_001 : IWorkArea
    {
        #region Declaration
        ...
        {
            _processCode = Process.CircularGrader;
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_001_RUNSTART popupRunStart = new FORM001_001_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_001_RUNSTART popup = sender as FORM001_001_RUNSTART;
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_001_CONFIRM popupConfirm = new FORM001_001_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_001_CONFIRM popup = sender as FORM001_001_CONFIRM;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
                GetProductLot(false);
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_001_PALETTE_CREATE popupPalletCreate = new FORM001_001_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_001_PALETTE_CREATE popupPalletEdit = new FORM001_001_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_001_PALETTE_CREATE popup = sender as FORM001_001_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
