...
{
    public partial class FORM001_CONFIRM : C1Window, IWorkArea
    {
        #region Declaration
        ...
        private string _equipmentSegmentCode = string.Empty;        // 설비코드
        ...
        public bool LastConfirm { get; set; }
        ...
        private void SetControl()
        {
            ...
            _equipmentSegmentCode = tmps[7] as string;
            ...
            txtNote.Text = prodLot["WIP_NOTE"].ToString();
        ...
        private void SetControlVisibility()
        {
            ...
            {
                dgProduct.Columns["INPUT_QTY"].Visibility = Visibility.Collapsed;
        ...
        private void btnConfirm_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (LastConfirm.Equals(true))
            {
                // 최종 외관 마지막 조립LOT 확정시 전부 불량인 경우 대차 삭제 메세지 표시
                // 실적 확정시 대차가 삭제 됩니다. 실적확정 하시겠습니까?
                Util.MessageInfo("SFU4498", (result) =>
                {
        ...
        public void SetGridProduct()
        {
            try
            {
                ...
                newRow["DEVISION"] = string.IsNullOrWhiteSpace(_divisionCode) || _divisionCode.Length < 1? null : _divisionCode.Substring(0,1);
        ...
        private void ConfirmProcess()
        {
            try
            {
                ...
                ShowLoadingIndicator();
                const string bizRuleName = "BR_PRD_REG_END_PROD_LOT_MCP";
        ...
        private bool ValidateConfirmRun()
        {
            ...
            if (string.IsNullOrWhiteSpace(DataTableConverter.GetValue(dgProduct.Rows[0].DataItem, "PRODUCT_QTY").GetString())
                || Util.NVC_Int(DataTableConverter.GetValue(dgProduct.Rows[0].DataItem, "PRODUCT_QTY").GetString()).Equals(0))
            {
                // 생산량이 없습니다.
                Util.MessageValidation("SFU1613");
                return false;
        ...
        private void ButtonShift_Click(object sender, RoutedEventArgs e)
        {
            ...
            parameters[2] = _equipmentSegmentCode;      // LoginInfo.CFG_EQSG_ID;
        ...
        private void popupShiftUser_Closed(object sender, EventArgs e)
        {
            ...
            {
                //GetEqptWrkInfo();
                UcPolymerFormShift.TextShiftStartTime.Text = Util.NVC(popup.WRKSTRTTIME);
                UcPolymerFormShift.TextShiftEndTime.Text = Util.NVC(popup.WRKENDTTIME);
                UcPolymerFormShift.TextShiftDateTime.Text = UcPolymerFormShift.TextShiftStartTime.Text + " ~ " + UcPolymerFormShift.TextShiftEndTime.Text;
                UcPolymerFormShift.TextWorker.Text = Util.NVC(popup.USERNAME);
                UcPolymerFormShift.TextWorker.Tag = Util.NVC(popup.USERID);
                UcPolymerFormShift.TextShift.Text = Util.NVC(popup.SHIFTNAME);
                UcPolymerFormShift.TextShift.Tag = Util.NVC(popup.SHIFTCODE);
            }
            this.Focus();
        }
        #endregion
