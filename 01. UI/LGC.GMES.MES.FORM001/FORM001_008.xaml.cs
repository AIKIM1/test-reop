...
{
    public partial class FORM001_008 : IWorkArea
    {
        #region Declaration
        ...
        {
            _processCode = Process.SmallDoubleTab;
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_008_RUNSTART popupRunStart = new FORM001_008_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_008_RUNSTART popup = sender as FORM001_008_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_008_CONFIRM popupConfirm = new FORM001_008_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_008_CONFIRM popup = sender as FORM001_008_CONFIRM;
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_008_PALETTE_CREATE popupPalletCreate = new FORM001_008_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_008_PALETTE_CREATE popupPalletEdit = new FORM001_008_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_008_PALETTE_CREATE popup = sender as FORM001_008_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
