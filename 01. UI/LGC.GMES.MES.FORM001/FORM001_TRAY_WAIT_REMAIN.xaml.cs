...
{
    public partial class FORM001_TRAY_WAIT_REMAIN : C1Window, IWorkArea
    {
        #region Declaration
        ...
        public FORM001_TRAY_WAIT_REMAIN()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void SetControl()
        {
            ...
            DataRow prodLotId = tmps[4] as DataRow;

            if (prodLotId == null)
                return;

            DataTable prodPalletBind = new DataTable();
            prodPalletBind = prodLotId.Table.Clone();
            prodPalletBind.ImportRow(prodLotId);

            txtProdLotID.Text = prodPalletBind.Rows[0]["LOTID"].ToString();
            txtAssyLotID.Text = prodPalletBind.Rows[0]["ASSY_LOTID"].ToString();
            ...
            SetGradeComboCode(cboCapa, "CAPA_GRD_CODE","G");
            SetGradeComboCode(cboRsst, "RSST_GRD_CODE");
            SetGradeComboCode(cboVltg, "VLTG_GRD_CODE");
        ...
        private void SetCreatePallet()
        {
            try
            {
                ...
                const string bizRuleName = "BR_PRD_REG_REMAIN_TRAY_OC";

                // DATA SET
                DataSet inDataSet = GetBR_PRD_REG_REMAIN_TRAY();
                ...
                newRow["PROD_LOTID"] = txtProdLotID.Text;
                ...
                newRow["CAPA_GRD_CODE"] = cboCapa.SelectedValue.ToString().Equals("SELECT") ? null : cboCapa.SelectedValue.ToString(); ;
                newRow["VLTG_GRD_CODE"] = cboVltg.SelectedValue.ToString().Equals("SELECT") ? null : cboVltg.SelectedValue.ToString(); ;
                newRow["RSST_GRD_CODE"] = cboRsst.SelectedValue.ToString().Equals("SELECT") ? null : cboRsst.SelectedValue.ToString(); ;
        ...
        /// 용량
        /// </summary>
        private void SetGradeComboCode(C1ComboBox _combo, string comTypeCode, string QltyTypeCode = null)
        {
            try
            {
                ...
                _combo.DisplayMemberPath = "CBO_NAME";
                _combo.SelectedValuePath = "CBO_CODE";
                _combo.ItemsSource = DataTableConverter.Convert(dtResult);
        ...
        private DataSet GetBR_PRD_REG_REMAIN_TRAY()
        {
