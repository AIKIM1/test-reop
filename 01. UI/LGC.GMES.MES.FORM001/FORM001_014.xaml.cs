...
{
    public partial class FORM001_014 : IWorkArea
    {
        #region Declaration
        ...
        {
            _processCode = Process.CircularVoltage;
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_014_RUNSTART popupRunStart = new FORM001_014_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_014_RUNSTART popup = sender as FORM001_014_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_014_CONFIRM popupConfirm = new FORM001_014_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_014_CONFIRM popup = sender as FORM001_014_CONFIRM;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
                GetProductLot(false);
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_014_PALETTE_CREATE popupPalletCreate = new FORM001_014_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_014_PALETTE_CREATE popupPalletEdit = new FORM001_014_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_014_PALETTE_CREATE popup = sender as FORM001_014_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
