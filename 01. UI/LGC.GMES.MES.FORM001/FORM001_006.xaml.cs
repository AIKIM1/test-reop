...
{
    public partial class FORM001_006 : IWorkArea
    {
        #region Declaration
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_006_RUNSTART popupRunStart = new FORM001_006_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_006_RUNSTART popup = sender as FORM001_006_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_006_CONFIRM popupConfirm = new FORM001_006_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_006_CONFIRM popup = sender as FORM001_006_CONFIRM;
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_006_PALETTE_CREATE popupPalletCreate = new FORM001_006_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_006_PALETTE_CREATE popupPalletEdit = new FORM001_006_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_006_PALETTE_CREATE popup = sender as FORM001_006_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
