...
{
    public partial class FORM001_011 : IWorkArea
    {
        #region Declaration
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_011_RUNSTART popupRunStart = new FORM001_011_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_011_RUNSTART popup = sender as FORM001_011_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_011_CONFIRM popupConfirm = new FORM001_011_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_011_CONFIRM popup = sender as FORM001_011_CONFIRM;
        ...
        private void ButtonChangeProdLot_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_011_CHANGE_PROD_LOT popupChangeProdLot = new FORM001_011_CHANGE_PROD_LOT { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_011_CHANGE_PROD_LOT popup = sender as FORM001_011_CHANGE_PROD_LOT;
        ...
        private void SetPopupGoodPalletCreate(string sQltyType = "G")
        {
            ...
            FORM001_011_PALETTE_CREATE popupPalletCreate = new FORM001_011_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_011_PALETTE_CREATE popupPalletEdit = new FORM001_011_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_011_PALETTE_CREATE popup = sender as FORM001_011_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
