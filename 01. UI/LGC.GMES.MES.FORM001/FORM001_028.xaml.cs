...
{
    public partial class FORM001_028 : IWorkArea
    {
        #region Declaration
        ...
        public UcPolymerFormInputTCO UcPolymerFormInputTCO { get; set; }
        ...
        private void InitializeUserControls()
        {
            ...
            UcPolymerFormInputTCO = grdInput.Children[0] as UcPolymerFormInputTCO;
            ...
            if (UcPolymerFormInputTCO != null)
            {
                UcPolymerFormInputTCO.UcParentControl = this;
                UcPolymerFormInputTCO.FrameOperation = FrameOperation;
                UcPolymerFormInputTCO.ProcessCode = _processCode;
                UcPolymerFormInputTCO.ProcessName = _processName;
                UcPolymerFormInputTCO.SetControlHeader();
                UcPolymerFormInputTCO.SetDataGridColumnVisibility();
            }
        ...
        private void InitializeUserControlsGrid()
        {
            ...
            DgInputPallet = UcPolymerFormInputTCO.DgPallet;
        ...
        private void SetEventInUserControls()
        {
            ...
            if (UcPolymerFormInputTCO != null)
            {
                UcPolymerFormInputTCO.ButtonPalletRemainWait.Click += ButtonPalletRemainWait_Click;
            }
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            if (_isLoaded == false)
            {
                _processCode = Process.PolymerSideTaping;
        ...
        private void ButtonPalletRemainWait_Click(object sender, RoutedEventArgs e)
        {
            ...
            parameters[2] = Util.NVC(ComboEquipment.SelectedValue);
            parameters[3] = Util.NVC(ComboEquipment.Text);
            parameters[4] = UcPolymerFormInputTCO.GetSelectInputPalletRow();
        ...
        private void popuInboxRemain_Closed(object sender, EventArgs e)
        {
            ...
            {
                GetProductLot(true);
                UcPolymerFormInputTCO.SelectInputPalletList();
            }
            GetEqptWrkInfo();
            GetUserControlShift();
                ...
                new ClientProxy().ExecuteService(bizRuleName, "RQSTDT", "RSLTDT", inTable, (result, ex) =>
                {
                    ...
                    else
                    {
                        ...
                        if (result == null || result.Rows.Count == 0)
                        {
                            // Clear ALL
                            GetProductCart();
                            UcPolymerFormInputTCO.InitializeControls();
                            UcPolymerFormProductionResult.InitializeControls();
                            HiddenLoadingIndicator();
                            return;
                        }
        ...
        public void ProdListClickedProcess(int iRow)
        {
            try
            {
                ...
                UcPolymerFormInputTCO.ProdLotId = lotId;
                UcPolymerFormInputTCO.ProdWipSeq = wipSeq;
                UcPolymerFormInputTCO.ProdAssyLotId = assyLot;
                UcPolymerFormInputTCO.ProdJobStartDT = jobstart;
                ...
                UcPolymerFormInputTCO.SelectInpuList();
        ...
        private void GetUserControlEquipmentCode()
        {
            ...
            UcPolymerFormInputTCO?.ChangeEquipment(equipmentCode, ComboEquipment.Text);
