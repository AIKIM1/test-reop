...
{
    public partial class FORM001_015 : IWorkArea
    {
        #region Declaration
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_015_RUNSTART popupRunStart = new FORM001_015_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_015_RUNSTART popup = sender as FORM001_015_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_015_CONFIRM popupConfirm = new FORM001_015_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_015_CONFIRM popup = sender as FORM001_015_CONFIRM;
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_015_PALETTE_CREATE popupPalletCreate = new FORM001_015_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_015_PALETTE_CREATE popupPalletEdit = new FORM001_015_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_015_PALETTE_CREATE popup = sender as FORM001_015_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
