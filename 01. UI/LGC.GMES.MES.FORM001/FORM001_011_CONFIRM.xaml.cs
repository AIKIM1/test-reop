...
{
    public partial class FORM001_011_CONFIRM : C1Window, IWorkArea
    {
        #region Declaration
        ...
        private void C1Window_Loaded(object sender, RoutedEventArgs e)
        {
            if (_load)
            {
                ...
                SetGridVisulMode(); // 외관 모드 콤보
                SetGridDtctPstn(); // 검출위치 콤보
        ...
        private void SetPalletIDNextSave(DataTable dt)
        {
            try
            {
                ...
                dgDefect.Columns["VISUAL_MODE"].IsReadOnly = true;
                dgDefect.Columns["DTCT_PSTN"].IsReadOnly = true;
