...
{
    public partial class FORM001_002_CONFIRM : C1Window, IWorkArea
    {
        #region Declaration
        ...
        private void ConfirmProcess()
        {
            try
            {
                ...
                foreach (C1.WPF.DataGrid.DataGridRow dRow in dgDefect.Rows)
                {
                    ...
                    newRow["ACTUSER"] = Util.NVC(DataTableConverter.GetValue(dRow.DataItem, "ACTUSER"));
