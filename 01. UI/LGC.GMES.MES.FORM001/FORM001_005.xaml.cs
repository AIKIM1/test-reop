...
{
    public partial class FORM001_005 : IWorkArea
    {
        #region Declaration
        ...
        public UcFormInputTab UcFormInputTab { get; set; }
        ...
        private void Initialize()
        {
            ...
            if (ComboEquipment?.SelectedValue != null)
            {
                ...
                UcFormInputTab.EquipmentCode = ComboEquipment.SelectedValue.GetString();
            }

            UcFormInputTab?.ChangeEquipment(equipmentCode);
            UcFormInputTab.SetCombo();
        }
        ...
        private void InitializeUserControls()
        {
            ...
            UcFormInputTab = grdInput.Children[0] as UcFormInputTab;
            ...
            if (UcFormInputTab != null)
            {
                UcFormInputTab.UcParentControl = this;
                UcFormInputTab.FrameOperation = FrameOperation;
                UcFormInputTab.ProcessCode = _processCode;
                UcFormInputTab.SetDataGridColumnVisibility();
            }
        ...
        private void InitializeUserControlsGrid()
        {
            ...
            DgInputPallet = UcFormInputTab.DgPallet;
        ...
        private void SetEventInUserControls()
        {
            ...
            if (UcFormInputTab != null)
            {
                UcFormInputTab.ButtonPalletRemainWait.Click += ButtonPalletRemainWait_Click;
            }
        ...
        {
            _processCode = Process.SmallExternalTab;
            ...
            UcFormInputTab.TextBoxPalletID.Focus();
        }
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_005_RUNSTART popupRunStart = new FORM001_005_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_005_RUNSTART popup = sender as FORM001_005_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_005_CONFIRM popupConfirm = new FORM001_005_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_005_CONFIRM popup = sender as FORM001_005_CONFIRM;
        ...
        private void ButtonPalletRemainWait_Click(object sender, RoutedEventArgs e)
        {
            ...
            parameters[2] = Util.NVC(ComboEquipment.SelectedValue);
            parameters[3] = Util.NVC(ComboEquipment.Text);
            parameters[4] = UcFormInputTab.GetSelectInputPalletRow();
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_005_PALETTE_CREATE popupPalletCreate = new FORM001_005_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_005_PALETTE_CREATE popupPalletEdit = new FORM001_005_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_005_PALETTE_CREATE popup = sender as FORM001_005_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
        ...
        private void ComboEquipment_SelectedValueChanged(object sender, PropertyChangedEventArgs<object> e)
        {
            try
            {
                ...
                UcFormInputTab?.ChangeEquipment(ComboEquipment.SelectedValue.ToString());
                UcFormInputTab.SetCombo();
                UcFormInputTab.SelectInpuList();
        ...
        public void GetProductLot(bool ProductOnly, string prodLot = null)
        {
            try
            {
                ...
                ////UcFormInputTab.InitializeControls();
        ...
        public void ProdListClickedProcess(int iRow)
        {
            try
            {
                ...
                UcFormInputTab.ProdLotId = Util.NVC(DataTableConverter.GetValue(DgProductLot.Rows[iRow].DataItem, "LOTID"));
                UcFormInputTab.ProdWipSeq = Util.NVC(DataTableConverter.GetValue(DgProductLot.Rows[iRow].DataItem, "WIPSEQ"));
        ...
        private bool ValidationCancel()
        {
            ...
            // 투입 자재 존재여부 확인
            if (UcFormInputTab.DgMaterial.Rows.Count - UcFormInputTab.DgMaterial.FrozenBottomRowsCount > 0)
            {
                // 투입이력이 존재하여 취소할 수 없습니다.
                Util.MessageValidation("SFU3437");
                return false;
