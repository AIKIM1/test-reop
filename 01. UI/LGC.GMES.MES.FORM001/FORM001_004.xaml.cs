...
{
    public partial class FORM001_004 : IWorkArea
    {
        #region Declaration
        ...
        private void SetEventInUserControls()
        {
            ...
            if (UcFormSearch != null)
            {
                ...
                UcFormSearch.ButtonFlofChange.Click += ButtonFlowChange_Click;
        ...
        {
            _processCode = Process.SmallXray;
        ...
        private void ButtonFlowChange_Click(object sender, RoutedEventArgs e)
        {
            FORM001_ROUTEFLOW popupRouteFlow = new FORM001_ROUTEFLOW { FrameOperation = FrameOperation };
            ...
            parameters[4] = UcFormSearch.TextBoxRouteFlow.Text;
            parameters[5] = UcFormSearch.TextBoxProcName.Text;
            parameters[6] = UcFormSearch.TextBoxProcName.Tag ?? UcFormSearch.TextBoxProcName.Tag;
            C1WindowExtension.SetParameters(popupRouteFlow, parameters);

            popupRouteFlow.Closed += new EventHandler(popupRouteFlow_Closed);
            grdMain.Children.Add(popupRouteFlow);
            popupRouteFlow.BringToFront();

        }

        private void popupRouteFlow_Closed(object sender, EventArgs e)
        {
            FORM001_ROUTEFLOW popup = sender as FORM001_ROUTEFLOW;
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_004_RUNSTART popupRunStart = new FORM001_004_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_004_RUNSTART popup = sender as FORM001_004_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_004_CONFIRM popupConfirm = new FORM001_004_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_004_CONFIRM popup = sender as FORM001_004_CONFIRM;
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_004_PALETTE_CREATE popupPalletCreate = new FORM001_004_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_004_PALETTE_CREATE popupPalletEdit = new FORM001_004_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_004_PALETTE_CREATE popup = sender as FORM001_004_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
        ...
        private void ComboEquipment_SelectedValueChanged(object sender, PropertyChangedEventArgs<object> e)
        {
            try
            {
                ...
                ////UcFormInput?.SelectInputTrayList();
