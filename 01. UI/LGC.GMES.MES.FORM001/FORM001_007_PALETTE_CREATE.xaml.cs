...
{
    public partial class FORM001_007_PALETTE_CREATE : C1Window, IWorkArea
    {
        #region Declaration
        ...
        public FORM001_007_PALETTE_CREATE()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void SetCreatePallet()
        {
            try
            {
                ...
                const string bizRuleName = "BR_PRD_REG_CREATE_PALLET_LI";
