...
{
    public partial class FORM001_005_CONFIRM : C1Window, IWorkArea
    {
        #region Declaration
        ...
        private void SetPalletIDNextSave(DataTable dt)
        {
            try
            {
                ...
                if (_dtPallet != null && _dtPallet.Rows.Count > 0)
                {
                    (dgDefect.Columns["cboPallet"] as C1.WPF.DataGrid.DataGridComboBoxColumn).ItemsSource = DataTableConverter.Convert(_dtPallet.DefaultView.ToTable(true, "LOTID"));
