...
{
    public partial class FORM001_054 : IWorkArea
    {
        #region Declaration
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_054_RUNSTART popupRunStart = new FORM001_054_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_054_RUNSTART popup = sender as FORM001_054_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_054_CONFIRM popupConfirm = new FORM001_054_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_054_CONFIRM popup = sender as FORM001_054_CONFIRM;
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_054_PALETTE_CREATE popupPalletCreate = new FORM001_054_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_054_PALETTE_CREATE popupPalletEdit = new FORM001_054_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_054_PALETTE_CREATE popup = sender as FORM001_054_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
        ...
        private void ButtonInboxCreate_Click(object sender, RoutedEventArgs e)
        {
            ...
            CMM_FORM_INBOX popupInboxCreate = new CMM_FORM_INBOX { FrameOperation = this.FrameOperation };
        ...
        {
            CMM_FORM_INBOX popup = sender as CMM_FORM_INBOX;
            //if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            //{
                UcFormProductionPallet.SelectPalletList();
                //UcFormProductionPallet.SelectPalletSummary();
