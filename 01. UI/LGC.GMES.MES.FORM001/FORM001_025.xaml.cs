...
{
    public partial class FORM001_025 : IWorkArea
    {
        #region Declaration
        ...
        public UcPolymerFormInputHistory UcPolymerFormInputHistory { get; set; }
        ...
        private PopupFindControl PopupFindControlShipto { get; set; }
        ...
        private void InitializeUserControls()
        {
            ...
            UcPolymerFormInputHistory = grdInput.Children[0] as UcPolymerFormInputHistory;
            ...
            if (UcPolymerFormSearch != null)
            {
                ...
                PopupFindControlShipto = UcPolymerFormSearch.PopupFindControlShipto;
            }
            ...
            if (UcPolymerFormInputHistory != null)
            {
                UcPolymerFormInputHistory.UcParentControl = this;
                UcPolymerFormInputHistory.FrameOperation = FrameOperation;
                UcPolymerFormInputHistory.ProcessCode = _processCode;
                UcPolymerFormInputHistory.ProcessName = _processName;
                UcPolymerFormInputHistory.SetControlHeader();
                UcPolymerFormInputHistory.SetDataGridColumnVisibility();
            }
        ...
        private void InitializeUserControlsGrid()
        {
            ...
            DgInputPallet = UcPolymerFormInputHistory.DgPallet;
        ...
        private void SetEventInUserControls()
        {
            if (UcPolymerFormCommand != null)
            {
                ...
                UcPolymerFormCommand.ButtonModeChange.Click += ButtonModeChange_Click;
            ...
            if (UcPolymerFormSearch != null)
            {
                ...
                UcPolymerFormSearch.PopupFindControlShipto.ValueChanged += PopupFindControlShipto_ValueChanged;
            ...
            if (UcPolymerFormCart != null)
            {
                ...
                //UcPolymerFormCart.ButtonCartCreate.Click += ButtonCartCreate_Click;
            ...
            if (UcPolymerFormInputHistory != null)
            {
                UcPolymerFormInputHistory.ButtonPalletRemainWait.Click += ButtonPalletRemainWait_Click;
            }
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            if (_isLoaded == false)
            {
                _processCode = Process.PolymerDSF; ;
        ...
        private void ButtonModeChange_Click(object sender, RoutedEventArgs e)
        {
            if (!ValidationModeChange())
                return;

            CMM_POLYMER_FORM_PRODLOT_MODE_CHANGE popupModeChange = new CMM_POLYMER_FORM_PRODLOT_MODE_CHANGE { FrameOperation = FrameOperation };
            if (ValidationGridAdd(popupModeChange.Name) == false)
                return;
            ...
            parameters[0] = _processCode;
            parameters[1] = DataTableConverter.GetValue(DgProductLot.Rows[iRow].DataItem, "LOTID").GetString();
            parameters[2] = DataTableConverter.GetValue(DgProductLot.Rows[iRow].DataItem, "CTNR_TYPE_CODE").GetString();
            C1WindowExtension.SetParameters(popupModeChange, parameters);

            popupModeChange.Closed += popupModeChangeClosed;
            grdMain.Children.Add(popupModeChange);
            popupModeChange.BringToFront();
        }

        private void popupModeChangeClosed(object sender, EventArgs e)
        {
            CMM_POLYMER_FORM_PRODLOT_MODE_CHANGE popup = sender as CMM_POLYMER_FORM_PRODLOT_MODE_CHANGE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
            }
        ...
        private void ButtonPalletRemainWait_Click(object sender, RoutedEventArgs e)
        {
            ...
            parameters[2] = Util.NVC(ComboEquipment.SelectedValue);
            parameters[3] = Util.NVC(ComboEquipment.Text);
            parameters[4] = UcPolymerFormInputHistory.GetSelectInputPalletRow();
        ...
        private void popuInboxRemain_Closed(object sender, EventArgs e)
        {
            ...
            {
                GetProductLot(true);
                UcPolymerFormInputHistory.SelectInputPalletList();
            }
            GetEqptWrkInfo();
            GetUserControlShift();
        ...
        private void PopupFindControlShipto_ValueChanged(object sender, EventArgs e)
        {
            // 선택 출하처...
            GetUserControlShiptoID();
        }
        ...
        public void GetProductLot(bool ProductOnly, string prodLot = null)
        {
            try
            {
                ...
                ////UcPolymerFormInputHistory.InitializeControls();
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (idx >= 0)
                            {
                                ...
                                UcPolymerFormProductionResult.DataRowProductLot = _util.GetDataGridFirstRowBycheck(DgProductLot, "CHK");
                                UcPolymerFormProductionResult.SetControlVisibility();
                            }
                            else
                            {
        ...
        public void GetProductCart(Button buttonClick = null, bool isSelect = false)
        {
            ...
            // 대차 상세에서 조회시 완성 Inbox 재조회
            int iRow = _util.GetDataGridFirstRowIndexWithTopRow(DgProductLot, "CHK");

            if (iRow > -1)
            {
                if (DataTableConverter.GetValue(DgProductLot.Rows[iRow].DataItem, "CTNR_TYPE_CODE").GetString().Equals("B"))
                {
                    UcPolymerFormProductionResult.SelectResultList();
                }
            }
        ...
        private bool ValidationModeChange()
        {
            int rowIndex = _util.GetDataGridFirstRowIndexWithTopRow(DgProductLot, "CHK");
        ...
        public void GetWorkOrder()
        {
            ...
            Ucworkorder.EQPTSEGMENT = Util.NVC(ComboEquipmentSegment.SelectedValue);
        ...
        public void ProdListClickedProcess(int iRow)
        {
            try
            {
                ...
                UcPolymerFormInputHistory.ProdLotId = lotId;
                UcPolymerFormInputHistory.ProdWipSeq = wipSeq;
                UcPolymerFormInputHistory.ProdAssyLotId = assyLot;
                UcPolymerFormInputHistory.ProdJobStartDT = jobstart;
                ...
                UcPolymerFormInputHistory.SelectInpuList();
                ...
                // 출하처 
                SetShipToPopControl(Util.NVC(dr[0]["PRODID"]));
        ...
        private void SetShipToPopControl(string prodID)
        {
            ...
            CommonCombo.SetFindPopupCombo(bizRuleName, PopupFindControlShipto, arrColumn, arrCondition, (string)PopupFindControlShipto.SelectedValuePath, (string)PopupFindControlShipto.DisplayMemberPath);
        }
        ...
        private void GetUserControlEquipmentCode()
        {
            ...
            UcPolymerFormInputHistory?.ChangeEquipment(equipmentCode, ComboEquipment.Text);
        ...
        private void GetUserControlShiptoID()
        {
            UcPolymerFormProductionResult.ShiptoID = Util.NVC(PopupFindControlShipto.SelectedValue);
        }
