...
{
    public partial class FORM001_007 : IWorkArea
    {
        #region Declaration
        ...
        {
            _processCode = Process.SmallLeak;
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_007_RUNSTART popupRunStart = new FORM001_007_RUNSTART { FrameOperation = FrameOperation };
        ...
        {
            FORM001_007_RUNSTART popup = sender as FORM001_007_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
        ...
        private void ButtonCompletion_Click(object sender, RoutedEventArgs e)
        {
            ...
            FORM001_007_CONFIRM popupConfirm = new FORM001_007_CONFIRM { FrameOperation = FrameOperation };
        ...
        {
            FORM001_007_CONFIRM popup = sender as FORM001_007_CONFIRM;
        ...
        private void SetPopupGoodPalletCreate()
        {
            ...
            FORM001_007_PALETTE_CREATE popupPalletCreate = new FORM001_007_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        private void SetPopupGoodPalletEdit()
        {
            ...
            FORM001_007_PALETTE_CREATE popupPalletEdit = new FORM001_007_PALETTE_CREATE { FrameOperation = this.FrameOperation };
        ...
        {
            FORM001_007_PALETTE_CREATE popup = sender as FORM001_007_PALETTE_CREATE;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                GetProductLot(true);
                UcFormProductionPallet.SelectPalletList();
