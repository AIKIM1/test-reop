...
{
    public partial class FORM001_015_PALETTE_CREATE : C1Window, IWorkArea
    {
        #region Declaration
        ...
        public FORM001_015_PALETTE_CREATE()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void SetControlVisibility()
        {
            if (string.Equals(_create, "Y"))
            {
                ...
                this.Header = ObjectDic.Instance.GetObjectName("대차 생성");
                btnCreate.Content = ObjectDic.Instance.GetObjectName("생성");
            }
            else
            {
                this.Header = ObjectDic.Instance.GetObjectName("대차 수정");
        ...
        private void SetCreatePallet()
        {
            try
            {
                ...
                const string bizRuleName = "BR_PRD_REG_CREATE_PALLET_CCD";
