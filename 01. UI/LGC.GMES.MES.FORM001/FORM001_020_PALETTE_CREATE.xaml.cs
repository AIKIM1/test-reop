...
{
    public partial class FORM001_020_PALETTE_CREATE : C1Window, IWorkArea
    {
        #region Declaration
        ...
        public FORM001_020_PALETTE_CREATE()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void SetCreatePallet()
        {
            try
            {
                ...
                const string bizRuleName = "BR_PRD_REG_CREATE_PALLET_MP";
        ...
        private bool ValidateCreate()
        {
            ...
            if (string.IsNullOrEmpty(UcFormShift.TextShift.Tag.ToString()))
            {
                // 작업조를 입력해 주세요.
            ...
            if (string.IsNullOrEmpty(UcFormShift.TextWorker.Tag.ToString()))
            {
                // 작업자를 입력 해 주세요.
