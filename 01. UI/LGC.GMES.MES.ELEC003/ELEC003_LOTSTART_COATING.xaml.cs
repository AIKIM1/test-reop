...
{
    public partial class ELEC003_LOTSTART_COATING : C1Window, IWorkArea
    {
        #region Initialize
        ...
        private bool _largeLotCreate = false;
        ...
        public bool LargeLotCreate
        {
            get { return _largeLotCreate; }
        }

        public ELEC003_LOTSTART_COATING()
        {
            ApplyPermissions();
            InitializeComponent();
        }
        ...
        public ELEC003_LOTSTART_COATING(Dictionary<string, string> dic)
        {
            InitializeComponent();
            try
            {
        ...
        //2022-09-15 유재홍 코터 설비의 GMES UI 상 수당 자랏 생성 기능 수정 요청건
        ...
        private void GetCurrentMount()
        {
            try
            {
                ...
                if (dtMain.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow _iRow in dtMain.Select("MTRL_CLSS_CODE = 'MFL'"))
        ...
        private bool ValidData()
        {
            ...
            if (string.Equals(sSlittingFlag, "Y"))
                //2022-09-14 유재홍 공통코드 항목에 따라 코터자랏 UI생성옵션 변경
                if (IsAreaCommonCodeUse("ELEC_CHK_LARGE_LOT_FOR_PROC_LOT", Process.COATING))
                {
        ...
        private void LotStart()
        {
            ...
            try
            {
                ...
                {
                    if (chkFirstFlag.IsChecked == true)
                        _largeLotCreate = true;
