/*************************************************************************************
 Created Date : 2021.07.20
      Creator : 조영대
   Decription : 전극 공정진척 - 생산실적 : 표면검사, REWINDER(E3800)
--------------------------------------------------------------------------------------
 [Change History]
...
namespace LGC.GMES.MES.ELEC003.Controls
{
    ...
    /// </summary>
    public partial class UcElectrodeProductionResult_ReWinder : UserControl
    {
        #region Declaration
        ...
        public UcElectrodeProductionResult_ReWinder()
        {
            InitializeComponent();
