/*************************************************************************************
 Created Date : 2021.12.15
      Creator : 조영대
   Decription : 전극 공정진척 - 생산실적 (E4200 Two Slitting) : Copy by UcElectrodeProductionResult_TwoSlitting
--------------------------------------------------------------------------------------
 [Change History]
  2021.12.15  강동희 : Initial Created.
  2024.05.29  양영재 : [E20240430-000680] 슬리터 공정 모든 레인 특이사항에 공통 특이사항 자동반영 요청건
**************************************************************************************/
...
namespace LGC.GMES.MES.ELEC003.Controls
{
    ...
    public partial class UcElectrodeProductionResult_TwoSlitting : UserControl
    {
        #region Declaration
        ...
        public UcElectrodeProductionResult_TwoSlitting()
        {
            InitializeComponent();
        ...
        private void dgWipReason_PreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (dg != null && dg.CurrentCell != null && dg.CurrentCell.Presenter != null)
            {
                ...
                {
                    if (_isRollMapEquipment && (string.Equals(ProcessCode, Process.TWO_SLITTING)))
                    {
