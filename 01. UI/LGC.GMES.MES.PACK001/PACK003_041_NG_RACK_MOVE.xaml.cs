...
--------------------------------------------------------------------------------------
 [Change History]
  2023.08.04  김선준           Initialize 
  2023.12.22  김선준           Rack Scan후 Return 추가
**************************************************************************************/
using C1.WPF;
...
{
    public partial class PACK003_041_NG_RACK_MOVE : C1Window, IWorkArea
    {
        ...
        public PACK003_041_NG_RACK_MOVE()
        {
            InitializeComponent();
        }
        #endregion
