...
-----------------------------------------------------------------------------------------------------------------------------------
  ...
  2025.06.25                               김홍기           Pack 영역 화면 분리 호출BIZ 변경(BR_INV_SEL_MTRL_PROC_DETAIL -> DA_INV_SEL_MTRL_PROC_DETAIL)
***********************************************************************************************************************************/
...
{
    public partial class PACK003_050 : UserControl, IWorkArea
    {
        #region Declaration
        ...
        private void DetailData(string MtrlID, string Loc)
        {
            try
            {
                ...
                string bizRule = "DA_INV_SEL_MTRL_PROC_DETAIL";
        ...
        private void ChkInputWhLocation()
        {
            try
            {
                ...
                else if (dtResult?.Rows?.Count > 0 && Util.NVC(dtResult.Rows[0]["BUSINESS_USAGE_CODE_ID"]).Equals(cboLoc.SelectedValue.ToString()))
                {
