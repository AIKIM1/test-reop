/*************************************************************************************
 Created Date : 2023.10.25
      Creator : 김용군
   Decription : ZZS라인 ZTZ 공정진척 - 작업시작(ASSY005_001_RUNSTART Copy 후 작성)
--------------------------------------------------------------------------------------
 [Change History]
...
{
    /// <summary>
    /// ASSY006_ZTZ_RUNSTART.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY006_ZTZ_RUNSTART : C1Window, IWorkArea
    {
        ...
        private void RunStart()
        {
            try
            {
                ...
                else if (_procid.Equals(Process.ZTZ))
                    sBizName = "BR_PRD_REG_START_LOT_ASSY_LS";
