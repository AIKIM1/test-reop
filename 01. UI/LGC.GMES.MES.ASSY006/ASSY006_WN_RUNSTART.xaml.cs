/*************************************************************************************
 Created Date : 2021.12.23
      Creator : 신광희 
   Decription : 소형 조립 공정진척(NFF) Winding 공정 착공 ASSY002_010_RUNSTART 참고
--------------------------------------------------------------------------------------
 [Change History]
...
{
    public partial class ASSY006_WN_RUNSTART : C1Window, IWorkArea
    {
        #region Declaration
        ...
        {
            //ASSY006_004_WAITING_PANCAKE_SEARCH _InputProduct = sender as ASSY006_004_WAITING_PANCAKE_SEARCH;
