...
namespace LGC.GMES.MES.ASSY006
{
    ...
    /// </summary>
    public partial class ASSY006_WASHING_CELL_MANAGEMENT : C1Window, IWorkArea
    {
        ...
        public ASSY006_WASHING_CELL_MANAGEMENT()
        {
            InitializeComponent();
        }

        private void ASSY006_WASHING_CELL_MANAGEMENT_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void btnCell_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                bSave = true;
                ASSY006_WASHING_INPUT_CELL popInputCell = new ASSY006_WASHING_INPUT_CELL { FrameOperation = FrameOperation };
        ...
        private void btnCan_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                bSave = true;
                ASSY006_WASHING_INPUT_CAN popInputCell = new ASSY006_WASHING_INPUT_CAN { FrameOperation = FrameOperation };
        ...
        private void btnCanVent_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                bSave = true;
                ASSY006_WASHING_INPUT_CAN_VENT popInputCell = new ASSY006_WASHING_INPUT_CAN_VENT { FrameOperation = FrameOperation };
        ...
        {
            ASSY006_WASHING_INPUT_CELL popup = sender as ASSY006_WASHING_INPUT_CELL;
        ...
        {
            ASSY006_WASHING_INPUT_CAN popup = sender as ASSY006_WASHING_INPUT_CAN;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                //SetGridCell(false);
                SetCellInfo();
        ...
        {
            ASSY006_WASHING_INPUT_CAN_VENT popup = sender as ASSY006_WASHING_INPUT_CAN_VENT;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                //SetGridCell(false);
                SetCellInfo();
        ...
        private void popMatchCell_Closed(object sender, EventArgs e)
        {
            ...
            ASSY006_WASHING_CELL_MATCH popup = sender as ASSY006_WASHING_CELL_MATCH;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                //SetGridCell(false);
                SetCellInfo();
        ...
        private void btnMatch_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                bSave = true;
                ASSY006_WASHING_CELL_MATCH popMatchCell = new ASSY006_WASHING_CELL_MATCH { FrameOperation = FrameOperation };
