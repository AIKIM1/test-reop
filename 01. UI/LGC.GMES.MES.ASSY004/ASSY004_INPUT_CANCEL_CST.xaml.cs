/*************************************************************************************
 Created Date : 2019.05.15
      Creator : INS 김동일K
   Decription : CWA3동 증설 - 공정진척 화면 - RFID 투입취소 팝업 (ASSY0001.ASSY001_INPUT_CANCEL_CST 2019/05/15 소스 카피 후 작성)
--------------------------------------------------------------------------------------
 [Change History]
  2019.05.15  INS 김동일K : Initial Created.
  2019.08.14      정문교  : 로더 투입 캐리어 EMPTY 유형 코드 "U"이면 
                            투입 취소시 CST ID 입력 여부 체크 제외 
**************************************************************************************/
...
{
    /// <summary>
    /// ASSY004_INPUT_CANCEL_CST.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY004_INPUT_CANCEL_CST : C1Window, IWorkArea
    {
        ...
        public ASSY004_INPUT_CANCEL_CST()
        {
            InitializeComponent();
        }
