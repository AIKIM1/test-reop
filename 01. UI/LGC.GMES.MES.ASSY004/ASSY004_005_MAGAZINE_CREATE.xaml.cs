/*************************************************************************************
 Created Date : 2019.05.15
      Creator : INS 김동일K
   Decription : CWA3동 증설 - 폴딩 공정진척 화면 - 매거진 재구성 팝업 (ASSY0001.ASSY001_005_MAGAZINE_CREATE 2019/05/15 소스 카피 후 작성)
--------------------------------------------------------------------------------------
 [Change History]
...
{
    /// <summary>
    /// ASSY004_005_MAGAZINE_CREATE.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY004_005_MAGAZINE_CREATE : C1Window, IWorkArea
    {
        ...
        public ASSY004_005_MAGAZINE_CREATE()
        {
            InitializeComponent();
        }
