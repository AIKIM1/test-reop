...
--------------------------------------------------------------------------------------
 [Change History]
 수정일자        개발자     CSR                  내용
 2024.11.27     박성진     E20240923-000237     요청자 미선택하고 실적확정 시 에러발생 조치(MES 2.0 Catch-Up)
...
namespace LGC.GMES.MES.ASSY004
{
    ...
    /// </summary>
    public partial class ASSY004_061_CONFIRM : C1Window, IWorkArea
    {
