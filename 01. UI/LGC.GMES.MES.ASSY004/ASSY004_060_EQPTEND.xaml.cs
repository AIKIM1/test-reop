...
--------------------------------------------------------------------------------------
 [Change History]
  2019.10.30  정문교 : Initial Created.   폴란드3동 & 빈강용 조립 공정에서 사용
                                          ASSY004_COM_EQPTEND Copy ASSY004_060_EQPTEND
...
namespace LGC.GMES.MES.ASSY004
{
    ...
    /// </summary>
    public partial class ASSY004_060_EQPTEND : C1Window, IWorkArea
    {
