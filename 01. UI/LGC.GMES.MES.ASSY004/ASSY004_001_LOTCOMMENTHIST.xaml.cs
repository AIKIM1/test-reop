/*************************************************************************************
 Created Date : 2019.04.11
      Creator : INS 김동일K
   Decription : CWA3동 증설 - 노칭 공정진척 화면 - LOT 특이사항 이력 팝업
--------------------------------------------------------------------------------------
 [Change History]
...
{
    /// <summary>
    /// ASSY004_001_LOTCOMMENTHIST.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY004_001_LOTCOMMENTHIST : C1Window, IWorkArea
    {
        ...
        public ASSY004_001_LOTCOMMENTHIST()
        {
            InitializeComponent();
        }
        #endregion
