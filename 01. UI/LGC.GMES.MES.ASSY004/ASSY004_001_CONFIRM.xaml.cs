...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2024.01.31  SI    남기운K : (NERP 대응 프로젝트)실적처리 허용비율 초과 입력 기능추가
**************************************************************************************/
...
{
    /// <summary>
    /// ASSY004_001_CONFIRM.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY004_001_CONFIRM : C1Window, IWorkArea
    {
        ...
        private double GetLotINPUTQTY(string sLotID)
        {
            ...
            if (dgQty != null && dgQty.Rows.Count > 0)
            {
                ...
                //dInputQty = Util.NVC(DataTableConverter.GetValue(dgQty.Rows[0].DataItem, "EQPT_INPUT_QTY")).Equals("") ? 0 : double.Parse(Util.NVC(DataTableConverter.GetValue(dgQty.Rows[0].DataItem, "EQPT_INPUT_QTY")));
