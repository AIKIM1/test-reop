/*************************************************************************************
 Created Date : 2019.04.26
      Creator : INS 김동일K
   Decription : CWA3동 증설 - Notching 공정 - 장비완료
--------------------------------------------------------------------------------------
 [Change History]
  2019.04.26  INS 김동일K : Initial Created.
...
{
    /// <summary>
    /// ASSY004_001_EQPTEND.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY004_001_EQPTEND : C1Window, IWorkArea
    {
