/*************************************************************************************
 Created Date : 2019.05.31
      Creator : INS 김동일K
   Decription : CWA3동 증설 - 노칭 공정진척 - 작업시작
--------------------------------------------------------------------------------------
 [Change History]
...
{
    /// <summary>
    /// ASSY004_001_RUNSTART.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY004_001_RUNSTART : C1Window, IWorkArea
    {
