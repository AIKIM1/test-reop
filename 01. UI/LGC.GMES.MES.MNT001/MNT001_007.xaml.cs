...
{
    public partial class MNT001_007 : Window
    {
        ...
        private void GetDataMain(string Mode)
        {
            if (Mode == "Main")
            {
                ...
                new ClientProxy().ExecuteService_Multi("BR_PRD_PROCESS_MONITORING", "INDATA", "OUTDATA", (dsRslt, bizException) =>
                {
                    try
                    {
                ...
                Set_Combo_Area(cboArea, ex02 =>
                {
                    ...
                    Set_Combo_EquipmentSegment(cboEquipmentSegment, ex03 =>
                    {
                        ...
                        Set_Combo_Process(cboProcess, ex04 =>
                        {
                            ...
                            cboEquipmentSegment.SelectionChanged += cboEquipmentSegment_SelectionChanged;
                            cboProcess.SelectedItemChanged -= cboEquipment_SelectedItemChanged;
                            cboProcess.SelectedItemChanged += cboEquipment_SelectedItemChanged;
        ...
        private void GetProcess()
        {
            ...
            DataTable dtMain = new ClientProxy().ExecuteServiceSync("DA_PRD_SEL_PROC_MNT_PACK", "INDATA", "RSLTDT", dtRQSTDT);
        ...
        private void Set_Combo_Process(C1ComboBox cbo, Action<Exception> action = null)
        {
            DataTable dtRQSTDT = new DataTable();
            dtRQSTDT.TableName = "RQSTDT";
            dtRQSTDT.Columns.Add("LANGID", typeof(string));
            ...
            new ClientProxy().ExecuteService("DA_PRD_SEL_PROC_MNT_PACK", "RQSTDT", "RSLTDT", dtRQSTDT, (result, Exception) =>
            {
                if (Exception != null)
                {
                    LGC.GMES.MES.ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage(Exception), null, "Error", MessageBoxButton.OK, MessageBoxIcon.Warning);
