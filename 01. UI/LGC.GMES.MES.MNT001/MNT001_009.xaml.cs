...
{
    public partial class MNT001_009 : Window
    {
        ...
        private void InitChart()
        {
            ...
            c1Chart.View.Background = new SolidColorBrush(Colors.Black);
        ...
        {           
            ...
            {
                Util.Alert(ex.Message);         // fix error message
            }
        }
                    ...
                    foreach (var code in currCode)
                    {
                        foreach (DataRow row in dtResult.Rows)
                        {
                            ...
                            if (row["LOSS_CODE"].ToString() == code.ToString())
                            {
                                ...
                                //// 상위Loss코드가 비조업이면 barColor가 검정색이므로 흰색테두리선 추가
                                //if (row["LOSS_CODE"].ToString() == "EL001" || row["LOSS_CODE"].ToString() == "EL002")
                                //{
                                //    lineColor.Add(new SolidColorBrush(Colors.White));
                                //} else
                                //{
                                //    lineColor.Add(scBrush);
                                //}
                            }
                        }
                    }
