...
{
    public partial class MNT001_008 : Window
    {
        ...
        private void InitSetting()
        {
            try
            {
                ...
                if (dtResult.Rows.Count == 0) //조립
                {
                    ...
                    colPrjtNamePack.Visibility = Visibility.Collapsed;

                    ProdId.Visibility = Visibility.Visible;
                    ProdIdPack.Visibility = Visibility.Collapsed;
                }
                else//PACK
                {
                    if (LoginInfo.CFG_SHOP_ID.Equals("G481"))
                    {
                        ...
                        colPrjtNamePack.Header = "[실적구분,실적구분]";
                        colPrjtNamePack.Visibility = Visibility.Visible;
                        colProcess.Header = "[PJT,PJT]";
                        colProcess.Visibility = Visibility.Visible;
                        cboElec.Visibility = Visibility.Collapsed;
                        tbElec.Visibility = Visibility.Collapsed;
                        tbProcess.Visibility = Visibility.Collapsed;
                        YesPlan.Visibility = Visibility.Collapsed;
                        YesWorkQty.Visibility = Visibility.Collapsed;
                        YesMeetRate.Visibility = Visibility.Collapsed;

                        ProdId.Visibility = Visibility.Collapsed;
                        ProdIdPack.Visibility = Visibility.Visible;
                    }
                    else
                    {
                        colPrjtName.Visibility = Visibility.Visible;
        ...
        private void SetCellColor(C1DataGrid dataGrid, C1.WPF.DataGrid.DataGridCellEventArgs e)
        {
            ...
            if (e.Cell.Column.Name.Equals("MEET_RATE_BYTIME") || e.Cell.Column.Name.Equals("MEET_RATE_YES") || e.Cell.Column.Name.Equals("MEET_RATE"))
            {
                ...
                if (e.Cell.Row.DataItem != null)
                {
                    if (!Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, e.Cell.Column.Name)).Equals(""))
                    {
                        if (!Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, e.Cell.Column.Name)).Equals("-"))
                        {
                            ...
                            double meet_rate = Double.Parse(Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, e.Cell.Column.Name)).Substring(0, Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, e.Cell.Column.Name)).Length - 3));
        ...
        private void dgMONITORING_LoadedCellPresenter(object sender, C1.WPF.DataGrid.DataGridCellEventArgs e)
        {
            try
            {
                ...
                if (!dataGrid.Dispatcher.CheckAccess()) //main UI 에서 호출
                {
                    ...
                    //if (dgMONITORING.GetCell(e.Cell.Row.Index, 1).Value.Equals("F") || dgMONITORING.GetCell(e.Cell.Row.Index, 1).Value.Equals("S"))
                    //{
                    //    if (e.Cell.Column.Index != 0  && e.Cell.Column.Index != 11)
                    //    {
                    //        e.Cell.Presenter.Background = new SolidColorBrush(Colors.White);
                    //        e.Cell.Presenter.Foreground = new SolidColorBrush(Colors.Black);
                    //        e.Cell.Presenter.BottomLineBrush = new SolidColorBrush(Colors.Black);
                    ...
                    //if (e.Cell.Column.Name.Equals("MEET_RATE"))
                    //{
                    //    if (e.Cell.Row.DataItem != null)
                    //    {
                    //        if (!Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE")).Equals("-"))
                    //        {
                    //            if (!Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE")).Substring(Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE")).Length - 1, 1).Equals("%"))
                    //            {
                    //                DataTableConverter.SetValue(e.Cell.Row.DataItem, "MEET_RATE", (Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE")) + "%"));
                    //            }
                    //        }
                    //    }
                    //}

                    //if (e.Cell.Column.Name.Equals("MEET_RATE_BYTIME"))
                    //{

                    //    if (e.Cell.Row.DataItem != null)
                    //    {
                    //        if (!Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME")).Equals("-"))
                    //        {
                    //            if (!Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME")).Substring(Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME")).Length - 1, 1).Equals("%"))
                    //            {
                    //                DataTableConverter.SetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME", (Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME")) + "%"));
                    //            }
                    ...
                    //            double meet_rate = Double.Parse(Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME")).Substring(0, Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME")).Length - 2));
                ...
                else //UI가 아닌 다른 Thread 호출시
                {
                    Action act = () =>
                    {
                        ...
                        //                double meet_rate = Double.Parse(Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME")).Substring(0, Util.NVC(DataTableConverter.GetValue(e.Cell.Row.DataItem, "MEET_RATE_BYTIME")).Length - 1));
