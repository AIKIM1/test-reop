...
namespace LGC.GMES.MES.ELEC001
{
    ...
    /// ELEC001_LOTSTART
    /// </summary>
    public partial class ELEC001_012_LOTSTART : C1Window, IWorkArea
    {
            ...
            Util.MessageConfirm("SFU1240", (result) =>
            {
                if (result == MessageBoxResult.OK)
                {
                    try
                    {
                        ...
                        DataSet dsRslt = new ClientProxy().ExecuteServiceSync_Multi("BR_PRD_REG_START_LOT_SI_EIF", "IN_EQP,IN_INPUT", "RSLTDT", indataSet);
