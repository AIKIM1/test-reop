...
{
    public partial class ELEC001_012 : IWorkArea
    {
        ...
        void InitInheritance()
        {
            ...
            _baseForm.PROCID = Process.REWINDER;
        ...
        private void btnStart_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ELEC001_012_LOTSTART LOTSTART = new ELEC001_012_LOTSTART();

                if (LOTSTART != null)
                {
                    object[] Parameters = new object[4];
                    Parameters[0] = Process.REWINDER;
        ...
        {
            ELEC001_012_LOTSTART window = sender as ELEC001_012_LOTSTART;
