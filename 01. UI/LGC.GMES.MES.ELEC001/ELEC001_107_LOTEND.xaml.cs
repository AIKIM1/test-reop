...
{
    public partial class ELEC001_107_LOTEND : C1Window, IWorkArea
    {
        ...
        private void btnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            //MUST_BIZ_APPLY
            new ClientProxy().ExecuteService("ECOM_EQPEND_LOT", "INDATA", "RSLTDT", inDataTable, (result, ex) =>
            {
                if (ex != null)
                {
                    ...
                    Util.AlertByBiz("ECOM_EQPEND_LOT", ex.Message, ex.ToString());
                    return;
                }
