...
--------------------------------------------------------------------------------------
 [Change History]
   ...
   2017.07.03   INS 이대영D : BR 변경에 따른 UI 및 파라미터 수정
**************************************************************************************/
...
{
    public partial class ASSY002_002_RUNSTART : C1Window, IWorkArea
    {
        #region Declaration
        ...
        #region [Form Load]
        private void ASSY002_002_RUNSTART_Loaded(object sender, RoutedEventArgs e)
        {
