/*************************************************************************************
 Created Date : 2017.03.02
      Creator : 신광희C
   Decription : 와인더 공정진척(초소형) 
--------------------------------------------------------------------------------------
 [Change History]
   2017.05.29   신광희C   : 와인더 공정진척 UserControl(UcAssyCommand,UcAssySearch,UcAssyProdLot,UcAssyResultDetail,UcAssyProduction) 내에서 발생하는 이벤트 및 메소드 분리 작업 
                          : 1. 다른 UserControl 의 영향이 가지 않는 경우 각각의 UserControl 내부에서 이벤트 및 메소드 처리를 원칙으로 함
                            2. UserControl 간의 참조가 필요한 경우 ASSY002_004.xaml.cs 파일에서 처리 함 
...
{
    public partial class ASSY002_004 : IWorkArea
    {
        #region Declaration
        ...
        /// <summary>
        /// Description     :   ASSY002_004.xaml Loaded 이벤트(Process Code 및 초소형 여부 설정, 권한별 버튼 설정, UserControl 정의 및 이벤트 설정)
        /// Author          :   신 광희
        ...
        private void ButtonWindingTrayLocation_Click(object sender, RoutedEventArgs e)
        {
            ...
            UcAssyDataCollect.DispatcherTimer?.Stop();
            ...
            if (btnTrayPosition.Name == "btnCellWindingLocation")
            {
                ...
                C1DataGrid dg = UcAssyDataCollect.DgProdCellWinding;
        ...
        private void popupWindingTrayPosition_Closed(object sender, EventArgs e)
        {
            ...
            if (UcAssyDataCollect.DispatcherTimer != null && UcAssyDataCollect.DispatcherTimer.Interval.TotalSeconds > 0)
                UcAssyDataCollect.DispatcherTimer.Start();
        }
        ...
        private void ButtonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            ASSY002_004_RUNSTART popupRunStart = new ASSY002_004_RUNSTART {FrameOperation = FrameOperation};
        ...
        {
            ASSY002_004_RUNSTART popup = sender as ASSY002_004_RUNSTART;
            if (popup != null && popup.DialogResult == MessageBoxResult.OK)
            {
                ClearControls();
                GetProductLot();
        ...
        private bool ValidationConfirm()
        {
            ...
            {
                //양품 수량을 확인하십시오. C20210826-000188 로 제거
                /*
