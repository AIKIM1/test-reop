...
{
    public partial class ASSY002_003_TRAY_INFO : C1Window, IWorkArea
    {
        ...
        private void InitCombo()
        {
            ...
            String[] sFilter1 = { "SPCL_RSNCODE" };
            _combo.SetCombo(cboSpecialTRay, CommonCombo.ComboStatus.SELECT, sFilter: sFilter1, sCase: "COMMCODE");

            if (cboSpecialTRay != null && cboSpecialTRay.Items != null && cboSpecialTRay.Items.Count > 0)
        ...
        #region [Form Load]
        private void ASSY002_003_TRAY_INFO_Loaded(object sender, RoutedEventArgs e)
        {
