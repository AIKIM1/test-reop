...
{
    /// <summary>
    /// ASSY002_003_TRAY_CELL_INFO.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY002_003_TRAY_CELL_INFO : C1Window, IWorkArea
    {
        #region Declaration
        ...
        #region Initialize
        public ASSY002_003_TRAY_CELL_INFO()
        {
            InitializeComponent();
        }
        #endregion
        ...
        #region [Form Load]
        private void ASSY002_003_TRAY_CELL_INFO_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        {
            //LGC.GMES.MES.ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage("저장하시겠습니까?"), null, "Information", MessageBoxButton.OKCancel, MessageBoxIcon.None, (result) =>
            Util.MessageConfirm("SFU1112", (result) =>
            {
                if (result == MessageBoxResult.OK)
                {
                    try
                    {
                        string sBizNAme = trayTag.Equals("C") ? "BR_PRD_REG_START_OUT_LOT_WS" : "BR_PRD_REG_MODIFY_OUT_LOT_WS";
        ...
        #region [DataGrid] - dgCellInfo_LoadedCellPresenter
