...
namespace LGC.GMES.MES.VIS001.FTP_Util
{
    //http://nicebury.tistory.com/47
    ...
    public class FTP
    {
        ...
        //FTP 객체를 생성할때 생성자에 인자로 필요한 값들을 넣어준다.
        public FTP(string ip, string id, string pw, string port)
        {
        ...
        public Boolean CheckFTP ()
        {
            try
            {
                ...
                reqFTP.Timeout = 3000;
                reqFTP.Method = System.Net.WebRequestMethods.Ftp.PrintWorkingDirectory;
        ...
        public Boolean Upload(string folder, string filename)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("FTP 전송중 문제가 발생하였습니다.네트워크 상황 또는 접속정보를 살펴 보시기 바랍니다.");
                return false;
            }
        }
        ...
        public List<string> GetDirDetailList(string subFolder)
        {
            List<string> files = new List<string>();
            string line = null;
            try
