...
{
    public partial class CMM_ASSY_TRAY_MOVE : C1Window, IWorkArea
    {
        ...
        #region [Form Load]
        private void CMM_ASSY_TRAY_MOVE_Loaded(object sender, RoutedEventArgs e)
        {
