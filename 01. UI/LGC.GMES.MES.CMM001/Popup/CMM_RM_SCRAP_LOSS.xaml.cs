/*************************************************************************************
 Created Date : 2024.05.28
      Creator : 신광희
   Decription : ROLLMAP DATA (파단(전극간연결) Loss량 표시) CMM_ROLLMAP_SCRAP_LOSS Copy
--------------------------------------------------------------------------------------
 [Change History]
...
namespace LGC.GMES.MES.CMM001.Popup
{
    ...
    public partial class CMM_RM_SCRAP_LOSS : C1Window, IWorkArea
    {
