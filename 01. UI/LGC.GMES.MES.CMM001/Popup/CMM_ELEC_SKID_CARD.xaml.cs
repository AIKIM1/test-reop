...
{
    /// <summary>
    /// CMM_ELEC_SKID_CARD.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class CMM_ELEC_SKID_CARD : C1Window, IWorkArea
    {
        ...
        private void SearchData()
        {
            try
            {
                ...
                dtRqst.Rows.Add(dr);
                DataSet dsRslt = new ClientProxy().ExecuteServiceSync_Multi("DA_PRD_SEL_SKID_PRINT_INFO", "RQSTDT", "RSLTDT", inData);
