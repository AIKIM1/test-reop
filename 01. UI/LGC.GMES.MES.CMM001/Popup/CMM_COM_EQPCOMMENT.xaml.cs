...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2017.02.08  신광희 : 추가 버튼 호출 시 데이터 저장 로직 변경 특이사항 DataGridTemplateColumn 사이즈 변경 없도록 처리
  2017.03.02  신광희 : 테이블(TB_SFC_EQPT_NOTE) 구조 변경으로 인한 BizRule 수정 및 데이터 저장 Rule 변경으로 인한 체크 로직 수정
**************************************************************************************/
...
{
    /// <summary>
    /// CMM_COM_EQPCOMMENT.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class CMM_COM_EQPCOMMENT : C1Window, IWorkArea
    {
        ...
        private string _saveWorkDate = string.Empty;
        ...
        private void C1Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (LoginInfo.LANGID.Equals("pl-PL") || LoginInfo.LANGID.Equals("uk-UA"))
                this.Width = 1200;
        }
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                var query = (from t in dt.AsEnumerable()
                             where t.Field<Int64>("CHK") == 1 // 2024.10.11. 김영국 - Data Type 변경에 따른 수정. Int32 -> Int64
                             select t).ToList();
            ...
            try
            {
                ...
                new ClientProxy().ExecuteService(bizRuleName, "INDATA", "", inDataTable, (result, ex) =>
                {
                    ...
                    else
                    {
                        ...
                        SelectEquiptMentNote(_saveWorkDate);
                    }
                });
            }
            catch ( Exception ex )
