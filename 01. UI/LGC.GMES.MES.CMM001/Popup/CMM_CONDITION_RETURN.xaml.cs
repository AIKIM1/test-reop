/*************************************************************************************
 Created Date : 2022.11.22
      Creator : 오화백
   Decription : 물류 반송 조건 설정
--------------------------------------------------------------------------------------
 [Change History]
 2023.02.22  연현정 : [ESHM] 1. LANE 설정 기능 추가
                            2. 설정 기능 ON/OFF 에 따른 Combo Disable --> Collapsed 로 변경
**************************************************************************************/
...
{
    public partial class CMM_CONDITION_RETURN : C1Window, IWorkArea
    {
        #region Declaration
        ...
        private void SetControl()
        {
            ...
            //2023.02.09 hjyeon - LotType, Ver, Side, Lane Visible 여부 먼저 처리 하도록 수정
            ...
            try
            {
                    ...
                    || Util.Equals(cboVersion.Visibility, Visibility.Visible))
                {
                    ...
                    if (cboSide.SelectedValue != null)
                    {
                        ...
                        sWDCode = cboSide.SelectedValue.ToString().Substring(1, 1);
                    }
        ...
        private void Non_coated_winding_dirctn_use_area_Chk()
        {
            try
            {
                ...
                newRow["CMCDTYPE"] = "NON_COATED_WINDING_DIRCTN_USE_AREA";
                ...
                {
                    _Non_coated_winding_dirctn_use_area = "2";
