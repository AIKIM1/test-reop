/*************************************************************************************
 Created Date : 2021.10.27
      Creator : 신광희
   Decription : ROLLMAP Rewinder 폐기 팝업
--------------------------------------------------------------------------------------
 [Change History]
  2021.10.27  : Initial Created.
  2023.09.12  : 신광희 RollMap Rewinder 폐기 팝업은 소형2170과 같이 사용(_isRollMapPatternApply 파라메터 값으로 BizRule 적용 처리)
**************************************************************************************/
...
namespace LGC.GMES.MES.CMM001.Popup
{
    ...
    public partial class CMM_ROLLMAP_RW_SCRAP : C1Window, IWorkArea
    {
        ...
        private void InitializeControl()
        {
            ...
            {
                tbRewinderScrapWidth.Text = ObjectDic.Instance.GetObjectName("패턴 추가 제거");
            }
            else
            {
        ...
        private void btnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                string bizRuleName = (_isRollMapPatternApply) ? "BR_PRD_REG_DATACOLLECT_DEFECT_RP_CY" : "BR_PRD_REG_DATACOLLECT_DEFECT_RP";
