/*************************************************************************************
 Created Date : 2019.11.07
      Creator : INS 김동일K
   Decription : CWA 전극 생산실적 자동화 - 진행중 불량 입력 팝업
--------------------------------------------------------------------------------------
 [Change History]
  2019.11.07  INS 김동일K : Initial Created.
...
{
    /// <summary>
    /// CMM_ELEC_PROC_RESN_FOR_AUTO_RSLT.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class CMM_ELEC_PROC_RESN_FOR_AUTO_RSLT : C1Window, IWorkArea
    {
        ...
        public CMM_ELEC_PROC_RESN_FOR_AUTO_RSLT()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void GetReasonData()
        {
            try
            {
                ...
                DataTable result = new ClientProxy().ExecuteServiceSync("DA_PRD_SEL_PROC_DEFECT_L", "INDATA", "RSLTDT", dt);
        ...
        private DataTable GetDefectDataByLot()
        {
            try
            {
                int idx = _Util.GetDataGridCheckFirstRowIndex(dgLot, "LOTID");
                ...
                //Indata["LOTID"] = Util.NVC(DataTableConverter.GetValue();
