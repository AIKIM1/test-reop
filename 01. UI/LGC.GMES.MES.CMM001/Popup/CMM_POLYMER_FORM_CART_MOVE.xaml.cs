...
namespace LGC.GMES.MES.CMM001.Popup
{
    ...
    /// </summary>
    public partial class CMM_POLYMER_FORM_CART_MOVE : C1Window, IWorkArea
    {
        ...
        public CMM_POLYMER_FORM_CART_MOVE()
        {
            InitializeComponent();
        }
        ...
        private void CartMove()
        {
            try
            {
                ...
                newRow["FROM_EQSGID"] = _lineId;
                newRow["FROM_PROCID"] = _procID;
                inTable.Rows.Add(newRow);
