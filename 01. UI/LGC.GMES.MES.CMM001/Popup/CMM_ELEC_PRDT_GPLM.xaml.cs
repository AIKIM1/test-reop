...
{
    /// <summary>
    /// CMM_ELEC_PRDT_GPLM.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class CMM_ELEC_PRDT_GPLM : C1Window, IWorkArea
    {
        #region Initialize
        ...
        private void GetProductGplmData()
        {
            ...
            new ClientProxy().ExecuteService("DA_PRD_SEL_CONV_RATE_GPLM", "INDATA", "RSLTDT", IndataTable, (result, searchException) =>
            {
                try
                {
