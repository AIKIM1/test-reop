...
{
    /// <summary>
    /// CMM_ASSY_MAGAZINE_CREATE.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class CMM_ASSY_MAGAZINE_CREATE : C1Window, IWorkArea
    {        
        ...
        public CMM_ASSY_MAGAZINE_CREATE()
        {
            InitializeComponent();
        }
        ...
        private void CreateMagazine()
        {
            try
            {
                ...
                {
                    inTable = _Biz.GetBR_PRD_REG_CREATE_REWORK_MAG_FD();
                    sBizName = "BR_PRD_REG_MAGAZINE_FD";
                }
