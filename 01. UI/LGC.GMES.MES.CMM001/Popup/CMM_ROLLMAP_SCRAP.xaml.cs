/*************************************************************************************
 Created Date : 2021.07.01
      Creator : 신광희
   Decription : ROLLMAP DATA 수정 (Scrap 으로 발생한 이음매 데이터 수정)
--------------------------------------------------------------------------------------
 [Change History]
...
namespace LGC.GMES.MES.CMM001.Popup
{
    ...
    public partial class CMM_ROLLMAP_SCRAP : C1Window, IWorkArea
    {
        ...
        private void InitializeControl()
        {
            ...
            {
                tbRewinderScrapPreviousWidth.Text = ObjectDic.Instance.GetObjectName("패턴 추가 제거");
                tbRewinderScrapAfterWidth.Text = ObjectDic.Instance.GetObjectName("패턴 추가 제거");
            }
            else
            {
        ...
        private void btnSave_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                string bizRuleName = (_isRollMapPatternApply) ? "BR_PRD_REG_ROLLMAP_SCRAP_CY_UI" : "BR_PRD_REG_ROLLMAP_SCRAP_UI";
