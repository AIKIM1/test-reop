...
namespace LGC.GMES.MES.CMM001.UserControls
{
    ...
    /// </summary>
    public partial class UcFormInputConfirm
    {
        #region Declaration
        ...
        public C1.WPF.C1Window UcParentControl;
        ...
        private void txtPalletID_KeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                if (string.Equals(ProcessCode, Process.CircularGrader) || string.Equals(ProcessCode, Process.SmallGrader))
                {
                    InputPalletrGrader();
                }
                else
        ...
        protected virtual void SetGridProduct()
        {
            ...
            try
            {
                ...
                MethodInfo methodInfo = type.GetMethod("SetGridProduct");
