/*************************************************************************************
 Created Date : 2017.11.10
      Creator : INS 김동일K
   Decription : 전지 5MEGA-GMES 구축 - 공정진척화면의 작업지시 공통 화면(남경)
--------------------------------------------------------------------------------------
 [Change History]
  2017.11.10  INS 김동일K : Initial Created.
...
{
    /// <summary>
    /// UC_WORKORDER_NJ.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class UC_WORKORDER_NJ : UserControl, IWorkArea
    {
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (LoginInfo.CFG_SHOP_ID.Equals("G182"))
            {
                ...
                {
                    if (dgWorkOrder.Columns.Contains("MKT_TYPE_CODE"))
                    {
                        dgWorkOrder.Columns["MKT_TYPE_CODE"].Visibility = Visibility.Collapsed;
                    }
                }
            }
        ...
        public void SetGridData(C1DataGrid dg)
        {
            ...
            dg.Columns["MKT_TYPE_CODE"].DisplayIndex = 7;
            dg.Columns["CELL_3DTYPE"].DisplayIndex = 8;
            dg.Columns["ELECTYPE"].DisplayIndex = 9;
            dg.Columns["MODLID"].DisplayIndex = 10;

            dg.Columns["LOTYNAME"].DisplayIndex = 11;
            dg.Columns["INPUT_QTY"].DisplayIndex = 12;
            dg.Columns["C_ROLL_QTY"].DisplayIndex = 13;
            dg.Columns["S_ROLL_QTY"].DisplayIndex = 14;
            dg.Columns["LANE_QTY"].DisplayIndex = 15;
            dg.Columns["OUTQTY"].DisplayIndex = 16;
            dg.Columns["UNIT_CODE"].DisplayIndex = 17;
            dg.Columns["STRT_DTTM"].DisplayIndex = 18;
            dg.Columns["END_DTTM"].DisplayIndex = 19;
            dg.Columns["WO_STAT_NAME"].DisplayIndex = 20;

            dg.Columns["WO_STAT_CODE"].DisplayIndex = 21;
            dg.Columns["WO_DETL_ID"].DisplayIndex = 22;
            dg.Columns["EQSGID"].DisplayIndex = 23;
            dg.Columns["EQSGNAME"].DisplayIndex = 24;
            dg.Columns["EQPTID"].DisplayIndex = 25;
            dg.Columns["EQPTNAME"].DisplayIndex = 26;
            dg.Columns["CLSS_ID"].DisplayIndex = 27;
            dg.Columns["CLSS_NAME"].DisplayIndex = 28;
            dg.Columns["PRODNAME"].DisplayIndex = 29;
        ...
        private DataTable GetEquipmentSegmentCombo()
        {
            try
            {
                ...
                dr2["CBO_NAME"] = "- " + ObjectDic.Instance.GetObjectName("라인선택") + " -";
                dr2["CBO_CODE"] = "";
        ...
        private bool CanChangeWorkOrder(DataRow dtRow)
        {
            ...
            if (dr?.Length > 0 && dt.Columns.Contains("DEMAND_TYPE") && dt.Columns.Contains("MODLID") && dt.Columns.Contains("PRODID"))
            {
