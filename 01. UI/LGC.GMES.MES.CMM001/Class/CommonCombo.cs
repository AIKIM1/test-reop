...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2021.01.27 손우석 운영에 배포시 수정 사항에 대하여 정상 배포되지 않는 현상으로 2021.01.01부터 수정 사항을 CommonCombo에서 CommonCombo2로 이동
  2021.07.21 강동희 롤프레스 대기 모델별 재공 수량 설정
  2022.04.28 김광오 C20220221-000333 NEW-1 bldg sepa interlock logic (4 h), PROCESS_BY_PROCID 추가, ex) LAM,FOL
  2022.06.20 장희만 C20220524-000581 Combo case에 cboProcessquery, cboEquipmentSegmentquery, cboEquipmentquery 추가  
  2022.10.04 정연준 Combo case에 DA_BAS_SEL_PROCESS_EQPTLOSS_CBO_FORM 추가
  2023.02.23 이상훈 E20230220-000068 Combo case FCRCODE_LOSS_LV3  추가
  2023.03.23 김선준 SetPackWHID
  2023.05.23 윤지해 E20230330-001442 cboOccurFcrEqpt, cboLastLossPart, cboLossEqsgProcPart, cboLossCodeProcPart, cboLossCodeOccurEqpt, cboOccrLossDetl, cboLossCodeProcRun 추가
  2023.07.21 백광영 주재홍   Pallet 재고 실사를 위한 ComboBox 추가
  2023.07.18 김대현 E20230711-000645 cboLossCodeAll 추가
  2023.08.10 김대현 E20230711-000645 cboLossCodeProcPackAll 추가
  2023.10.13 김대현 SRC_TYPE 조회 추가(인도네시아 개발자 개발본 머지)
  2023.11.08 윤지해 E20231014-001517 SetProcessWithArea 기존에 EQSGID 변수 파라미터 공백일 경우 NULL 값으로 처리
  2023.11.24 윤지해 E20231026-001195 SetToolTypeCode 다국어 처리를 위한 LANGID 파라미터 추가
  2024.02.14 김용군 E20240221-000898 ESMI1동(A4) 6Line증설관련 화면별 라인ID 콤보정보에 조회될 Line정보와 제외될 Line정보 처리
  2024.03.20 김태오 E20240327-001078 설비Loss 등록화면 Loss분류 콤보 오류 개선 건
  2024.03.21 이병윤 SI[자재 Loss 관리] 자재 Loss 관리  대상 공정만 콤보 
  2024.04.23 김도형 [E20240319-000564] [ESNA]인수인계 화면 개선 요청 건( PRODID_BY_PJT)
  2024.04.23 유명환 [E20240325-000251] 자재LOSS관련 공정, 라인, 설비 디폴드 설정 무시하도록 변경
  2024.06.01 남재현 E20240601-001907 cboOccurFcrEqptMulti, cboOccurEqptMulti 추가
  2024.06.09 박승렬 E20240306-001141 cboRSTR_STD_COL 추가
  2025.07.04 김선준 SI  TACT TIME Combo추가
  2025.07.15 김선준 SI  WHID(AUTO/MANUAL) Combo추가
**************************************************************************************/
using System;
...
namespace LGC.GMES.MES.CMM001.Class
{
    public class CommonCombo
    {
        ...
        public void SetCombo(C1ComboBox cb)
        {
            try
            {
                ...
                switch (hashTag["combo_case"].ToString())
                {
                    ...
                    //KI 한계불량 수준 CASE 추가
                    case "cboLimitDefectLevel1":
                        SetLimitDefectLevel1(cb, cs, sFilter);
                        break;
                    case "cboLimitDefectLevel2":
                        SetLimitDefectLevel2(cb, cs, sFilter);
                        break;
                    case "cboLimitDefectLevel3":
                        SetLimitDefectLevel3(cb, cs, sFilter);
                        break;
                    ...
                    case "cboEquipmentSegmentquery":
                    case "cboHistEquipmentSegment":
                    case "cboLine":
                    case "EQUIPMENTSEGMENT":
                        SetLine(cb, cs, sFilter);
                        break;
                    //ESMI 1동(A4) 1~5 또는 6 Line 제외처리
                    case "ESMI_A4_EXCEPT_LINEID":
                        SetLineCmiExceptLineId(cb, cs, sFilter);
                        break;
                    case "ESMI_A4_FIRST_PRIORITY_LINEID":
                        SetLineCmiFirstLineId(cb, cs, sFilter);
                        break;
                    case "ESMI_A4_EQUIPMENTSEGMENT_BY_EXCEPT_EQGRID":
                        SetEquipmentSegmentByExceptEQSGID(cb, cs, sFilter);
                        break;
                    ...
                    case "EQUIPMENTSEGMENT_AREATYPE":
                        ...
                        break;
                    case "cboProcess":
                    case "cboProcessquery":
                    case "PROCESS":
                    case "cboProcessSRS":
                        SetProcess(cb, cs, sFilter);
                        break;
                    // 2022.10.04
                    case "DA_BAS_SEL_PROCESS_EQPTLOSS_CBO_FORM":
                        SetProcessEqptLoss(cb, cs, sFilter);
                        break;
                    case "ProcessCWA":
                    ...
                    case "cboEquipmentEqptLoss":
                        ...
                        break;
                    case "DA_BAS_SEL_EQUIPMENT_EQPT_TACT_MNTR_CBO":
                        SetEquipmentEqptTtMntr(cb, cs, sFilter);
                        break;
                    case "DA_PRD_SEL_TACTTIME_MONITORING_EQPT_BY_HIS":
                        SetEquipmentEqptTickTimeHis(cb, cs, sFilter);
                        break;
                    ...
                    case "FCRCODE":
                        ...
                        break;
                    case "FCRCODE_LOSS_LV3":
                        SetFCRCodeLossLv3(cb, cs, sFilter);
                        break;
                    case "COMMCODE":
                    ...
                    case "COMMCODEATTRS":
                        ...
                        break;
                    case "COMMCODEATTRSMULTI":
                        SetCommonCodeAttrsMulti(cb, cs, sFilter);
                        break;
                    case "COMMCODEATTR2":
                    ...
                    case "cboOccurEqpt":
                        ...
                        break;
                    case "cboOccurFcrEqpt":
                        SetOccurFcrEqpt(cb, cs, sFilter);
                        break;
                    case "cboOccurFcrEqptMulti":
                        SetOccurFcrEqptMulti(cb, cs, sFilter);
                        break;
                    case "cboOccurEqptMulti":
                        SetOccurEqptMulti(cb, cs, sFilter);
                        break;
                    case "STOCKSEQ":
                    ...
                    case "PILOTLINE":
                        ...
                        break;
                    case "PRDT_CLSS_CODE_PACK":
                        SetPrdt_Clss_Code_Pack(cb, cs, sFilter);
                        break;
                    case "cboProducts":
                        SetProducts(cb, cs, sFilter);
                        break;
                    case "cboProductsPjt":
                        SetProductsPjt(cb, cs, sFilter);
                        break;
                    ...
                    case "cboProcessPack":
                        ...
                        break;
                    case "cboProcessPack_Area":
                        SetProcessPack_Area(cb, cs, sFilter);
                        break;
                    case "PROCBYPCSGID":
                    ...
                    case "cboLossCodeProcPack":
                        ...
                        break;
                    case "cboLossCodeProcPackAll":
                        SetLossCodeProcPackAll(cb, cs, sFilter);
                        break;
                    ...
                    case "TOOL_TYPE_CODE":
                        ...
                        break;
                    case "TOOL_TYPE_CODE_ATTR_CBO":
                        SetToolTypeCodeAttr(cb, cs, sFilter);
                        break;
                    ...
                    case "cboWHID":
                        ...
                        break;
                    case "AUTO_MANUAL_WHID":
                        SetAutoManualWHID(cb, cs, sFilter);
                        break;                        
                    case "cboRackId":
                    ...
                    case "PROCESS_PCSGID_V":
                        ...
                        break;
                    case "EQUIPMENTSEGMENT_ASSY":
                        setComboAssyLine(cb, cs, sFilter);
                        break;
                    case "PROCESS_ASSY":
                        setComboAssyProcess(cb, cs, sFilter);
                        break;
                    case "EQUIPMENT_ASSY":
                        setComboAssyEquipment(cb, cs, sFilter);
                        break;
                    case "POLARITY":
                        SetPolarity(cb, cs, sFilter);
                        break;
                    case "EQUIPMENT_NT_AUTO_CFG":
                        SetEquipmentNTByCfg(cb, cs, sFilter);
                        break;
                    case "MixingProcess":
                        SetProcessMixing(cb, cs, sFilter);
                        break;
                    case "EQUIPMENT_VERIFICATION":
                        SetEquipmentVerif(cb, cs, sFilter);
                        break;
                    case "cboSelectQty": // C20210806-000184 Notched Pancake 포장 시, 포장 수량 선택 ComboBox 추가
                        SetNotchedPancakeQty(cb, cs, sFilter);
                        break;
                    case "AREA_COMMON_CODE_BY_SLOC":    // 동별 반품창고
                        SetAreaCommonCodeForSloc(cb, cs, sFilter);
                        break;
                    case "PROCESS_BY_PROCID":
                        SetProcessByProcId(cb, cs, sFilter);
                        break;
                    case "cboShopProduct":// Shop에 따른 제품 조회
                        SetShopProduct(cb, cs, sFilter);
                        break;
                    case "cboLastLossPart":
                        SetLastLossPart(cb, cs, sFilter);
                        break;
                    case "cboLossEqsgProcPart":
                        SetLossEqsgProcPart(cb, cs, sFilter);
                        break;
                    case "cboLossCodeProcPart":
                        SetLossCodeProcPart(cb, cs, sFilter);
                        break;
                    case "cboLossCodeOccurEqpt":
                        SetLossCodeOccurEqpt(cb, cs, sFilter);
                        break;
                    case "cboOccrLossDetl":
                        SetOccrEqptLossDetl(cb, cs, sFilter);
                        break;
                    case "cboLossCodeProcRun":
                        SetLossCodeProcRun(cb, cs, sFilter);
                        break;
                    case "MODEL_FOR_FCS_HOLD_FRM":
                        SetModelForFCSHoldForm(cb, cs, sFilter);
                        break;
                    case "AREA_SECTION":
                        SetAreaSection(cb, cs, sFilter);
                        break;
                    case "SECTION_STOCKSEQ":
                        SetSectionStockSeq(cb, cs, sFilter);
                        break;
                    case "cboLossCodeAll":
                        SetLossCodeAll(cb, cs, sFilter);
                        break;
                    case "cboSrcType": // IBNU FIRDAUS NURALAM 2023/07/26
                        SetSrcType(cb, cs, sFilter);
                        break;
                    case "cboLossCodeAll_OccurEqpt":  // 2024.03.20 김태오 S 원인 설비 Flag INDATA 추가
                        SetOccurEqptLossCodeAll(cb, cs, sFilter);
                        break;
                    case "cboMatlLossProcess":
                        SetMatlLossProcess(cb, cs, sFilter);
                        break;
                    case "cboMatlLossEquipmentSegment":
                        SetMatlLossEquipmentSegment(cb, cs, sFilter);
                        break;
                    case "cboMatlLossEquipment":
                        cboMatlLossEquipment(cb, cs, sFilter);
                        break;
                    case "cboRSTR_STD_COL":     // 2024-06-09 박승렬 데이터 복원 시 기준 컬럼 추가
                        SetRestoreColumn(cb, cs, sFilter);
                        break;
                    default:
                        SetDefaultCbo(cb, cs);
                        break;
        ...
        // IBNU FIRDAUS NURALAM 2023/07/26
        private void SetSrcType(C1ComboBox cbo, ComboStatus cs, string[] sFilter)
        {
            try
            {
                ...
                //Update 2023/08/09 Ibnu Firdaus Nuralam  Change BR_SM_PRD_LAT02-->DA_BAS_SEL_COMMONCODE
                // DataTable dtResult = new ClientProxy().ExecuteServiceSync("BR_SM_PRD_LAT02", "RQSTDT", "RSLTDT", RQSTDT);
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_COMMONCODE", "RQSTDT", "RSLTDT", RQSTDT);
                cbo.DisplayMemberPath = "CBO_CODE";
                cbo.SelectedValuePath = "CBO_CODE";

                cbo.ItemsSource = AddStatus(dtResult, cs, "CBO_CODE", "CBO_CODE").Copy().AsDataView();
                cbo.ItemsSource = dtResult.Copy().AsDataView();

                cbo.SelectedValue = "EQ";
        ...
        private void SetPackWHID(C1ComboBox cbo, ComboStatus cs, string[] sFilter)
        {
            try
            {
                ...
                RQSTDT.Columns.Add("AREAID", typeof(string));
                RQSTDT.Columns.Add("WH_NAME", typeof(string));

                DataRow dr = RQSTDT.NewRow();
                dr["LANGID"] = LoginInfo.LANGID;
                dr["SHOPID"] = LoginInfo.CFG_SHOP_ID;
                dr["AREAID"] =  string.IsNullOrEmpty(sFilter[0]) ? LoginInfo.CFG_AREA_ID : sFilter[0];
                dr["WH_NAME"] = string.IsNullOrEmpty(sFilter[1]) ? null : sFilter[1]; //창고명 조회 2023-03-29 sonjun9
        ...
        private void SetAutoManualWHID(C1ComboBox cbo, ComboStatus cs, string[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                RQSTDT.Columns.Add("LANGID", typeof(string)); 
                RQSTDT.Columns.Add("AREAID", typeof(string)); 
                RQSTDT.Columns.Add("STOCKER_TYPE", typeof(string)); 

                DataRow dr = RQSTDT.NewRow();
                dr["LANGID"] = LoginInfo.LANGID; 
                dr["AREAID"] =  LoginInfo.CFG_AREA_ID ;
                dr["STOCKER_TYPE"] = sFilter[0];
        ...
        //KI , 한계불량 LEVEL 별 SETCOMBO 추가


        private void SetLimitDefectLevel1(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
        ...
        private void SetLimitDefectLevel2(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
        ...
        private void SetLimitDefectLevel3(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
        ...
        private void SetMatlLossEquipmentSegment(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_LOSS_EQUIPMENTSEGMENT_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        //ESMI-A4동 6Line 제외처리
        private void SetLineCmiExceptLineId(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQUIPMENTSEGMENT_EXCEPT_LINE_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        //ESMI 1동(A4) 1~5 Line 제외처리
        private void SetLineCmiFirstLineId(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                DataTable dtResult = new DataTable();
                dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQUIPMENTSEGMENT_FIRST_PRIORITY_LINE_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetProcessPCSGID_V(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                RQSTDT.Columns.Add("LANGID", typeof(string));
                RQSTDT.Columns.Add("EQSGID", typeof(string));
                RQSTDT.Columns.Add("COMBO_TYPE", typeof(string));

                DataRow dr = RQSTDT.NewRow();
                dr["LANGID"] = LoginInfo.LANGID;
                dr["EQSGID"] = sFilter[0];
                dr["COMBO_TYPE"] = string.IsNullOrEmpty(sFilter[1]) ? null : sFilter[1];
                RQSTDT.Rows.Add(dr);
        ...
        private void SetProcess(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                //제외 공정 추가 - sFilter[1] 사용
                if (dtResult != null && sFilter.Length >= 2 && !string.IsNullOrEmpty(sFilter[1]))
                {
                    DataTable dtConvert = dtResult.Clone();
                    foreach (DataRow dataRow in dtResult.Rows)
                    {
                        if (sFilter[1].Contains(dataRow["CBO_CODE"].Nvc())) continue;

                        dtConvert.Rows.Add(dataRow.ItemArray);
                    }
        ...
        private void SetProcessEqptLoss(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
        ...
        private void SetProcessPack_Area(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                if (LoginInfo.CFG_SHOP_ID == "G481")
                    ...
                    dr["AREAID"] = sFilter[1] == "SELECT" ? LoginInfo.CFG_AREA_ID : sFilter[1];
        ...
        private void SetProcessWithArea(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                dr["LANGID"] = LoginInfo.LANGID;
                dr["AREAID"] = sFilter[0];
                dr["EQSGID"] = sFilter[1] == "" ? null : sFilter[1];    // 2023.11.08 윤지해 E20231014-001517 공백일 경우 NULL로 처리
                RQSTDT.Rows.Add(dr);
        ...
        private void SetProcessByProcId(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                dr["LANGID"] = LoginInfo.LANGID;
                dr["EQSGID"] = sFilter[0];
                dr["PROCID"] = sFilter[1];  // ex) LAM,FOL
                RQSTDT.Rows.Add(dr);

                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_PROC_BY_PROCID_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void cboMatlLossEquipment(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
        ...
        private void SetEquipmentEqptTtMntr(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQUIPMENT_EQPT_TACT_MNTR_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetEquipmentEqptTickTimeHis(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_PRD_SEL_TACTTIME_MONITORING_EQPT_BY_HIS", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetOccurEqptMulti(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataRow dr;
                foreach (string temp in sFilter)
                {
                    dr = RQSTDT.NewRow();
                    dr["LANGID"] = LoginInfo.LANGID;
                    dr["EQPTID"] = temp;
                ...
                DataTable dtResult = null;
                dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_OCCUREQP_CBO_MULTI", "RQSTDT", "RSLTDT", RQSTDT).Select("", "CBO_CODE").CopyToDataTable<DataRow>();
        ...
        /// <summary>
        /// 공정 Loss Lv3별 FCR 코드 매핑 기준정보 조회 처리
        /// </summary>
        /// <param name="cbo"></param>
        /// <param name="cs"></param>
        /// <param name="sFilter"></param>
        private void SetFCRCodeLossLv3(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                string sSelectText = Util.ConvertEmptyToNull(sFilter[7].ToString());
                ...
                dr["LANGID"] = LoginInfo.LANGID;
                dr["PROCID"] = Util.ConvertEmptyToNull(sFilter[0]);
                dr["LOSS_CODE"] = Util.ConvertEmptyToNull(sFilter[1]);
                dr["LOSS_DETL_CODE"] = Util.ConvertEmptyToNull(sFilter[2]);
                dr["FCR_TYPE_CODE"] = Util.ConvertEmptyToNull(sFilter[3]);
                dr["FAIL_CODE"] = Util.ConvertEmptyToNull(sFilter[4]);
                dr["CAUSE_CODE"] = Util.ConvertEmptyToNull(sFilter[5]);
                dr["RESOL_CODE"] = Util.ConvertEmptyToNull(sFilter[6]);
                dr["OCCUREQPTFLAG"] = Util.ConvertEmptyToNull(sFilter[8]);
                dr["EQPTID"] = Util.ConvertEmptyToNull(sFilter[9]);
                dr["CAUSE_EQPTID"] = Util.ConvertEmptyToNull(sFilter[10]);
                INDATA.Rows.Add(dr);
                ...
                //기존 선택값 처리
                if (string.IsNullOrEmpty(sSelectText))
                    cbo.SelectedIndex = 0;
                else
                    cbo.SelectedValue = sSelectText;
            }
            catch (Exception ex)
            {
                LGC.GMES.MES.ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage(ex), ex.ToString(), "Error", MessageBoxButton.OK, MessageBoxIcon.Warning);
        ...
        private void SetCommonCodeAttrsMulti(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                string[] columnArr = { "CMCDTYPE", "ATTRIBUTE1", "ATTRIBUTE2", "ATTRIBUTE3", "ATTRIBUTE4", "ATTRIBUTE5" };
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_COMMONCODE_ATTRIBUTES_MULTI", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetShopProduct(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_PRODUCT_BY_PLANT_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetPrdt_Clss_Code_Pack(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            ...
            try
            {
                ...
                dr["LANGID"] = LoginInfo.LANGID;
                dr["CMCDTYPE"] = sFilter[0];
                dr["CMCODE"] = sFilter[1] == "" ? null : sFilter[1];

                RQSTDT.Rows.Add(dr);

                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_COMMCODE_FORM_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        // [E20240319-000564] [ESNA]인수인계 화면 개선 요청 건( PRODID_BY_PJT)
        private void SetProductsPjt(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_PROD_BY_PJT_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        // C20210806-000184 Notched Pancake 포장 시, 포장 수량 선택 ComboBox 추가   DA_BAS_SEL_COMMCODE_NTC_QTY_CBO
        private void SetNotchedPancakeQty(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                string sQty = dtResult.Rows[0]["ATTR1"].ToString();

                DataTable dtResult2 = new DataTable();

                dtResult2.Columns.Add("CBO_CODE", typeof(string));
                dtResult2.Columns.Add("CBO_NAME", typeof(string));

                DataRow newRow = dtResult2.NewRow();
                newRow.ItemArray = new object[] { sQty, "=" + sQty };
                dtResult2.Rows.Add(newRow);

                DataRow newRow2 = dtResult2.NewRow();
                newRow2.ItemArray = new object[] { sQty, "<" + sQty };
                dtResult2.Rows.Add(newRow2);

                cbo.DisplayMemberPath = "CBO_NAME";
                cbo.SelectedValuePath = "CBO_CODE";
                cbo.ItemsSource = AddStatus(dtResult2, cs, "CBO_CODE", "CBO_NAME").Copy().AsDataView();
        ...
        private void SetLastLossAll(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            DataTable RQSTDT = new DataTable();
            RQSTDT.TableName = "RQSTDT";
            RQSTDT.Columns.Add("LANGID", typeof(string));
            ...
            DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_LAST_LOSS_CBO_ALL", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetLossCodeAll(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQPTLOSSCODE_CBO_ALL", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetOccurEqptLossCodeAll(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                RQSTDT.Columns.Add("PROCID", typeof(string));
                RQSTDT.Columns.Add("EQPTID", typeof(string));
                RQSTDT.Columns.Add("OCCUREQPTFLAG", typeof(string));
                ...
                dr["PROCID"] = sFilter[1];
                dr["EQPTID"] = sFilter[2];
                dr["OCCUREQPTFLAG"] = sFilter[3]; //2024.03.20 김태오 S 원인 설비 Flag INDATA 추가
                RQSTDT.Rows.Add(dr);
        ...
        private void SetLossCodeProcPackAll(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQPTLOSSCODE_CBO_PROC_PACK_ALL", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetEquipment_NEW(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                RQSTDT.Columns.Add("EQSGID", typeof(string));
                RQSTDT.Columns.Add("PROCID", typeof(string));
                RQSTDT.Columns.Add("EQGRID", typeof(string));                   //20220411 sinjigun22 add
                RQSTDT.Columns.Add("COATER_EQPT_TYPE_CODE", typeof(string));
                ...
                dr["EQSGID"] = sFilter[0];
                dr["PROCID"] = sFilter[1];
                dr["EQGRID"] = sFilter[2];                                      //20220411 sinjigun22 add
                dr["COATER_EQPT_TYPE_CODE"] = sFilter[3];
                RQSTDT.Rows.Add(dr);
        ...
        private static DataTable AddStatus(DataTable dt, ComboStatus cs, string sValue, string sDisplay)
        {
        ...
        public static void SetDataGridPopupFindDataColumnComboItem(string bizRuleIp, string bizRuleProtocol, string bizRulePort, string bizRuleServiceMode, string bizRuleServiceIndex, string bizRuleName, string[] arrColumn, string[] arrCondition, ComboStatus status, C1.WPF.DataGrid.DataGridColumn dgcol, string selectedValueText, string displayMemberText)
        {
            try
            {
                DataTable inDataTable = new DataTable();
                ...
                DataTable dtResult = new ClientProxy(bizRuleIp, bizRuleProtocol, bizRulePort, bizRuleServiceMode, bizRuleServiceIndex).ExecuteServiceSync(bizRuleName, "RQSTDT", "RSLTDT", inDataTable);

                DataTable dtBinding = dtResult.DefaultView.ToTable(false, new string[] { selectedValueText, displayMemberText });

                PopupFindDataColumn popupFindDataColumn = null;
                popupFindDataColumn = dgcol as PopupFindDataColumn;

                if (popupFindDataColumn != null)
                    popupFindDataColumn.ItemsSource = StatusAdd(dtBinding, status, selectedValueText, displayMemberText).Copy().AsDataView();
        ...
        private void SetToolTypeCode(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                RQSTDT.TableName = "RQSTDT";
                RQSTDT.Columns.Add("EQPTID", typeof(string));
                RQSTDT.Columns.Add("LANGID", typeof(string));   // 2023.11.24 CSR E20231026-001195 LANGID 추가

                DataRow dr = RQSTDT.NewRow();
                dr["EQPTID"] = sFilter[0];
                dr["LANGID"] = LoginInfo.LANGID;    // 2023.11.24 CSR E20231026-001195 LANGID 추가
        ...
        /// <summary>
        /// 2023.1.5 주동석 Tool 속성 콤보 추가
        /// </summary>
        /// <param name="cbo"></param>
        /// <param name="cs"></param>
        /// <param name="sFilter"></param>
        private void SetToolTypeCodeAttr(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_TB_COMMONCODE_TOOL_TYPE_CODE_ATTR_CBO", "RQSTDT", "RSLTDT", RQSTDT);

                cbo.DisplayMemberPath = "OBJNAME";
                cbo.SelectedValuePath = "COLUMNNAME";
                cbo.ItemsSource = AddStatus(dtResult, cs, "COLUMNNAME", "OBJNAME").Copy().AsDataView();
        ...
        private void setComboAssyLine(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQUIPMENTSEGMENT_ASSY", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void setComboAssyProcess(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_PROCESS_ASSY_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void setComboAssyEquipment(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQUIPMENT_ASSY_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetPolarity(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
        ...
        private void SetEquipmentNTByCfg(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
        ...
        private void SetProcessMixing(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
        ...
        private void SetEquipmentVerif(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQUIPMENT_CBO_VERIF", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetAreaCommonCodeForSloc(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_AREA_COM_CODE_SLOC", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        public static void SetDtCommonCombo(DataTable dt, C1ComboBox cbo, CommonCombo.ComboStatus status, string selectedValue = null, string selectedIndex = null)
        {
            try
            {
                if (dt != null)
                {
                    int idtRowCnt = dt.Rows.Count;
                    string selectedValueText = cbo.SelectedValuePath;
                    string displayMemberText = cbo.DisplayMemberPath;

                    DataTable dtBinding = dt.DefaultView.ToTable(false, new string[] { selectedValueText, displayMemberText });

                    cbo.ItemsSource = null;
                    cbo.DisplayMemberPath = displayMemberText;
                    cbo.SelectedValuePath = selectedValueText;
                    cbo.ItemsSource = AddStatus(dt, status, selectedValueText, displayMemberText).Copy().AsDataView();
                    cbo.SelectedIndex = 0;

                    if (!string.IsNullOrEmpty(selectedValue))
                        cbo.SelectedValue = selectedValue;

                    if (!string.IsNullOrEmpty(selectedIndex) && idtRowCnt > 0)
                        cbo.SelectedIndex = int.Parse(selectedIndex);
                }
            }
            catch (Exception ex)
            {
        ...
        public static void SetDtCommonCombo(DataTable dt, C1.WPF.DataGrid.DataGridColumn Col, CommonCombo.ComboStatus status, string selectedValue = null)
        {
            try
            {
                if (dt != null)
                {
                    string selectedValueText = ((C1.WPF.DataGrid.DataGridComboBoxColumn)Col).SelectedValuePath;
                    string displayMemberText = ((C1.WPF.DataGrid.DataGridComboBoxColumn)Col).DisplayMemberPath;

                    DataTable dtBinding = dt.DefaultView.ToTable(false, new string[] { selectedValueText, displayMemberText });

                    C1.WPF.DataGrid.DataGridComboBoxColumn dataGridComboBoxColumn = Col as C1.WPF.DataGrid.DataGridComboBoxColumn;
                    if (dataGridComboBoxColumn != null)
        ...
        private void SetOccurFcrEqpt(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataTable dtResult = null;
                dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_OCCUREQP_FCR_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetOccurFcrEqptMulti(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
        ...
        private void SetLastLossPart(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            DataTable RQSTDT = new DataTable();
            RQSTDT.TableName = "RQSTDT";
            RQSTDT.Columns.Add("LANGID", typeof(string));
            ...
            DataRow dr = RQSTDT.NewRow();
            dr["LANGID"] = LoginInfo.LANGID;
            dr["EQPTID"] = Util.ConvertEmptyToNull(sFilter[0]);
            dr["USERID"] = LoginInfo.USERID;
            dr["OCCUREQPTFLAG"] = Util.ConvertEmptyToNull(sFilter[1]);
            RQSTDT.Rows.Add(dr);
        ...
        private void SetLossEqsgProcPart(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            DataTable RQSTDT = new DataTable();
            RQSTDT.TableName = "RQSTDT";
            RQSTDT.Columns.Add("LANGID", typeof(string));
            ...
            DataRow dr = RQSTDT.NewRow();
            dr["LANGID"] = LoginInfo.LANGID;
            dr["EQSGID"] = Util.ConvertEmptyToNull(sFilter[0]);
            dr["PROCID"] = Util.ConvertEmptyToNull(sFilter[1]);
            dr["OCCUREQPTFLAG"] = Util.ConvertEmptyToNull(sFilter[2]);
            RQSTDT.Rows.Add(dr);
        ...
        private void SetLossCodeProcPart(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                dr["AREAID"] = Util.ConvertEmptyToNull(sFilter[0]);
                dr["PROCID"] = Util.ConvertEmptyToNull(sFilter[1]);
                dr["EQPTID"] = Util.ConvertEmptyToNull(sFilter[2]);
                dr["USERID"] = LoginInfo.USERID;
                dr["OCCUREQPTFLAG"] = Util.ConvertEmptyToNull(sFilter[3]);
                RQSTDT.Rows.Add(dr);

                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQPTLOSSCODE_CBO_PROC", "RQSTDT", "RSLTDT", RQSTDT);

                if (sFilter[4].Equals("popup"))
                {
                    DataRow row = dtResult.NewRow();
                    row["CBO_NAME"] = "RUN";
                    row["CBO_CODE"] = "RUN";
                ...
                cbo.SelectedIndex = sFilter[4].Equals("popup") ? 1 : 0;
            }
            catch (Exception ex)
            {
                LGC.GMES.MES.ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage(ex), ex.ToString(), "Error", MessageBoxButton.OK, MessageBoxIcon.Warning);
        ...
        private void SetLossCodeOccurEqpt(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                dr["LANGID"] = LoginInfo.LANGID;
                dr["EQPTID"] = Util.ConvertEmptyToNull(sFilter[0]);
                dr["CAUSE_EQPTID"] = Util.ConvertEmptyToNull(sFilter[1]);
                RQSTDT.Rows.Add(dr);

                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQPTLOSSCODE_OCCUREQPT_CBO", "RQSTDT", "RSLTDT", RQSTDT);

                if (sFilter[2].Equals("popup"))
                {
                    DataRow row = dtResult.NewRow();
                    row["CBO_NAME"] = "RUN";
                    row["CBO_CODE"] = "RUN";
                ...
                cbo.SelectedIndex = sFilter[2].Equals("popup") ? 1 : 0;
            }
            catch (Exception ex)
            {
                LGC.GMES.MES.ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage(ex), ex.ToString(), "Error", MessageBoxButton.OK, MessageBoxIcon.Warning);
        ...
        private void SetOccrEqptLossDetl(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                dr["LOSS_CODE"] = sFilter[0];
                dr["EQPTID"] = sFilter[1];
                dr["CAUSE_EQPTID"] = sFilter[2];
                RQSTDT.Rows.Add(dr);

                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQPTLOSSDETLCODE_OCCUREQP_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        /// <param name="cs"></param>
        /// <param name="sFilter"></param>
        private void SetLossCodeProcRun(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                cbo.SelectedIndex = sFilter[3].Equals("popup") ? 1 : 0;
            }
            catch (Exception ex)
            {
                LGC.GMES.MES.ControlsLibrary.MessageBox.Show(MessageDic.Instance.GetMessage(ex), ex.ToString(), "Error", MessageBoxButton.OK, MessageBoxIcon.Warning);
        ...
        private void SetModelForFCSHoldForm(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            DataTable RQSTDT = new DataTable();
            ...
            DataRow dr = RQSTDT.NewRow();
            dr["LANGID"] = LoginInfo.LANGID;
            dr["SHOPID"] = Util.ConvertEmptyToNull(sFilter[0]);
            RQSTDT.Rows.Add(dr);

            DataTable dtResult = new ClientProxy().ExecuteServiceSync("BR_PRD_SEL_MODEL_CBO", "INDATA", "OUTDATA", RQSTDT);
        ...
        /// <param name="cs"></param>
        /// <param name="sFilter"></param>
        private void SetAreaSection(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                cbo.ItemsSource = AddStatus(dtResult, cs, "WH_ID", "WH_NAME").Copy().AsDataView();
        ...
        /// <param name="cs"></param>
        /// <param name="sFilter"></param>
        private void SetSectionStockSeq(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                DataTable RQSTDT = new DataTable();
                ...
                DataRow dr = RQSTDT.NewRow();
                dr["LANGID"] = LoginInfo.LANGID;
                dr["STCK_CNT_YM"] = Util.ConvertEmptyToNull(sFilter[0]);
                dr["AREAID"] = Util.ConvertEmptyToNull(sFilter[1]);
                dr["WH_ID"] = Util.ConvertEmptyToNull(sFilter[2]);
                dr["STCK_CNT_CMPL_FLAG"] = Util.ConvertEmptyToNull(sFilter[3]);
                RQSTDT.Rows.Add(dr);

                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_PRD_GET_COMBO_WH_STCK_CNT_ORD", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        //ESMI-A4동 6Line 제외처리
        private void SetEquipmentSegmentByExceptEQSGID(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_EQUIPMENTSEGMENT_BY_EQGRID_EXCEPT_LINE_CBO", "RQSTDT", "RSLTDT", RQSTDT);               
        ...
        private void SetMatlLossProcess(C1ComboBox cbo, ComboStatus cs, String[] sFilter)
        {
            try
            {
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_LOSS_PROCESS_CBO", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetRestoreColumn(C1ComboBox cbo, ComboStatus cs, String[] sFilter)  // 2024-06-09 박승렬 데이터 복원 시 기준 컬럼 추가 
        {
            try
            {
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_BAS_SEL_COMBO_RSTR_COL", "RQSTDT", "RSLTDT", RQSTDT);
