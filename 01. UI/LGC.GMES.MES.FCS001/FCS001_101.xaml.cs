...
{
	public partial class FCS001_101 : UserControl, IWorkArea
	{
        ...
        private void btnDegreeAdd_Click(object sender, RoutedEventArgs e)
		{
			try
			{
				...
				{
					FCS001_101_STOCKCNT_START wndSTOCKCNT_START = new FCS001_101_STOCKCNT_START();
		...
		private void wndSTOCKCNT_START_Closed(object sender, EventArgs e)
		{
			try
			{
				FCS001_101_STOCKCNT_START window = sender as FCS001_101_STOCKCNT_START;
