/*************************************************************************************
 Created Date : 2020.12.15
      Creator : 
   Decription : [개발자 전용] Cell 등급 변경
--------------------------------------------------------------------------------------
 [Change History]
  2020.12.15  DEVELOPER : Initial Created.
  2023.09.20  조영대    : IWorkArea 추가
  2025.04.02  이현승    : Catch-Up [E20240911-001061] Cell 등급 변경 시 MENUID INDATA 추가, Cell 등급 변경 이력 조회 탭 화면 추가 및 적용 UI 컬럼 추가
...
namespace LGC.GMES.MES.FCS001
{
    ...
    /// </summary>
    public partial class FCS001_090 : UserControl, IWorkArea
    {
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //2025.04.02 이현승 Cell 등급 변경 이력 조회 탭 화면 추가
        ...
        private void InitCombo()
        {
            ...
            string[] sFilter = { "COMBO_SUBLOTJUDGE_CHANGE" }; // 공통코드 확인
            _combo.SetCombo(cboGrade, CommonCombo_Form.ComboStatus.ALL, sCase: "COMMCODE", sFilter: sFilter);
        }
        ...
        // 2025.04.02 이현승 : Cell 등급 변경 이력 조회 탭 화면 추가 - FCS001_034 참고
        private void GetDataFromGrid2()
        {
            try
            {
                ...
                else
                {
                    ...
                    string sActMenu = cboActMenu.SelectedItemsToString; // 2025.04.02 이현승 : Cell 등급 변경 이력 조회 조건 추가
        ...
        // 2025.04.02 이현승 : Cell 등급 변경 이력 조회 조건 추가 
        private void SetActMenuID()
        {
            try
            {
                // 2025.04.02 이현승 >>  2025.02.27 홍석원 : 적용 UI 콤보박스 조회 시 공통코드 조회로 변경 하여 불필요한 Input Param 삭제
                ...
                Util.MessageConfirm("FM_ME_0020", (result) => //Cell 등급을 변경하시겠습니까?
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < dgCellList.Rows.Count; i++)
                        {
                            ...
                            dr["MENUID"] = LoginInfo.CFG_MENUID; // 2025.04.02 이현승 : 적용 UI 추적성 향상을 위한 MENUID 추가
