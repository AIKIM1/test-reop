...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2023.08.14  이정미 : Parameters 변수 배열 크기 수정 
  ...
  2024.08.01  박태용 : E20240729-000116 기존 재작업 시트 부분 DFCT_CODE 더블 클릭 시 ERROR 발생하는 현상 수정 // object[] Parameters 12 -> 14로 변경.
**************************************************************************************/
...
{
    public partial class FCS001_057_SUMMARY : UserControl, IWorkArea
    {
        #region Declaration & Constructor 

        Util _Util = new Util();
        private DataTable[] dtHeader = new DataTable[4];
        public FCS001_057_SUMMARY()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void GetSummaryData(string WRKLOG_TYPE_CODE, string _L_flag, string remark)
        {
            try
            {
                DataTable dtRqst = new DataTable();
