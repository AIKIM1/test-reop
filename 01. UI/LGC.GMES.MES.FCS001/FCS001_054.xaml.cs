...
{
    public partial class FCS001_054 : UserControl, IWorkArea
    {
        #region Declaration & Constructor 

        Util _Util = new Util();
        DataTable dtHeader = new DataTable();
        string[] col = { "IPT_01", "IPT_02", "ST2_01", "ST2_02", "ST2_03", "WFT_01", "WFT_02", "WFT_03", "WFT_04" };
        //CAD_01, SS1_01, NA 제거 
        string[] col4 = { "NA1", "SP2_01", "SS2_01" };
        string[] colH = { "HPT_01", "HPT_02", "HPP_01", "HPS_01" };
        ...
        private void GetEqpConditon(DataTable dt, string colName, int colIdx, int rowInterval, bool flagH)
        {
            ...
            {
                string value = Util.NVC(DataTableConverter.GetValue(dgEqp.Rows[Rowidx].DataItem, colName));
        ...
        private void GetSummaryData()
        {
            try
            {
                ...
                //  DataSet dsRslt = new ClientProxy().ExecuteServiceSync_Multi("BR_GET_DGS_EOL_PERF", "INDATA", "OUT_DIR,OUT_DIR_DETAIL,OUT_RWK,OUT_RWK_DETAIL", InDataSet);
        ...
        private void dgList_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            if (wndPopup != null)
            {
                ...
                {
                    Parameters[8] = "DEGAS_FRST_MOVE";
                    Parameters[11] = ""; // LOTCOMENT, 2021-04-23 재작업일지일 경우 이전 불량명 추가 
                }
                else
                {
                    Parameters[8] = "DEGAS_RWK_MOVE";
