...
--------------------------------------------------------------------------------------
 [Change History]
  2022.07.06  조영대 : Initial Created  (Copy by FCS001_026_MANUAL_OUT)
**************************************************************************************/
...
{
    public partial class FCS001_026_MANUAL_OUT_LOC : C1Window, IWorkArea
    {
        ...
        public FCS001_026_MANUAL_OUT_LOC()
        {
            InitializeComponent();
            Initialize();
        }
