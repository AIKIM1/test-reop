...
{
    public partial class FCS001_105_MAX_TRF_QTY : C1Window, IWorkArea
    {
        ...
        private void GetMaxTrfQtyList()
        {
            try
            {
                ...
                new ClientProxy().ExecuteService("DA_PRD_SEL_OUTER_WH_STAND_INFO", "INDATA", "OUTDATA", inTable, (searchResult, searchException) =>
                {
