...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2022.09.08  최도훈    : 조회결과 18개 이상일 때, 장애 발생하는 현상 조치
...
{
    public partial class FCS001_073_GRADE_DETAIL : C1Window, IWorkArea
    {
        ...
        public FCS001_073_GRADE_DETAIL()
        {
            InitializeComponent();
        }
        ...
        private void GetList()
        {
            try
            {
                ...
                DataTable dtRslt = new ClientProxy().ExecuteServiceSync("DA_SEL_LOAD_CELL_DATA", "RQSTDT", "RSLTDT", dtRqst);
