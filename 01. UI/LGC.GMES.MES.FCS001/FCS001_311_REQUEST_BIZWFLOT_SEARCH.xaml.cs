/*************************************************************************************
 Created Date : 
      Creator : 
   Decription : BizWF 요청서 선택
--------------------------------------------------------------------------------------
 [Change History]
 2023.03.15  LEEHJ     : 소형활성화 MES 복사
 2023.07.04  조영대    : FCS002_311_REQUEST_BIZWFLOT_SEARCH => FCS001_311_REQUEST_BIZWFLOT_SEARCH 복사
**************************************************************************************/
...
{
    public partial class FCS001_311_REQUEST_BIZWFLOT_SEARCH : C1Window, IWorkArea
    {
        ...
        public FCS001_311_REQUEST_BIZWFLOT_SEARCH()
        {
            InitializeComponent();
        }
        ...
        {
            if (_dtBizWFHeader == null || _dtBizWFDetail == null)
            {
        ...
        private void SearchBizWFHeader()
        {
            try
            {
                ...
                dtInTable.Columns.Add("FROM_DATE", typeof(string));
                dtInTable.Columns.Add("TO_DATE", typeof(string));
                ...
                dr["BIZ_WF_REQ_DOC_NO"] = txtBizWFHeader.GetBindValue();
                ...
                dr["IS_COMPLETE"] = rdoComplete.IsChecked.Equals(false) ? "N" : "Y";
        ...
        private void rbBizWFChoice_Checked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (rb.IsChecked != null)
                {
                    ...
                    if (drv != null && ((bool)rb.IsChecked && drv.Row["CHK"].ToString().Equals("1") || Convert.ToBoolean(drv.Row["CHK"]) == true))
                    {
