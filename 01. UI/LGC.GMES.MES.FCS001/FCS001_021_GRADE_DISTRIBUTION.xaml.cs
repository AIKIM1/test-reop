...
{
    public partial class FCS001_021_GRADE_DISTRIBUTION : C1Window, IWorkArea
    {
        ...
        public FCS001_021_GRADE_DISTRIBUTION()
        {
            InitializeComponent();
        }
        ...
        private void GetList()
        {
            try
            {
                ...
                dtRslt = new ClientProxy().ExecuteServiceSync("DA_SEL_CELL_GRADE", "INDATA", "OUTDATA", dtRqst);
