...
{
    public partial class FCS001_117 : UserControl, IWorkArea
    {
        ...
        private void AddDefectHeader_JF(C1DataGrid dg, int iWidth = 0)
        {
            ...
            DataTable dtRslt = new ClientProxy().ExecuteServiceSync("DA_SEL_DEFECT_CELL_HIST_PROCESS", "RQSTDT", "RSLTDT", dtRqst);
        ...
        private void GetHPCD(string sCellID)
        {
            try
            {
                ...
                new ClientProxy().ExecuteService("DA_SEL_DEFECT_CELL_HIST", "RQSTDT", "RSLTDT", dtRqst, (bizResult, bizException) =>
                {
        ...
        private void GetDegas(string sCellID)
        {
            try
            {
                ...
                ShowLoadingIndicator();
                new ClientProxy().ExecuteService("DA_SEL_DEFECT_CELL_DEGAS_HIST", "RQSTDT", "RSLTDT", dtRqst, (bizResult, bizException) =>
                {
                    if (bizException != null)
                    {
                        HiddenLoadingIndicator();
        ...
        private void GetEOL(string sCellID)
        {
            try
            {
                ...
                ShowLoadingIndicator();
                new ClientProxy().ExecuteService("DA_SEL_DEFECT_CELL_EOL_HIST", "RQSTDT", "RSLTDT", dtRqst, (bizResult, bizException) =>
                {
                    if (bizException != null)
                    {
                        HiddenLoadingIndicator();
