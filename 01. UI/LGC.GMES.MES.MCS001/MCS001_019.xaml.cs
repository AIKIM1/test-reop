/*************************************************************************************
 Created Date : 2019.01.16
      Creator : 신광희 차장
   Decription : Skid 현황 모니터링
--------------------------------------------------------------------------------------
 [Change History]
  2019.02.25  신광희 차장 : Initial Created.
**************************************************************************************/
...
{
    /// <summary>
    /// MCS001_019.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class MCS001_019 : UserControl, IWorkArea
    {
        ...
        private void btnSearch_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (CommonVerify.HasTableInDataSet(dsResult))
                {
                    ...
                    Util.GridSetData(dgList, _dtSkidStateInfo, null, false);
