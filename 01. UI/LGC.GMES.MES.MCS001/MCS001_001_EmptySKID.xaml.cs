...
{
	public partial class MCS001_001_EmptySKID : C1Window, IWorkArea
	{
		...
		private void SeachData() {
			...
			new ClientProxy().ExecuteService("DA_MCS_SEL_EMPTY_SKID", "RQSTDT", "RSLTDT", RQSTDT, ( result, exception ) => {
				try {
					if( exception != null ) {
