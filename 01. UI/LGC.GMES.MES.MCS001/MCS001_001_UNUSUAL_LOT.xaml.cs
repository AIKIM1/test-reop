...
{
    public partial class MCS001_001_UNUSUAL_LOT : C1Window, IWorkArea
    {
        ...
        private void SeachData()
        {
			...
			new ClientProxy().ExecuteService("DA_MCS_SEL_UNUSUAL_LOT_INFO", "RQSTDT", "RSLTDT", RQSTDT, ( result, exception ) => {
				try {
					if( exception != null ) {
