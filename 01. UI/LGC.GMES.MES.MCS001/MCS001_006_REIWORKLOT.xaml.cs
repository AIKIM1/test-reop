...
{
    public partial class MCS001_006_REWORKLOT : C1Window, IWorkArea
    {
        ...
        private void SeachData()
        {
			...
			new ClientProxy().ExecuteService("DA_MCS_SEL_LAMI_REWORK_LOT", "RQSTDT", "RSLTDT", RQSTDT, ( result, exception ) => {
				try {
					if( exception != null ) {
