...
{
    public partial class MCS001_001_REWORKSKID : C1Window, IWorkArea
    {
		#region Declaration & Constructor 

		private string WH_ID;

		public MCS001_001_REWORKSKID()
        {
            InitializeComponent();
        }
        ...
        private void SeachData()
        {
			...
			new ClientProxy().ExecuteService("DA_MCS_SEL_REWORK_SKID_INFO", "RQSTDT", "RSLTDT", RQSTDT, ( result, exception ) => {
				try {
					if( exception != null ) {
