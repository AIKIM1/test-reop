...
{
	public partial class MCS001_077_QUICK_SHIP_SETTING : C1Window, IWorkArea
	{
		...
		public MCS001_077_QUICK_SHIP_SETTING()
		{
			InitializeComponent();
		}
		...
		private void SeachData()
		{
			...
			new ClientProxy().ExecuteService("DA_MCS_SEL_FORMATION_EOL_QUICK_SHIP_INFO_V2", "RQSTDT", "RSLTDT", RQSTDT, ( result, exception ) =>
			{
				try
				{
					if(exception != null)
