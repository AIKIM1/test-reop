...
{
	public partial class MCS001_001_NOT_INPUT_LOT : C1Window, IWorkArea
	{
		...
		public MCS001_001_NOT_INPUT_LOT() {
			InitializeComponent();
		}
		...
		private void SeachData() {
			...
			new ClientProxy().ExecuteService("DA_MCS_SEL_NO_INPUT_LOT", "RQSTDT", "RSLTDT", RQSTDT, ( result, exception ) => {
				try {
					if( exception != null ) {
