...
{
	public partial class MCS001_002_INPUT_LOT : C1Window, IWorkArea
	{

        #region Declaration & Constructor 
        private string _PRJ_NAME = string.Empty;  //프로젝트명
        private string _POLARITY= string.Empty;   //극성
        private string _EQGRID = string.Empty;    //설비그룹
        private string _QA_VAL = string.Empty;


        public MCS001_002_INPUT_LOT() {
			InitializeComponent();
		}
		...
		private void C1Window_Loaded( object sender, RoutedEventArgs e ) {
            ...
            _QA_VAL = parameters[2] as string;
            _EQGRID = parameters[3] as string; //설비그룹
        ...
        private void SeachData() {
            ...
            dr["QA_VAL"] = _QA_VAL.ToString() == string.Empty? null: _QA_VAL;
            dr["EQGRID"] = _EQGRID;

            RQSTDT.Rows.Add( dr );

			new ClientProxy().ExecuteService("DA_MCS_SEL_MEB_INPUT_LOT", "RQSTDT", "RSLTDT", RQSTDT, ( result, exception ) => {
				try {
					if( exception != null ) {
