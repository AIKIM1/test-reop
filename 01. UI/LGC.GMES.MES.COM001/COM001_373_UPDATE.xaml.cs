...
{
    public partial class COM001_373_UPDATE : C1Window, IWorkArea
    {
        ...
        public COM001_373_UPDATE()
        {
            InitializeComponent();
            Loaded += COM001_373_UPDATE_Loaded;
        }

        private void COM001_373_UPDATE_Loaded(object sender, RoutedEventArgs e)
        {
            Loaded -= COM001_373_UPDATE_Loaded;
        ...
        private void ModifyProcess()
        {
            try
            {
                ...
                foreach (DataRow row in drList)
                {
                    ...
                    newRow["HOLD_GR_ID"] = Util.NVC(row["HOLD_GR_ID"]);
                    newRow["HOLD_GR_ID_SEQNO"] = Util.NVC(row["HOLD_GR_ID_SEQNO"]);
