...
namespace LGC.GMES.MES.COM001
{
    ...
    /// </summary>
    public partial class COM001_035_REQUEST_BIZWFLOT_SPLIT : C1Window, IWorkArea
    {
        Util _util = new Util();
        ...
        #region Initialize
        public COM001_035_REQUEST_BIZWFLOT_SPLIT()
        {
            InitializeComponent();
        }
        ...
        private void GridRowRemove() {
            ...
            List<DataRow> drList = dt.Select("CHK = true OR CHK = 1")?.ToList();
            if (drList.Count > 0)
            {
