...
{
    public partial class COM001_035_REQUEST_RESERVATION : C1Window, IWorkArea
    {
        ...
        public COM001_035_REQUEST_RESERVATION()
        {
            InitializeComponent();
        ...
        private void chkHold_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (DataTableConverter.GetValue(cb.DataContext, "REL_SYSTEM_ID").Nvc().Equals("OCAP"))
                {
                    ...
                    DataTableConverter.GetValue(cb.DataContext, "CHK").Equals(1))//체크되는 경우
                {
                    ...
                    {
                        if(DataTableConverter.GetValue(cb.DataContext, dc.ColumnName) == null) continue ;
        ...
        private void Request()
        {
            ...
            try
            {
                DataSet dsRslt = new ClientProxy().ExecuteServiceSync_Multi(bizRuleName, "INDATA,INLOT,INPROG,INREF", "OUTDATA,OUTDATA_LOT", inData);
