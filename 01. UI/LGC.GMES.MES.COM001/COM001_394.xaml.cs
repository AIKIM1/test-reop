/*************************************************************************************
 Created Date : 2023.12.08
      Creator : 백광영
   Decription : 공PALLET 재고실사
--------------------------------------------------------------------------------------
 [Change History]
  2023.12.08  백광영 : COM001_387 Copy
...
{
    public partial class COM001_394 : UserControl, IWorkArea
    {
        ...
        private void InitCombo()
        {
            ...
            // 차수
            String[] sFilter = { Util.GetCondition(ldpMonthShot), LoginInfo.CFG_AREA_ID, Util.GetCondition(cboSection), "" };
            _combo.SetCombo(cboInventorySeq, CommonCombo.ComboStatus.NONE, sCase: "SECTION_STOCKSEQ", sFilter: sFilter);
            #endregion

            #region Tab2
            setWareHouse(cboSectionResult);

            // 차수
            String[] sFilter1 = { Util.GetCondition(ldpMonthShot), LoginInfo.CFG_AREA_ID, Util.GetCondition(cboSectionResult), "" };
            _combo.SetCombo(cboInventoryResultSeqNo, CommonCombo.ComboStatus.NONE, sCase: "SECTION_STOCKSEQ", sFilter: sFilter1);
        ...
        private void btnAddSeq_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                COM001_394_ADD_SEQ wndSTOCKCNT_ADD = new COM001_394_ADD_SEQ();
                wndSTOCKCNT_ADD.FrameOperation = FrameOperation;

                if (wndSTOCKCNT_ADD != null)
                {
                    object[] Parameters = new object[6];
                    Parameters[0] = ldpMonthShot.SelectedDateTime;
                    Parameters[1] = Convert.ToString(cboSection.SelectedValue);
        ...
        private void wndSTOCKCNT_ADD_Closed(object sender, EventArgs e)
        {
            try
            {
                COM001_394_ADD_SEQ window = sender as COM001_394_ADD_SEQ;
        ...
        private void GetInventoryCheckResult(int idx , string _type)
        {
            try
            {
                ...
                string sBizRule = chkDiffFlag.IsChecked == true ? "DA_PRD_GET_WH_STCK_CNT_RSLT_CFM_DIFF_EMPTY_PALLET" : "DA_PRD_GET_WH_STCK_CNT_RSLT_CFM_EMPTY_PALLET";
            ...
            try
            {
                ...
                if (dg.CurrentRow != null)
                {
                    ...
                    if (dg.CurrentCell.Row.Type.ToString().Equals("Bottom"))
                    {
                        ...
                        drvRow["AREAID"] = LoginInfo.CFG_AREA_ID;
        ...
        private void ShowInventoryDetail(DataRowView drvRow)
        {
            ...
            try
            {
                ...
                INDATA.Columns.Add("WH_TYPE_CODE", typeof(string));
                ...
                string _sbizName = "DA_PRD_GET_WH_STCK_CNT_SNAP_DTL_EMPTY_PALLET";
        ...
        private void Confirm()
        {
            ...
            try
            {
                DataSet dsRslt = new ClientProxy().ExecuteServiceSync_Multi("BR_PRD_REG_WH_STCK_CNT_RSLT_CFM_EMPTY_PALLET", "INDATA,INDATA_BOXID", null, inData);
        ...
        private void SetListShot()
        {
            try
            {
                ...
                DataTable result = new ClientProxy().ExecuteServiceSync("DA_PRD_GET_WH_STCK_CNT_SNAP_SUM_EMPTY_PALLET", "RQSTDT", "RSLTDT", RQSTDT);
        ...
        private void SetListResult()
        {
            try
            {
                ...
                DataTable dtRslt = new ClientProxy().ExecuteServiceSync("DA_PRD_GET_WH_STCK_CNT_SUM_EMPTY_PALLET", "RQSTDT", "RSLTDT", RQSTDT);
