...
{
    public partial class COM001_014_RUN_SPLIT_APPR_ASSIGN : C1Window, IWorkArea
    {
        #region Declaration & Constructor 
        string areaId = string.Empty;
        DataTable dtLoss = new DataTable();

        public COM001_014_RUN_SPLIT_APPR_ASSIGN()
        {
            InitializeComponent();
        }
        ...
        private void Save()
        {
            ...
            if (dtLoss != null && dtLoss.Rows.Count > 0)
            {
                for (int i = 0; i < dtLoss.Rows.Count; i++)
                {
                    ...
                    dr["STRT_DTTM"] = DateTime.Parse(Util.NVC(dtLoss.Rows[i]["START_DTTM"])).ToString("yyyyMMddHHmmss");
                    ...
                    dr["SPLT_MRG_FLAG"] = "S";
                    dr["ORG_STRT_DTTM"] = DateTime.Parse(Util.NVC(dtLoss.Rows[0]["START_DTTM"])).ToString("yyyyMMddHHmmss");
