...
namespace LGC.GMES.MES.COM001
{
    ...
    /// </summary>
    public partial class COM001_143_Auth : C1Window, IWorkArea
    {
        ...
        private void GetUserList()
        {
            try
            {
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_RTLS_SET_TOUT_AUTH_USR", "RQSTDT", "RSLTDT", RQSTDT);
