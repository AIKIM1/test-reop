...
{
    public partial class COM001_073_REIN_RACK : C1Window, IWorkArea
    {
        #region Declaration & Constructor 

        public COM001_073_REIN_RACK()
        {
            InitializeComponent();
        }
        ...
        private void SeachData()
        {
            ...
            new ClientProxy().ExecuteService("DA_PRD_SEL_STOCK_BY_REIN_NOTCH_LOT", "RQSTDT", "RSLTDT", RQSTDT, (result, exception) =>
            {
                try
                {
                    if (result == null)
