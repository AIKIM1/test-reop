/*************************************************************************************
 Created Date : 2024.03.19
      Creator : 이재우
   Decription : 절연코터 롤맵 팝업(NT향 소형 파우치) - 자동차 리와인더 롤맵과 통합 작업 필요.
--------------------------------------------------------------------------------------
 [Change History]
...
{
    /// <summary>
    /// COM001_RM_CHART_IC.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class COM001_RM_CHART_IC : C1Window, IWorkArea
    {
        #region Variables
        ...
        #region TextBlockLane_PreviewMouseUp(IC 롤맵화면에서 사용안함)
        /// <summary>
        /// 두께차트 범례(레인) 클릭시 해당 레인 제외/복구해서 다시 그리기(IC 롤맵화면에서 사용안함)
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
