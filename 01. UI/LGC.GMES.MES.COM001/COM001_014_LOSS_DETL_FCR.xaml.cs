...
--------------------------------------------------------------------------------------
 Created Date : 2023.07.18
      Creator : 윤지해
   Decription : 부동내용 및 FCR 코드 선택
--------------------------------------------------------------------------------------
  2023.07.18 윤지해 CSR ID E20230703-000158 FCR 코드 입력 방식 개선 / COM001_014_LOSS_DETL_FCR 화면으로 분리
...
{
    public partial class COM001_014_LOSS_DETL_FCR : C1Window, IWorkArea
    {
        ...
        public COM001_014_LOSS_DETL_FCR()
        {
            InitializeComponent();
        }
