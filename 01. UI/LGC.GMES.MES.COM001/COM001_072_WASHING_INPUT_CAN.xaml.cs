/*************************************************************************************
 Created Date : 2022.02.10
      Creator : 신광희
   Decription : CAN 등록 (ASSY006_WASHING_INPUT_CELL 참조)
--------------------------------------------------------------------------------------
 [Change History]
  2022.07.18  배현우 : Initial Created.
  2023.05.26  배현우 : Can ID Validation 수정
...
{
    public partial class COM001_072_WASHING_INPUT_CAN : C1Window, IWorkArea
    {
        ...
        public COM001_072_WASHING_INPUT_CAN()
        {
            InitializeComponent();
        }
        ...
        private bool IsValid()
        {
            ...
            if (query.Any())
            {
                foreach (var item in query)
                {
                    ...
                    if (Convert.ToInt16(item["CSTSLOT"].GetString()) > 64)
                    {
                ...
                Util.MessageConfirm("SFU1241", (result) =>
                {
                    if (result == MessageBoxResult.OK)
                    {
                        ...
                        string bizRuleName = _completeProd == "Y"
                            ...
                            : "BR_PRD_REG_PUT_SUBLOT_IN_CST_WS_CANID";
