...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2022.04.06  김태균  : 제2산단 소형 전극/조립의 경우 SYSTEM ID가 'KR'이 아니고 'K2'임.'K2' 추가함.
                        조회대상 ERP서버정보 관련 수정
  2023.03.31  김동일  : C20221010-000086 Summary 컬럼에 "Total" 추가 및 더블클릭 시 전체 상세 정보 조회 로직 추가.
  2024.10.15  김영택  : RFC 3.1 반영내역 롤백
  2024.11.01  김상영  : E20240724-001093 상세정보 조회 시 CLASS 필터링 조건 변경
**************************************************************************************/
...
{
    /// <summary>
    /// COM001_080.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class COM001_077 : UserControl, IWorkArea
    {
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            chkAvlPndChk.Visibility = Visibility.Collapsed; // 2024.12.19. 김영국 - 해당 checkBox Hidden 처리.
        }
        ...
        private void dgMaster_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            this.Dispatcher.BeginInvoke(new Action(() =>
            {
                try
                {
                    ...
                    {
                        COM001_077_CMP_DAY wndPopup = new COM001_077_CMP_DAY();
        ...
        private void wndPopup_Closed(object sender, EventArgs e)
        {
            try
            {
                COM001_077_CMP_DAY wndPopup = sender as COM001_077_CMP_DAY;
