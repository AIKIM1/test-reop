...
{
    public partial class COM001_327_UPDATE : C1Window, IWorkArea
    {
        ...
        public COM001_327_UPDATE()
        {
            InitializeComponent();
            Loaded += COM001_327_UPDATE_Loaded;
        }

        private void COM001_327_UPDATE_Loaded(object sender, RoutedEventArgs e)
        {
            Loaded -= COM001_327_UPDATE_Loaded;
            ...
            txtIssue_Cntt.Text = tmmp01.Rows[0]["HOLD_ISSUE_CNTT"].ToString();
            txtAdj_Qty.Value = Convert.ToDouble(tmmp01.Rows[0]["HOLD_ADJ_QTY"]);
            txtOccrCause_Cntt.Text = tmmp01.Rows[0]["OCCR_CAUSE_CNTT"].ToString();
            txtPrcs_Mthd_Cntt.Text = tmmp01.Rows[0]["PRCS_MTHD_CNTT"].ToString();
            txtProg_Stat_Cntt.Text = tmmp01.Rows[0]["PROG_STAT_CNTT"].ToString();
            txtUser.Text = tmmp01.Rows[0]["CHARGE_USERNAME"].ToString();
            txtDept.Text = tmmp01.Rows[0]["CHARGE_DEPT_NAME"].ToString();
