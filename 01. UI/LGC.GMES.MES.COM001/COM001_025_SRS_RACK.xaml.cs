...
{
    public partial class COM001_025_SRS_RACK : C1Window, IWorkArea
    {
        ...
        public COM001_025_SRS_RACK()
        {
            InitializeComponent();
        }

        public COM001_025_SRS_RACK(string sRack, string sText)
        {
            InitializeComponent();

            string sBizName = "DA_PRD_SEL_STOCK_BY_RACK_PALLET_LIST";
