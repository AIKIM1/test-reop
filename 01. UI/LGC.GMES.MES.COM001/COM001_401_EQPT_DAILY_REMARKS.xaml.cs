/*************************************************************************************
 Created Date : 2024.06.03
      Creator : 김도형
   Decription : 특이사항 ->전극 생산일별 특이사항(NEW)-> 설비 일별 노트 팝업
--------------------------------------------------------------------------------------
 [Change History]
  2024.06.03  김도형 : Initial Created.
...
{
    /// <summary>
    /// COM001_401_EQPT_DAILY_REMARKS.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class COM001_401_EQPT_DAILY_REMARKS : C1Window, IWorkArea
    {
        ...
        public COM001_401_EQPT_DAILY_REMARKS()
        {
            InitializeComponent();
        }
        ...
        private void InitCombo()
        {
            ...
            _combo.SetCombo(cboEquipment, CommonCombo.ComboStatus.SELECT, cbParent: cboEquipmentParent, sCase: "EQUIPMENT");
