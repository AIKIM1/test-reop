...
{
    /// <summary>
    /// COM001_035_PACK_SHIP_UNINTERLOCK_PERSON.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class COM001_035_PACK_SHIP_UNINTERLOCK_PERSON : C1Window, IWorkArea
    {
        ...
        public COM001_035_PACK_SHIP_UNINTERLOCK_PERSON()
        {
            InitializeComponent();
        }
        ...
        private void GetUserList()
        {
            try
            {
                ...
                DataTable dtResult = new ClientProxy().ExecuteServiceSync("DA_PRD_SEL_HOLD_RELEASE_PERSON", "RQSTDT", "RSLTDT", RQSTDT);
