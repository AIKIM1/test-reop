...
{
    public partial class COM001_MAIN_StartUp : C1Window, IWorkArea
    {
        ...
        private void btnSearch_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                rowIndata["SYSTEM_ID"] = LoginInfo.SYSID;    // 특정시스템 조회용
        ...
        private void SetComboSystem()
        {
            ...
            string[] arrCondition = { LoginInfo.LANGID, "MES_SYSTEM_TYPE_CODE" };  
            this.cboSystem.SetDataComboItem("DA_BAS_SEL_COMMCODE_CBO", arrColumn, arrCondition, CommonCombo.ComboStatus.ALL, LoginInfo.CFG_SYSTEM_TYPE_CODE);
