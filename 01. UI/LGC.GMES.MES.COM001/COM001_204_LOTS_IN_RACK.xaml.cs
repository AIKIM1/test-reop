...
{
    public partial class COM001_204_LOTS_IN_RACK : C1Window, IWorkArea
    {
        ...
        public COM001_204_LOTS_IN_RACK()
        {
            InitializeComponent();
        }

        public COM001_204_LOTS_IN_RACK(string sRack, string sareaid, string swhid)
        {
            InitializeComponent();
