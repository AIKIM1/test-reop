...
--------------------------------------------------------------------------------------
 [Change History]
  2019.05.17  정문교 : Initial Created.   COM001_309_MODIFY_INPUT_LOT_QTY Copy 폴란드3동 & 빈강용으로 생성
**************************************************************************************/
...
{
    public partial class COM001_305_MODIFY_INPUT_LOT_QTY : C1Window, IWorkArea
    {
        ...
        public COM001_305_MODIFY_INPUT_LOT_QTY()
        {
            InitializeComponent();
