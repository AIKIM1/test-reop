...
{
    public partial class COM001_014_FCR : C1Window, IWorkArea
    {
        ...
        private void SaveFCRGroup()
        {
            try
            {
                ...
                new ClientProxy().ExecuteService_Multi("BR_EQPT_EQPTLOSS_FCRGR", "INDATA", null, (bizResult, bizException) =>
                {
                    try
                    {
