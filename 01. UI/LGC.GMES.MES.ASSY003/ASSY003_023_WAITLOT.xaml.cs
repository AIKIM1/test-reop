/*************************************************************************************
 Created Date : 2019.11.06
      Creator : 이상준C
   Decription : 전지 5MEGA-GMES 구축 - ZZS 공정진척 화면 - 대기LOT조회 팝업
--------------------------------------------------------------------------------------
 [Change History]
...
{
    /// <summary>
    /// ASSY003_023_WAITLOT.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY003_023_WAITLOT : C1Window, IWorkArea
    {   
        ...
        string _sPGM_ID = "ASSY003_023_WAITLOT";
        ...
        private void C1Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            String[] sFilter = { LoginInfo.CFG_AREA_ID, Process.ZZS, null, _LineID };
