...
{
    /// <summary>
    /// ASSY003_001_EQPEND.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY003_001_EQPEND : C1Window, IWorkArea
    {
        ...
        private string _WipqtyEA = string.Empty;
            ...
            try
            {
                ...
                new ClientProxy().ExecuteService("DA_PRD_SEL_INPUTLOT_INFO_NT", "INDATA", "OUTDATA", inTable, (searchResult, searchException) =>
                {
                    try
                    {
                        ...
                        //
                        if (searchResult != null && searchResult.Rows.Count > 0 && searchResult.Columns.Contains("WIPQTY_EA"))
                        {
                            searchResult.Rows[0]["WIPQTY_EA"] = _WipqtyEA;
                        }
        ...
        private void EqpEnd()
        {
            try
            {
                ...
                new ClientProxy().ExecuteService_Multi("BR_PRD_REG_EQPT_END_LOT_NT_UI_S", "IN_EQP,IN_INPUT", null, (bizResult, bizException) =>
                {
                    try
                    {
