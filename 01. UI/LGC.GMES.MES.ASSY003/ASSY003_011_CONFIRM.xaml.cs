...
{
    /// <summary>
    /// ASSY003_011_CONFIRM.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY003_011_CONFIRM : C1Window, IWorkArea
    {   
        ...
        private void btnWorker_Click(object sender, RoutedEventArgs e)
        {
            ...
            wndShiftUser = new CMM_SHIFT_USER2 { FrameOperation = this.FrameOperation };
        ...
        private void Save()
        {
            try
            {
                ...
                //DataTable SearchResult = Util.Get_ConfirmQty(txtLotId.Text.Trim(), Process.SSC_FOLDED_BICELL, _equipmentCode, _lineCode);
