...
{
    /// <summary>
    /// ASSY003_001_RUNSTART.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY003_001_RUNSTART : C1Window, IWorkArea
    {
        ...
        private void GetWaitList()
        {
            try
            {
                ...
                newRow["EQSGID"] = txtLot.Text.Trim().Equals("") ? _LineID : null;
        ...
        private void StartRun(string sNewLot)
        {
            try
            {
                ...
                new ClientProxy().ExecuteService_Multi("BR_PRD_REG_START_LOT_NT_EIF_S", "IN_EQP,IN_INPUT", "OUTDATA", (bizResult, bizException) =>
                {
                    try
                    {
