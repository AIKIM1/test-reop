...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2024.01.24        남기운K : (NERP 대응 프로젝트)실적처리 허용비율 초과 입력 기능추가
...
{
    /// <summary>
    /// ASSY001_004_CONFIRM.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY001_004_CONFIRM : C1Window, IWorkArea
    {
        ...
        private void InitializeControls()
        {
            ...
            {
                if (dgMagazine.Columns.Contains("CSTID"))
                    dgMagazine.Columns["CSTID"].Visibility = Visibility.Visible;
            }
            else
            {
                if (dgMagazine.Columns.Contains("CSTID"))
                    dgMagazine.Columns["CSTID"].Visibility = Visibility.Collapsed;
            }
        }
