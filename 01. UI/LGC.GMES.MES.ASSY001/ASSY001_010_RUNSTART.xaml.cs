...
{
    public partial class ASSY001_010_RUNSTART : C1Window, IWorkArea
    {
        ...
        private void RunStart(string sNewLot)
        {
            try
            {
                ...
                new ClientProxy().ExecuteServiceSync_Multi("BR_PRD_REG_START_LOT_SSCBI", "IN_EQP,IN_INPUT", "OUT_LOT", indataSet);
