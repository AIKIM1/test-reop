...
{
    /// <summary>
    /// ASSY001_OUTLOT_MERGE.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY001_OUTLOT_MERGE : C1Window, IWorkArea
    {
        ...
        private void C1Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (_LDR_LOT_IDENT_BAS_CODE.Equals("RF_ID") || _LDR_LOT_IDENT_BAS_CODE.Equals("CST_ID"))
            {
                ...
                tbLotID.Text = ObjectDic.Instance.GetObjectName("LOTID(CSTID)");
            }
            else
            {
                if (dgMerge.Columns.Contains("CSTID"))
        ...
        private void GetLotInfo()
        {
            try
            {
                ...
                new ClientProxy().ExecuteService_Multi("BR_PRD_SEL_MERGE_LOT_INFO", "INDATA", "OUTDATA", (bizResult, ex) =>
                {
                    try
                    {
                        txtLotID.Text = "";
