...
--------------------------------------------------------------------------------------
 [Change History]
  ...
  2023.05.09  윤지해   E20230324-002690    ESNA VD check quantity improved - ESNA 자동차 조립일 경우 검사수량 Validation 스킵처리
**************************************************************************************/
...
{
    public partial class ASSY001_024_QAJUDG : C1Window, IWorkArea
    {
        ...
        private void btnInspectionConfirm_Click(object sender, RoutedEventArgs e)
        {
            ...
            #region   2023.05.09  윤지해   E20230324-002690    ESNA VD check quantity improved - ESNA 자동차 조립일 경우 검사수량 Validation 스킵처리
            //기존
            ...
            //수정 후
            if (int.Parse(txtNumber.Text) == 0 && !(LoginInfo.CFG_SYSTEM_TYPE_CODE.Equals(Area_Type.ASSY) && LoginInfo.CFG_SHOP_ID.Equals("G451")))
            {
                Util.MessageValidation("SFU3371"); //수량이 0이상이어야 합니다.
                return;
            }
