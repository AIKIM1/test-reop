...
{
    public partial class ASSY001_008_RUNSTART : C1Window, IWorkArea
    {
        ...
        private void RunStart()
        {
            try
            {
                ...
                new ClientProxy().ExecuteServiceSync_Multi("BR_PRD_REG_START_LOT_SRC", "IN_EQP,IN_INPUT", "OUT_LOT", indataSet);
