...
{
    public partial class ASSY001_005_MAGAZINE_CREATE : C1Window, IWorkArea
    {
        ...
        public ASSY001_005_MAGAZINE_CREATE()
        {
            InitializeComponent();
        }
        ...
        private void C1Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //{
            //    rdoRemain.Visibility = Visibility.Collapsed;
            //    rdoRecover.IsChecked = true;
            //}
        ...
        private void CreateMagazine()
        {
            try
            {
                ...
                DataTable dtRslt = new ClientProxy().ExecuteServiceSync("BR_PRD_REG_MAGAZINE_FD", "INDATA", "OUTDATA", inTable);
        ...
        private bool CanCreate()
        {
            ...
            if (!(((bool)rdoRecover.IsChecked && rdoRecover.Visibility == Visibility.Visible) ||
                ((bool)rdoRemain.IsChecked && rdoRemain.Visibility == Visibility.Visible) ||
                ((bool)rdoScrap.IsChecked && rdoScrap.Visibility == Visibility.Visible)))
            {
