/*************************************************************************************
 Created Date : 2020.10.26
      Creator : 신광희
   Decription : 노칭 설비 구간별 파단 횟수 관리 팝업 (ASSY005_001_EQPT_SECT_CUTOFF Copy 후 작성)
--------------------------------------------------------------------------------------
 [Change History]
...
{
    /// <summary>
    /// ASSY005_001_EQPT_SECT_CUTOFF.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY005_001_EQPT_SECT_CUTOFF : C1Window, IWorkArea
    {
        ...
        public ASSY005_001_EQPT_SECT_CUTOFF()
        {
            InitializeComponent();
        }
        #endregion
