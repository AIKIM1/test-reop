/*************************************************************************************
 Created Date : 2020.11.13
      Creator : 신광희
   Decription : CWA3동 증설 - 조립 공정 공통 - 장비완료(ASSY004_COM_EQPTEND Copy 후 작성)
--------------------------------------------------------------------------------------
 [Change History]
...
{
    /// <summary>
    /// ASSY005_COM_EQPTEND.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY005_COM_EQPTEND : C1Window, IWorkArea
    {
        ...
        private void InitializeControls()
        {
            ...
            if (_ProcID.Equals(Process.LAMINATION) || _ProcID.Equals(Process.DNC))  // 250428 ESHG DNC공정추가
            {
        ...
        private void Save()
        {
            try
            {
                ...
                // 김용군
                //if (_ProcID.Equals(Process.LAMINATION ) || _ProcID.Equals(Process.AZS_ECUTTER))
                ...
                // 김용군 AZS_STACKING 대응
                    ...
                    bizName = "BR_PRD_REG_EQPT_END_PROD_LOT_AZS_L";
                // 김용군 AZS_ECUTTER 대응
                else if (_ProcID.Equals(Process.AZS_ECUTTER))
                    bizName = "BR_PRD_REG_EQPT_END_PROD_LOT_AZC";
                else if (_ProcID.Equals(Process.PACKAGING))
                    bizName = "BR_PRD_REG_EQPT_END_PROD_LOT_CL_L";
                else if (_ProcID.Equals(Process.DNC))       // 250428 ESHG DNC공정추가 
                    bizName = "BR_PRD_REG_EQPT_END_PROD_LOT_DNC";
        ...
        private void GetAllData()
        {
            ...
            if (_ProcID.Equals(Process.LAMINATION) || _ProcID.Equals(Process.AZS_ECUTTER) || _ProcID.Equals(Process.DNC))   // 250428 ESHG DNC공정추가 
            {
                GetMagzineList();
                GetDefectInfo();
            }
