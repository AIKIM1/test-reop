/*************************************************************************************
 Created Date : 2020.11.19
      Creator : 신광희
   Decription : CNB2동 증설 - Packaging 공정진척 화면 - Tray 생성 팝업 (ASSY0004.ASSY001_007_TRAY_CREATE 소스 카피 후 작성)
--------------------------------------------------------------------------------------
 [Change History]
  2020.11.19  신광희 : Initial Created.
**************************************************************************************/
...
{
    /// <summary>
    /// ASSY005_007_TRAY_CREATE.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASSY005_007_TRAY_CREATE : C1Window, IWorkArea
    {
        ...
        public ASSY005_007_TRAY_CREATE()
        {
            InitializeComponent();
        }
        #endregion
