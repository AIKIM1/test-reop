/*************************************************************************************
 Created Date : 2020.10.29
      Creator : 정문교
   Decription : CNB2동 증설 - 공정진척 화면 - RFID 투입취소 팝업 (ASSY004_COM_INPUT_LOT_END 2020/10/29 소스 카피 후 작성)
--------------------------------------------------------------------------------------
 [Change History]
...
namespace LGC.GMES.MES.ASSY005
{
    ...
    /// </summary>
    public partial class ASSY005_COM_INPUT_LOT_END : C1Window, IWorkArea
    {
        ...
        public ASSY005_COM_INPUT_LOT_END()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void C1Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            cboHoldCODE.SetDataComboItem("DA_BAS_SEL_AREA_COM_CODE_CBO_ATTR_LIKE", arrColumn, arrCondition);


            cboHoldCODE.SelectedIndex = 5;
        ...
        private void Save()
        {
            try
            {
                ...
                if(cboHoldCODE.IsEnabled == true)
                {
                    newRow["HOLD_CODE"] = cboHoldCODE.SelectedValue.ToString();
                }
        ...
        private void HoldCBOChanged(object sender, PropertyChangedEventArgs<object> e)
        {
            if(cboHold.IsEnabled && cboHold.Text == "Y" && cboHoldCODE.Items.Count !=0)
            {
